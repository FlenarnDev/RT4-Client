...
public class FogManager {
    ...
    public static void setup() {
        ...
        glLightfv(GL_LIGHT0, GL_AMBIENT, light0Params);
        glEnable(GL_LIGHT0);

        @Pc(55) float[] light1Params = new float[] { 0.0F, 0.0F, 0.0F, 1.0F };
        glLightfv(GL_LIGHT1, GL_AMBIENT, light1Params);
        glEnable(GL_LIGHT1);
