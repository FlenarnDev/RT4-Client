...
@OriginalClass("com.jagex3.client.client!bh")
public final class MapSpotAnim extends ModelSource {

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "y", descriptor = "Lclient!ga;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "O", descriptor = "I")
	private final int anInt602 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "P", descriptor = "I")
	private int anInt603 = -32768;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "T", descriptor = "Z")
	public boolean aBoolean41 = false;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "U", descriptor = "I")
	private int anInt607 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "I", descriptor = "I")
	public final int anInt598;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "Q", descriptor = "I")
	public final int anInt604;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "S", descriptor = "I")
	public final int anInt606;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "w", descriptor = "I")
	public final int anInt590;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "F", descriptor = "I")
	private final int anInt596;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "K", descriptor = "I")
	public final int anInt599;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "J", descriptor = "Lclient!tk;")
	private SeqType aClass144_1;

	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "<init>", descriptor = "(IIIIIII)V")
	public MapSpotAnim(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt598 = arg3;
		this.anInt604 = arg2;
		this.anInt606 = arg1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "a", descriptor = "(IIIIIIIIJILclient!ga;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "a", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bh", name = "a", descriptor = "(IIIII)V")
	@Override
