...
@OriginalClass("com.jagex3.client.client!vi")
public final class GlVertexBufferObject {

	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "a", descriptor = "I")
	private int anInt5760;

	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "b", descriptor = "I")
	private final int anInt5761;

	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "c", descriptor = "I")
	private int anInt5762;

	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "d", descriptor = "Z")
	private final boolean aBoolean300;

	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "<init>", descriptor = "()V")
	public GlVertexBufferObject() {
		this(false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "<init>", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "a", descriptor = "(Ljava/nio/ByteBuffer;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "a", descriptor = "()V")
	public final void method4516() {
		@Pc(1) GL2 local1 = GlRenderer.gl;
		local1.glBindBuffer(GL2.GL_ARRAY_BUFFER, this.anInt5760);
	}

	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "b", descriptor = "(Ljava/nio/ByteBuffer;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "b", descriptor = "()V")
	public final void method4518() {
		@Pc(1) GL2 local1 = GlRenderer.gl;
		local1.glBindBuffer(GL2.GL_ELEMENT_ARRAY_BUFFER, this.anInt5760);
	}

	@OriginalMember(owner = "com.jagex3.client.client!vi", name = "c", descriptor = "(Ljava/nio/ByteBuffer;)V")
