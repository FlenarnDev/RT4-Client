...
import deob.Static62;
import deob.Static84;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!gi")
public final class Light {

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "a", descriptor = "Z")
	public final boolean aBoolean124;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "d", descriptor = "I")
	private int anInt2232;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "e", descriptor = "I")
	private int anInt2233;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "i", descriptor = "I")
	public int anInt2235;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "j", descriptor = "I")
	public final int anInt2236;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "p", descriptor = "I")
	private int anInt2239;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "q", descriptor = "I")
	public int anInt2240;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "r", descriptor = "I")
	public int anInt2241;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "t", descriptor = "I")
	public final int anInt2243;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "u", descriptor = "[S")
	public final short[] aShortArray30;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "w", descriptor = "F")
	public float aFloat8;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "x", descriptor = "I")
	public int anInt2245;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "y", descriptor = "I")
	private int anInt2246;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "z", descriptor = "F")
	...
	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "g", descriptor = "Z")
	public boolean aBoolean125 = false;

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "I", descriptor = "[F")
	...
	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "a", descriptor = "(BIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "a", descriptor = "(I)V")
	private void method1763() {
		@Pc(10) int local10 = (this.anInt2236 << 7) + 64;
		this.aFloat9 = 1.0F / (float) (local10 * local10);
	}

	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "a", descriptor = "(ZII)V")
	public final void method1765(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(62) int local62;
		if (local29 == 1) {
			local62 = (Pix3D.sinTable[local26] >> 6) + 1024;
		} else if (local29 == 3) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!gi", name = "c", descriptor = "(I)V")
