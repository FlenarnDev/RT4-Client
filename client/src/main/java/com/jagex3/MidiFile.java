...
@OriginalClass("com.jagex3.client.client!rf")
public final class MidiFile extends Linkable {

	@OriginalMember(owner = "com.jagex3.client.client!rf", name = "p", descriptor = "Lclient!sc;")
	public HashTable aClass133_22;

	@OriginalMember(owner = "com.jagex3.client.client!rf", name = "q", descriptor = "[B")
	public final byte[] aByteArray65;

	@OriginalMember(owner = "com.jagex3.client.client!rf", name = "<init>", descriptor = "(Lclient!wa;)V")
	public MidiFile(@OriginalArg(0) Packet arg0) {
		...
		label221: for (@Pc(549) int local549 = 0; local549 < local12; local549++) {
			...
			while (true) {
				while (true) {
					@Pc(571) int local571 = arg0.gMidiVarLen();
					local500.pMidiVarLen(local571);
					...
					if (local583 == 7) {
						...
						local500.p1(47);
						local500.p1(0);
						local500.psize4(local500.pos - local565);
						continue label221;
					}
					if (local583 == 23) {
						if (local590) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!rf", name = "a", descriptor = "()V")
	public final void method3740() {
		this.aClass133_22 = null;
	}

	@OriginalMember(owner = "com.jagex3.client.client!rf", name = "b", descriptor = "()V")
	public final void method3741() {
		...
		@Pc(29) MidiParser local29 = new MidiParser(this.aByteArray65);
