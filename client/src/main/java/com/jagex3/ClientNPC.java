...
@OriginalClass("com.jagex3.client.client!km")
public final class ClientNPC extends ClientEntity {

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "rc", descriptor = "Lclient!me;")
	public NpcType aClass96_1;

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!km", name = "a", descriptor = "(IIIIIIIIJILclient!ga;)V")
	@Override
	public final void method4546(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) long arg8, @OriginalArg(9) int arg9, @OriginalArg(10) ParticleSystem arg10) {
		...
		if (!GlRenderer.enabled) {
			if (local140 != null) {
				local74 = ((SoftwareModelLit) local74).method4588(local140);
			}
	...
	@OriginalMember(owner = "com.jagex3.client.client!km", name = "a", descriptor = "(IIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!km", name = "a", descriptor = "(B)Z")
	@Override
	public final boolean method2682() {
		return this.aClass96_1 != null;
	}

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "a", descriptor = "(ILclient!me;)V")
