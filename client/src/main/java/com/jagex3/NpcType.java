...
public final class NpcType {
	...
	@OriginalMember(owner = "com.jagex3.client.client!me", name = "d", descriptor = "[S")
	private short[] aShortArray38;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "g", descriptor = "[I")
	private int[] anIntArray354;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "o", descriptor = "[S")
	private short[] aShortArray39;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "t", descriptor = "[[I")
	private int[][] anIntArrayArray28;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "z", descriptor = "[[I")
	private int[][] anIntArrayArray29;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "J", descriptor = "[S")
	private short[] aShortArray40;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "K", descriptor = "Lclient!sc;")
	private HashTable aClass133_15;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "X", descriptor = "I")
	public int anInt3741;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "cb", descriptor = "[I")
	private int[] anIntArray356;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "hb", descriptor = "[I")
	public int[] anIntArray357;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "A", descriptor = "I")
	public int anInt3728 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "I", descriptor = "Z")
	public boolean aBoolean183 = true;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "a", descriptor = "I")
	public int anInt3713 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "q", descriptor = "Z")
	public boolean aBoolean181 = true;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "O", descriptor = "I")
	public int anInt3734 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "r", descriptor = "S")
	public short aShort23 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "L", descriptor = "Lclient!na;")
	public JagString aClass100_738 = Static266.aClass100_1010;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "x", descriptor = "I")
	public int anInt3726 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "Z", descriptor = "Z")
	public boolean aBoolean184 = true;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "l", descriptor = "I")
	public int anInt3719 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "U", descriptor = "I")
	private int anInt3738 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "V", descriptor = "I")
	public int anInt3739 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "C", descriptor = "I")
	private int anInt3729 = 128;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "N", descriptor = "B")
	public byte aByte12 = -16;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "H", descriptor = "I")
	public int anInt3732 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "F", descriptor = "B")
	public byte aByte10 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "e", descriptor = "Z")
	public boolean aBoolean180 = true;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "ab", descriptor = "S")
	public short aShort24 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "db", descriptor = "I")
	public int anInt3743 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "R", descriptor = "I")
	public int anInt3736 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "h", descriptor = "I")
	private int anInt3715 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "B", descriptor = "Z")
	public boolean aBoolean182 = false;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "M", descriptor = "I")
	public int anInt3733 = 32;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "u", descriptor = "[Lclient!na;")
	public final JagString[] aClass100Array116 = new JagString[5];

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "ib", descriptor = "I")
	public int anInt3747 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "bb", descriptor = "B")
	public byte aByte13 = -96;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "G", descriptor = "B")
	public byte aByte11 = 7;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "S", descriptor = "I")
	public int anInt3737 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "mb", descriptor = "I")
	public int anInt3750 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "gb", descriptor = "I")
	public int anInt3746 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "E", descriptor = "I")
	private int anInt3731 = 128;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "s", descriptor = "I")
	private int anInt3723 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "fb", descriptor = "I")
	public int anInt3745 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "D", descriptor = "I")
	public int anInt3730 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "Q", descriptor = "I")
	public int anInt3735 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "lb", descriptor = "I")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!t", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!ra", name = "c", descriptor = "(BI)V")
    ...
    public static NpcType list(@OriginalArg(0) int arg0) {
        @Pc(10) NpcType local10 = (NpcType) Static93.aClass99_13.method3106((long) arg0);
        if (local10 != null) {
            return local10;
        }
        @Pc(26) byte[] local26 = clientConfig.method4495(Static60.method1447(arg0), Static179.method3322(arg0));
        local10 = new NpcType();
	...
	public final NpcType method2932() {
		...
		if (local5 < 0 || local5 >= this.anIntArray357.length - 1 || this.anIntArray357[local5] == -1) {
			...
			return local55 == -1 ? null : list(local55);
		} else {
			return list(this.anIntArray357[local5]);
		}
	}

	@OriginalMember(owner = "com.jagex3.client.client!me", name = "b", descriptor = "(B)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!me", name = "a", descriptor = "(I)Z")
	public final boolean method2935() {
		...
		for (@Pc(35) int local35 = 0; local35 < this.anIntArray357.length; local35++) {
			if (this.anIntArray357[local35] != -1) {
				@Pc(60) NpcType local60 = list(this.anIntArray357[local35]);
	...
	@OriginalMember(owner = "com.jagex3.client.client!me", name = "a", descriptor = "(III)I")
	public final int method2936(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass133_15 == null) {
			return arg1;
		} else {
			@Pc(18) IntNode local18 = (IntNode) this.aClass133_15.find((long) arg0);
	...
	public final ModelLit method2937(@OriginalArg(0) Class147[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) SeqType arg6, @OriginalArg(8) int arg7, @OriginalArg(9) SeqType arg8) {
		...
		if (local40 == null) {
			...
			for (@Pc(86) int local86 = 0; local86 < this.anIntArray356.length; local86++) {
				if (this.anIntArray356[local86] != -1) {
					local84[local86] = ModelUnlit.method1686(aClass153_37, this.anIntArray356[local86]);
					...
					if (local156.anIntArrayArray7[local173] != null && local84.length > local173 && local84[local173] != null) {
						...
						if (this.anIntArrayArray28[local173] == null) {
							...
							if (local207 == 0 && local214 == 0 && local228 == 0) {
								...
								local300 = Pix3D.cosTable[local207] >> 1;
								@Pc(306) int local306 = Pix3D.sinTable[local207] >> 1;
								@Pc(312) int local312 = Pix3D.cosTable[local214] >> 1;
								local318 = Pix3D.cosTable[local228] >> 1;
								local324 = Pix3D.sinTable[local214] >> 1;
								local330 = Pix3D.sinTable[local228] >> 1;
		...
		for (local235 = 0; local235 < local173; local235++) {
			if (arg0[local235] != null) {
				@Pc(753) SeqType local753 = SeqType.list(arg0[local235].anInt5396);
				if (local753.frames != null) {
					...
					if ((local753.aBoolean277 || Static204.aBoolean234) && local207 != -1 && local753.frames.length > local207) {
		...
		if (arg8 != null) {
			...
			if ((arg8.aBoolean277 || Static204.aBoolean234) && arg3 != -1 && arg8.frames.length > arg3) {
		...
		if (arg6 != null) {
			...
			if ((arg6.aBoolean277 || Static204.aBoolean234) && arg1 != -1 && arg1 < arg6.frames.length) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!me", name = "a", descriptor = "(ILclient!na;Z)Lclient!na;")
	public final JagString method2938(@OriginalArg(0) int arg0, @OriginalArg(1) JagString arg1) {
		if (this.aClass133_15 == null) {
			return arg1;
		} else {
			@Pc(18) StringNode local18 = (StringNode) this.aClass133_15.find((long) arg0);
	...
	@OriginalMember(owner = "com.jagex3.client.client!me", name = "b", descriptor = "(I)V")
		...
		if (this.anIntArray357 != null) {
			...
			if (local41 == null) {
				...
				for (@Pc(84) int local84 = 0; local84 < this.anIntArray354.length; local84++) {
					local82[local84] = ModelUnlit.method1686(aClass153_37, this.anIntArray354[local84]);
				}
	...
	private void method2944(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
		...
		if (arg0 == 1) {
			...
			if (this.aClass100Array116[arg0 - 30].equalsIgnoreCase(LocalizedText.HIDDEN)) {
