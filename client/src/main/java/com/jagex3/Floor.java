...
import deob.Static108;
import deob.Static117;
...
@OriginalClass("com.jagex3.client.client!ie")
public final class Floor {

	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "e", descriptor = "[I")
	private final int[] anIntArray262;

	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "i", descriptor = "[I")
	private final int[] anIntArray265;

	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "g", descriptor = "[I")
	private final int[] anIntArray263;

	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "a", descriptor = "[I")
	private final int[] anIntArray260;

	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "c", descriptor = "[[I")
	private final int[][] anIntArrayArray20;

	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "f", descriptor = "I")
	private final int anInt2880;

	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "d", descriptor = "[I")
	private final int[] anIntArray261;

	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "<init>", descriptor = "()V")
	public Floor() {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "a", descriptor = "(IIII[FI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "a", descriptor = "(IIIII)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "a", descriptor = "([FI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ie", name = "b", descriptor = "()Z")
