...
@OriginalClass("com.jagex3.client.client!sb")
public final class MaterialManager_Class106_Sub2_Sub1 extends MaterialManager_Class106_Sub2 {

	@OriginalMember(owner = "com.jagex3.client.client!sb", name = "I", descriptor = "[B")
	private byte[] aByteArray68;

	@OriginalMember(owner = "com.jagex3.client.client!sb", name = "<init>", descriptor = "()V")
	public MaterialManager_Class106_Sub2_Sub1() {
		super(12, 5, 16, 2, 2, 0.45F);
	}

	@OriginalMember(owner = "com.jagex3.client.client!sb", name = "a", descriptor = "(IB)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!sb", name = "b", descriptor = "(III)[B")
