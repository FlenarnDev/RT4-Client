...
public final class SeqType {
	...
	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "y", descriptor = "I")
	public int anInt5361;

	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "C", descriptor = "[[I")
	public int[][] anIntArrayArray38;

	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "G", descriptor = "[I")
	public int[] anIntArray474;

	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "I", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "f", descriptor = "I")
	public int anInt5349 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "e", descriptor = "I")
	public int anInt5348 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "d", descriptor = "Z")
	public boolean aBoolean278 = false;

	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "t", descriptor = "I")
	public int anInt5357 = 99;

	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "z", descriptor = "I")
	public int anInt5362 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "B", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "l", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!tk", name = "b", descriptor = "(B)V")
