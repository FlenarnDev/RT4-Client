...
import deob.Static271;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!ge")
public final class DataFile {

	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "a", descriptor = "Lclient!en;")
	private BufferedRandomAccessFile aClass38_1 = null;

	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "f", descriptor = "Lclient!en;")
	private BufferedRandomAccessFile aClass38_2 = null;

	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "l", descriptor = "I")
	private int anInt2156 = 65000;

	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "c", descriptor = "I")
	private final int anInt2150;

	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "<init>", descriptor = "(ILclient!en;Lclient!en;I)V")
	public DataFile(@OriginalArg(0) int arg0, @OriginalArg(1) BufferedRandomAccessFile arg1, @OriginalArg(2) BufferedRandomAccessFile arg2, @OriginalArg(3) int arg3) {
		this.anInt2156 = arg3;
	...
	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "toString", descriptor = "()Ljava/lang/String;")
	@Override
	public final String toString() {
		return "deob.Cache:" + this.anInt2150;
	}

	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "a", descriptor = "(II[BB)Z")
	public final boolean method1700(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2) {
		@Pc(7) BufferedRandomAccessFile local7 = this.aClass38_1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "a", descriptor = "(IB)[B")
	public final byte[] method1701(@OriginalArg(0) int arg0) {
		@Pc(9) BufferedRandomAccessFile local9 = this.aClass38_1;
		synchronized (this.aClass38_1) {
			try {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ge", name = "a", descriptor = "(BII[BZ)Z")
