...
import deob.Static222;
import deob.SynthEnvelopeSet;
import deob.Wave;
import deob.WaveCache;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!jk")
public final class Patch extends Linkable {

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "r", descriptor = "[B")
	public final byte[] aByteArray43 = new byte[128];

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "s", descriptor = "[I")
	private int[] anIntArray289 = new int[128];

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "u", descriptor = "I")
	public final int anInt3078;

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "w", descriptor = "[B")
	public final byte[] aByteArray44;

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "C", descriptor = "[B")
	public final byte[] aByteArray45 = new byte[128];

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "D", descriptor = "[Lclient!kj;")
	public final Wave[] aClass3_Sub16_Sub1Array1 = new Wave[128];

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "H", descriptor = "[S")
	public final short[] aShortArray36 = new short[128];

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "I", descriptor = "[Lclient!wh;")
	public final SynthEnvelopeSet[] aSynthEnvelopeSetArray1 = new SynthEnvelopeSet[128];

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "<init>", descriptor = "([B)V")
	public Patch(@OriginalArg(0) byte[] arg0) {
		@Pc(29) int local29 = 0;
		...
		@Pc(242) SynthEnvelopeSet[] local242 = new SynthEnvelopeSet[local194];
		for (local206 = 0; local206 < local242.length; local206++) {
			@Pc(256) SynthEnvelopeSet local256 = local242[local206] = new SynthEnvelopeSet();
		...
		local428 = 0;
		local375 = 0;
		@Pc(609) SynthEnvelopeSet local609 = null;
		@Pc(611) int local611;
		for (local611 = 0; local611 < 128; local611++) {
			if (this.anIntArray289[local611] != 0) {
				...
				this.aSynthEnvelopeSetArray1[local611] = local609;
				local375--;
			}
		}
		local375 = 0;
		...
		@Pc(729) SynthEnvelopeSet local729;
		@Pc(734) int local734;
	...
	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "d", descriptor = "(B)V")
	public final void method2432() {
		this.anIntArray289 = null;
	}

	@OriginalMember(owner = "com.jagex3.client.client!jk", name = "a", descriptor = "(I[ILclient!le;[B)Z")
	public final boolean method2436(@OriginalArg(1) int[] arg0, @OriginalArg(2) WaveCache arg1, @OriginalArg(3) byte[] arg2) {
		@Pc(8) int local8 = 0;
		@Pc(10) Wave local10 = null;
