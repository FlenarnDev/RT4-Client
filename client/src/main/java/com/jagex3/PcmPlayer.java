...
@OriginalClass("com.jagex3.client.client!vh")
public class PcmPlayer {

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "h", descriptor = "Lclient!qb;")
	private PcmStream aClass3_Sub3_6;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "n", descriptor = "[I")
	public int[] anIntArray411;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "D", descriptor = "I")
	private int anInt4637;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "H", descriptor = "I")
	public int anInt4641;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "K", descriptor = "I")
	public int anInt4644;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "a", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "x", descriptor = "I")
	private int anInt4634 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "v", descriptor = "J")
	private long aLong152 = 0L;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "E", descriptor = "I")
	private int anInt4638 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "A", descriptor = "Z")
	private boolean aBoolean229 = true;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "z", descriptor = "[Lclient!qb;")
	private final PcmStream[] aClass3_Sub3Array6 = new PcmStream[8];

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "y", descriptor = "J")
	private long aLong153 = 0L;

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "G", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "a", descriptor = "(I)V")
	public void method3562(@OriginalArg(0) int arg0) throws Exception {
	}

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "b", descriptor = "()V")
	protected void method3563() throws Exception {
	}

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "a", descriptor = "([II)V")
					...
					if ((local73 & 0x1) != 0) {
						...
						label100: while (true) {
							while (true) {
								...
								@Pc(101) PcmStreamable local101 = local96.aClass3_Sub16_5;
	...
	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "a", descriptor = "(Lclient!qb;IB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "d", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "a", descriptor = "(Ljava/awt/deob.Component;)V")
