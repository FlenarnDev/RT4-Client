...
public final class GlSolidColorTexture extends DoubleLinkable {
	...
	@OriginalMember(owner = "com.jagex3.client.client!sd", name = "K", descriptor = "I")
	private int anInt5058 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!sd", name = "L", descriptor = "I")
	private final int anInt5059;

	@OriginalMember(owner = "com.jagex3.client.client!sd", name = "<init>", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sd", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!sd", name = "g", descriptor = "(B)V")
