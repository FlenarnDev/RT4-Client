...
import deob.Static284;
import deob.Static44;
...
@OriginalClass("com.jagex3.client.client!te")
public final class MidiMixer extends PcmStream {

	@OriginalMember(owner = "com.jagex3.client.client!te", name = "w", descriptor = "Lclient!ih;")
	public final LinkList aClass69_126 = new LinkList();

	@OriginalMember(owner = "com.jagex3.client.client!te", name = "K", descriptor = "Lclient!ei;")
	public final Mixer aClass3_Sub3_Sub2_2 = new Mixer();

	@OriginalMember(owner = "com.jagex3.client.client!te", name = "E", descriptor = "Lclient!va;")
	private final MidiPlayer aClass3_Sub3_Sub4_3;

	@OriginalMember(owner = "com.jagex3.client.client!te", name = "<init>", descriptor = "(Lclient!va;)V")
	public MidiMixer(@OriginalArg(0) MidiPlayer arg0) {
		this.aClass3_Sub3_Sub4_3 = arg0;
	}

	@OriginalMember(owner = "com.jagex3.client.client!te", name = "d", descriptor = "()Lclient!qb;")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!te", name = "b", descriptor = "()Lclient!qb;")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!te", name = "a", descriptor = "(Lclient!mf;II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!te", name = "a", descriptor = "()I")
	@Override
	public final int method4404() {
		return 0;
	}

	@OriginalMember(owner = "com.jagex3.client.client!te", name = "c", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!te", name = "b", descriptor = "([III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!te", name = "a", descriptor = "([ILclient!mf;IIIB)V")
	private void method4146(@OriginalArg(0) int[] arg0, @OriginalArg(1) MidiNote arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if ((this.aClass3_Sub3_Sub4_3.anIntArray508[arg1.anInt3773] & 0x4) != 0 && arg1.anInt3767 < 0) {
			...
			while (true) {
				...
				@Pc(58) WaveStream local58 = arg1.aClass3_Sub3_Sub1_3;
