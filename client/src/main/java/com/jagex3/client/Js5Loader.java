...
@OriginalClass("com.jagex3.client.client!al")
public final class Js5Loader {
	...
	@OriginalMember(owner = "com.jagex3.client.client!al", name = "j", descriptor = "Lclient!k;")
	private final Js5CacheQueue aClass80_1;

	@OriginalMember(owner = "com.jagex3.client.client!al", name = "f", descriptor = "Lclient!jb;")
	private final Js5Net aClass73_1;

	@OriginalMember(owner = "com.jagex3.client.client!al", name = "c", descriptor = "Lclient!pm;")
	private Js5NetRequest aClass3_Sub2_Sub5_Sub2_1;

	@OriginalMember(owner = "com.jagex3.client.client!al", name = "<init>", descriptor = "(Lclient!jb;Lclient!k;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!al", name = "b", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!al", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!al", name = "a", descriptor = "(IILclient!ge;Lclient!ge;)Lclient!bg;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!al", name = "a", descriptor = "(Lclient!ge;IIZLclient!ge;)Lclient!bg;")
