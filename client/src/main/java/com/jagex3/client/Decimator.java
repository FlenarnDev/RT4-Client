...
import deob.Static180;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!vj")
public final class Decimator {

	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "k", descriptor = "I")
	private int anInt5769;

	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "i", descriptor = "[[I")
	private int[][] anIntArrayArray40;

	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "e", descriptor = "I")
	private int anInt5766;

	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "<init>", descriptor = "(II)V")
	public Decimator(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 != arg0) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "a", descriptor = "([BB)[B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "a", descriptor = "(IB)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "a", descriptor = "(ZI)I")
