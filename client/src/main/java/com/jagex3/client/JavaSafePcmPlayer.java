...
@OriginalClass("com.jagex3.client.client!hl")
public final class JavaSafePcmPlayer extends PcmPlayer {

	@OriginalMember(owner = "com.jagex3.client.client!hl", name = "L", descriptor = "I")
	private final int anInt2606;

	@OriginalMember(owner = "com.jagex3.client.client!hl", name = "<init>", descriptor = "(Lsignlink!ll;I)V")
	public JavaSafePcmPlayer(@OriginalArg(0) SignLink arg0, @OriginalArg(1) int arg1) {
		Static100.anInterface10_1 = arg0.method5125();
		this.anInt2606 = arg1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!hl", name = "c", descriptor = "()I")
	@Override
	protected final int method3569() {
		return Static100.anInterface10_1.method5098(this.anInt2606);
	}

	@OriginalMember(owner = "com.jagex3.client.client!hl", name = "a", descriptor = "()V")
	@Override
	protected final void method3561() {
		Static100.anInterface10_1.method5102(this.anInt2606, this.anIntArray411);
	}

	@OriginalMember(owner = "com.jagex3.client.client!hl", name = "a", descriptor = "(Ljava/awt/deob.Component;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!hl", name = "b", descriptor = "()V")
	@Override
	protected final void method3563() {
		Static100.anInterface10_1.method5097(this.anInt2606);
	}

	@OriginalMember(owner = "com.jagex3.client.client!hl", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!hl", name = "d", descriptor = "()V")
	@Override
