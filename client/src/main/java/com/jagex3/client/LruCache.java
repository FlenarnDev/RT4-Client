...
@OriginalClass("com.jagex3.client.client!gn")
public final class LruCache {

	@OriginalMember(owner = "com.jagex3.client.client!gn", name = "l", descriptor = "Lclient!rg;")
	private DoubleLinkable aClass3_Sub2_37 = new DoubleLinkable();

	@OriginalMember(owner = "com.jagex3.client.client!gn", name = "s", descriptor = "Lclient!ce;")
	private final secondaryLinkList aClass16_1 = new secondaryLinkList();

	@OriginalMember(owner = "com.jagex3.client.client!gn", name = "u", descriptor = "I")
	private int anInt2314;

	@OriginalMember(owner = "com.jagex3.client.client!gn", name = "r", descriptor = "I")
	private final int anInt2313;

	@OriginalMember(owner = "com.jagex3.client.client!gn", name = "q", descriptor = "Lclient!sc;")
	private final HashTable aClass133_5;

	@OriginalMember(owner = "com.jagex3.client.client!gn", name = "<init>", descriptor = "(I)V")
	...
	public final void method1815() {
		...
		this.aClass3_Sub2_37 = new DoubleLinkable();
