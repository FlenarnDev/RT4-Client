...
@OriginalClass("com.jagex3.client.client!jb")
public final class Js5Net {

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "A", descriptor = "J")
	private long aLong104;

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "B", descriptor = "Lclient!ma;")
	private ClientStream aClass95_1;

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "C", descriptor = "I")
	private int anInt2962;

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "J", descriptor = "Lclient!pm;")
	private Js5NetRequest aClass3_Sub2_Sub5_Sub2_2;

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "a", descriptor = "Lclient!ce;")
	private final secondaryLinkList aClass16_2 = new secondaryLinkList();

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "q", descriptor = "Lclient!ce;")
	private final secondaryLinkList aClass16_3 = new secondaryLinkList();

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "v", descriptor = "Lclient!ce;")
	private final secondaryLinkList aClass16_4 = new secondaryLinkList();

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "z", descriptor = "Lclient!ce;")
	private final secondaryLinkList aClass16_5 = new secondaryLinkList();

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "E", descriptor = "Lclient!wa;")
	private final Packet aClass3_Sub15_4 = new Packet(4);

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "G", descriptor = "B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "F", descriptor = "Lclient!wa;")
	private final Packet aClass3_Sub15_5 = new Packet(8);

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "a", descriptor = "(I)Z")
	public final boolean method2316() {
		return this.method2321() >= 20;
	}

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "b", descriptor = "(B)Z")
		...
		try {
			...
			for (@Pc(172) int local172 = 0; local172 < 100; local172++) {
				...
				if (local196 <= 0) {
					...
					this.aClass95_1.read(this.aClass3_Sub2_Sub5_Sub2_2.aClass3_Sub15_7.pos, local235, this.aClass3_Sub2_Sub5_Sub2_2.aClass3_Sub15_7.data);
					if (this.aByte8 != 0) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "b", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "a", descriptor = "(ZLclient!ma;I)V")
	public final void loggedOut(@OriginalArg(0) boolean arg0, @OriginalArg(1) ClientStream arg1) {
		if (this.aClass95_1 != null) {
			try {
				this.aClass95_1.close();
	...
	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "c", descriptor = "(B)Z")
	public final boolean method2326() {
		return this.method2328() >= 20;
	}

	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "d", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "a", descriptor = "(IIBIZ)Lclient!pm;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jb", name = "e", descriptor = "(B)V")
