...
import deob.Static135;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!ki")
public final class MidiParser {

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "b", descriptor = "[I")
	public int[] anIntArray310;

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "c", descriptor = "[I")
	private int[] anIntArray311;

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "d", descriptor = "I")
	public int anInt3303;

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "f", descriptor = "[I")
	private int[] anIntArray312;

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "g", descriptor = "J")
	private long aLong117;

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "h", descriptor = "[I")
	private int[] anIntArray313;

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "i", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "<init>", descriptor = "([B)V")
	public MidiParser(@OriginalArg(0) byte[] arg0) {
		this.method2635(arg0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "a", descriptor = "(I)J")
	public final long method2625(@OriginalArg(0) int arg0) {
		return this.aLong117 + (long) arg0 * (long) this.anInt3304;
	}

	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "b", descriptor = "()Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "a", descriptor = "(J)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "c", descriptor = "()Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "b", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "a", descriptor = "(II)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ki", name = "f", descriptor = "()V")
