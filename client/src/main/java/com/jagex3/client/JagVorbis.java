...
@OriginalClass("com.jagex3.client.client!jc")
public final class JagVorbis extends Linkable {

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "r", descriptor = "I")
	private int anInt2973;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "s", descriptor = "I")
	private int anInt2974;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "w", descriptor = "[F")
	private float[] aFloatArray11;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "x", descriptor = "Z")
	private boolean aBoolean148;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "z", descriptor = "I")
	private int anInt2976;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "D", descriptor = "I")
	private int anInt2977;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "K", descriptor = "I")
	private int anInt2980;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "M", descriptor = "[[B")
	private byte[][] aByteArrayArray10;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "N", descriptor = "Z")
	private boolean aBoolean150;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "O", descriptor = "I")
	private int anInt2981;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "R", descriptor = "[B")
	private byte[] aByteArray41;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "U", descriptor = "I")
	private int anInt2983;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "V", descriptor = "I")
	private int anInt2984;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "<init>", descriptor = "([B)V")
	public JagVorbis(@OriginalArg(0) byte[] arg0) {
		this.method2342(arg0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "a", descriptor = "([I)Lclient!kj;")
	public final Wave method2341(@OriginalArg(0) int[] arg0) {
		...
		return new Wave(this.anInt2980, local129, this.anInt2976, this.anInt2977, this.aBoolean148);
	}
	...
	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "d", descriptor = "(I)[F")
	private float[] method2348(@OriginalArg(0) int arg0) {
		...
		@Pc(140) boolean local140 = !Static117.aFloorArray1[local131].method2272();
		...
		if (!local140) {
			...
			Static117.aFloorArray1[local176].method2269(Static117.aFloatArray14, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
