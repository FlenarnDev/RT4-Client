...
@OriginalClass("com.jagex3.client.client!fi")
public final class HuffmanCodec {

	@OriginalMember(owner = "com.jagex3.client.client!fi", name = "c", descriptor = "[I")
	public static final int[] anIntArray175 = new int[256];

	@OriginalMember(owner = "com.jagex3.client.client!fi", name = "b", descriptor = "[I")
	private int[] anIntArray174;

	@OriginalMember(owner = "com.jagex3.client.client!fi", name = "h", descriptor = "[I")
	private final int[] anIntArray176;

	@OriginalMember(owner = "com.jagex3.client.client!fi", name = "e", descriptor = "[B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fi", name = "<init>", descriptor = "([B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fi", name = "a", descriptor = "(II[B[BII)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fi", name = "a", descriptor = "(II[BI[BI)I")
