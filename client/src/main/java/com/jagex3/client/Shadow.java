...
@OriginalClass("com.jagex3.client.client!wm")
public final class Shadow {

	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "a", descriptor = "Lclient!vi;")
	private GlVertexBufferObject aClass155_6;

	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "c", descriptor = "Ljava/nio/ByteBuffer;")
	private ByteBuffer aByteBuffer11;

	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "e", descriptor = "Ljava/nio/ByteBuffer;")
	private ByteBuffer aByteBuffer12;

	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "f", descriptor = "Lclient!vi;")
	private GlVertexBufferObject aClass155_7;

	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "b", descriptor = "Z")
	public boolean aBoolean313 = true;

	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "h", descriptor = "I")
	private int anInt5902 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "d", descriptor = "I")
	private final int anInt5901;

	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "<init>", descriptor = "()V")
	public Shadow() {
	...
	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "a", descriptor = "(Lclient!ek;II)Z")
	public final boolean method4677(@OriginalArg(0) SoftwarePix8 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!wm", name = "b", descriptor = "()V")
