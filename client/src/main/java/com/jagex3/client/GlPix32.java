...
import deob.Static63;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!cf")
public class GlPix32 extends AbstractPix32 {

	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "O", descriptor = "I")
	public int anInt1870;

	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "cb", descriptor = "I")
	public int anInt1874;

	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "db", descriptor = "I")
	private int anInt1875;

	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "L", descriptor = "I")
	protected int anInt1869 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "ab", descriptor = "I")
	public int anInt1872 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "Z", descriptor = "I")
	private int anInt1871 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "bb", descriptor = "I")
	private int anInt1873 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "<init>", descriptor = "(IIIIII[I)V")
	public GlPix32(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6) {
		this.anInt1860 = arg0;
		this.anInt1866 = arg1;
		this.anInt1863 = arg2;
		this.anInt1861 = arg3;
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "<init>", descriptor = "(Lclient!mm;)V")
	public GlPix32(@OriginalArg(0) Pix32 arg0) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "d", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "a", descriptor = "(IILclient!cf;)V")
	public final void method1425(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) GlPix32 arg2) {
		if (arg2 == null) {
			return;
		}
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "c", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "a", descriptor = "(IIIIIIIILclient!cf;)V")
	public final void method1427(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) GlPix32 arg8) {
		if (arg8 == null) {
			return;
		}
		GlRenderer.method4149();
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "d", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "e", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "b", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "a", descriptor = "(IIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "c", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "a", descriptor = "(IIIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "b", descriptor = "(IIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "b", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "a", descriptor = "([I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!cf", name = "a", descriptor = "()V")
