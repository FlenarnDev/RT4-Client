...
import deob.Static68;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!fg")
public final class Ground {

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "s", descriptor = "Z")
	public boolean aBoolean113 = true;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "a", descriptor = "I")
	public final int anInt1966;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "b", descriptor = "I")
	public final int anInt1967;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "p", descriptor = "I")
	public final int anInt1969;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "k", descriptor = "I")
	public final int anInt1968;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "q", descriptor = "[I")
	public final int[] anIntArray168;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "e", descriptor = "[I")
	public final int[] anIntArray160;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "h", descriptor = "[I")
	public final int[] anIntArray163;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "n", descriptor = "[I")
	public final int[] anIntArray166;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "g", descriptor = "[I")
	public final int[] anIntArray162;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "c", descriptor = "[I")
	public final int[] anIntArray158;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "o", descriptor = "[I")
	public final int[] anIntArray167;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "v", descriptor = "[I")
	public final int[] anIntArray172;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "u", descriptor = "[I")
	public final int[] anIntArray171;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "f", descriptor = "[I")
	public int[] anIntArray161;

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "<init>", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
	public Ground(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
