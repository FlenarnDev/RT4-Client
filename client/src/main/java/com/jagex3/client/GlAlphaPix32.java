...
@OriginalClass("com.jagex3.client.client!el")
public final class GlAlphaPix32 extends GlPix32 {

	@OriginalMember(owner = "com.jagex3.client.client!el", name = "<init>", descriptor = "(IIIIII[I)V")
	public GlAlphaPix32(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6) {
		super(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
	}

	@OriginalMember(owner = "com.jagex3.client.client!el", name = "<init>", descriptor = "(Lclient!mm;)V")
	public GlAlphaPix32(@OriginalArg(0) Pix32 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!el", name = "a", descriptor = "([I)V")
	@Override
