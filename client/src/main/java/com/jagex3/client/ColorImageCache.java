...
import deob.Static105;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!pf")
public final class ColorImageCache {

	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "d", descriptor = "I")
	private int anInt4467 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "m", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "a", descriptor = "I")
	private final int anInt4465;

	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "e", descriptor = "[Lclient!qi;")
	private ColorImageCacheEntry[] aClass3_Sub28Array1;

	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "s", descriptor = "I")
	private final int anInt4475;

	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "g", descriptor = "[[I")
	private int[][] anIntArrayArray34;

	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "<init>", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "b", descriptor = "(II)[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pf", name = "a", descriptor = "(B)[[I")
