...
@OriginalClass("com.jagex3.client.client!dm")
public final class IdkType {

	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "b", descriptor = "[S")
	private short[] aShortArray11;

	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "i", descriptor = "[S")
	private short[] aShortArray12;

	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "s", descriptor = "[S")
	private short[] aShortArray13;

	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "t", descriptor = "[S")
	private short[] aShortArray14;

	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "w", descriptor = "[I")
	private int[] anIntArray112;

	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "x", descriptor = "[I")
	private final int[] anIntArray113 = new int[] { -1, -1, -1, -1, -1 };

	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "k", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "a", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "b", descriptor = "(B)Lclient!gb;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dm", name = "c", descriptor = "(I)Z")
