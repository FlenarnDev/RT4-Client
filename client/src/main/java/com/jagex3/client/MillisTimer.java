...
@OriginalClass("com.jagex3.client.client!lj")
public final class MillisTimer extends Timer {

	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "o", descriptor = "I")
	private int anInt3549;

	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "x", descriptor = "[J")
	private final long[] aLongArray4 = new long[10];

	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "r", descriptor = "I")
	private int anInt3550 = 256;

	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "u", descriptor = "I")
	private int anInt3552 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "v", descriptor = "I")
	private int anInt3553 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "k", descriptor = "J")
	private long aLong122 = MonotonicClock.currentTime();

	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "<init>", descriptor = "()V")
	public MillisTimer() {
	...
	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "b", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!lj", name = "a", descriptor = "(III)I")
	@Override
	public final int method3391(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		this.anInt3550 = 300;
		this.anInt3552 = 1;
		this.aLong122 = MonotonicClock.currentTime();
		...
		Static231.sleepPrecise((long) this.anInt3552);
		local139 = 0;
