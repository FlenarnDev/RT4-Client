...
import deob.Static285;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!dd")
public final class PixFont extends PixFontGeneric {

	@OriginalMember(owner = "com.jagex3.client.client!dd", name = "Eb", descriptor = "[[B")
	private byte[][] aByteArrayArray7 = new byte[256][];

	@OriginalMember(owner = "com.jagex3.client.client!dd", name = "<init>", descriptor = "([B)V")
	public PixFont(@OriginalArg(0) byte[] arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!dd", name = "<init>", descriptor = "([B[I[I[I[I[[B)V")
	public PixFont(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) byte[][] arg5) {
		super(arg0, arg1, arg2, arg3, arg4);
		this.aByteArrayArray7 = arg5;
	}

	@OriginalMember(owner = "com.jagex3.client.client!dd", name = "a", descriptor = "(IIIIIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!dd", name = "a", descriptor = "(IIIIIIZ)V")
	@Override
