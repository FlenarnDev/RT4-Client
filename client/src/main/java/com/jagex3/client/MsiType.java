...
public final class MsiType {
	...
	public final SoftwarePix8 method9(@OriginalArg(0) int arg0) {
		...
		spritesArchive.method4506(this.anInt12);
		local17 = Static164.method3119(this.anInt12, spritesArchive);
		if (local17 != null) {
			local17.method1389(redDelta, greenDelta, blueDelta);
