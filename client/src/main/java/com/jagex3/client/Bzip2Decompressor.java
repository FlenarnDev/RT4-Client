...
public final class Bzip2Decompressor {
	...
	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "a", descriptor = "Lclient!bb;")
	private static final Bzip2DState aClass11_1 = new Bzip2DState();

	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "a", descriptor = "(ILclient!bb;)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "a", descriptor = "(Lclient!bb;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "a", descriptor = "([I[I[I[BIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "b", descriptor = "(Lclient!bb;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "c", descriptor = "(Lclient!bb;)B")
	private static byte method3313(@OriginalArg(0) Bzip2DState arg0) {
		return (byte) method3309(8, arg0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "d", descriptor = "(Lclient!bb;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "e", descriptor = "(Lclient!bb;)B")
	private static byte method3315(@OriginalArg(0) Bzip2DState arg0) {
		return (byte) method3309(1, arg0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!oc", name = "a", descriptor = "([BI[BII)I")
