...
@OriginalClass("com.jagex3.client.client!mb")
public final class GlPixFont extends PixFontGeneric {

	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "Gb", descriptor = "[I")
	private int[] anIntArray349;

	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "Hb", descriptor = "I")
	private int anInt3639;

	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "Ib", descriptor = "I")
	private int anInt3640;

	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "Fb", descriptor = "I")
	private int anInt3638 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "Eb", descriptor = "I")
	private int anInt3637 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "<init>", descriptor = "([B[I[I[I[I[[B)V")
	public GlPixFont(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) byte[][] arg5) {
		super(arg0, arg1, arg2, arg3, arg4);
		this.method2881(arg5);
		this.method2880();
	}

	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "a", descriptor = "(IIIIIIZ)V")
	@Override
	protected final void method2854(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		GlRenderer.setTextureId(this.anInt3638);
		@Pc(68) GlPix32 local68 = Static46.aClass3_Sub2_Sub1_Sub2_1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "a", descriptor = "(IIIIIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "b", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mb", name = "a", descriptor = "([[B)V")
