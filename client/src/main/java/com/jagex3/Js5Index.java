...
import deob.Static162;
import deob.Static71;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!ii")
public final class Js5Index {

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "b", descriptor = "[[I")
	public int[][] anIntArrayArray21;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "d", descriptor = "[I")
	public int[] anIntArray268;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "f", descriptor = "I")
	public int anInt2902;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "h", descriptor = "Lclient!jg;")
	public IntHashTable aClass76_1;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "m", descriptor = "[I")
	public int[] anIntArray269;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "n", descriptor = "[I")
	public int[] anIntArray270;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "o", descriptor = "[I")
	public int[] anIntArray271;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "p", descriptor = "[I")
	public int[] anIntArray272;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "r", descriptor = "[I")
	public int[] anIntArray273;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "s", descriptor = "[[I")
	public int[][] anIntArrayArray22;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "u", descriptor = "I")
	public int anInt2907;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "v", descriptor = "I")
	public int anInt2908;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "x", descriptor = "[Lclient!jg;")
	public IntHashTable[] aClass76Array1;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "z", descriptor = "I")
	public final int anInt2911;

	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "<init>", descriptor = "([BI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ii", name = "a", descriptor = "(I[B)V")
