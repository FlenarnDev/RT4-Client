...
@OriginalClass("com.jagex3.client.client!qa")
public final class JavaPcmPlayer extends PcmPlayer {

	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "L", descriptor = "I")
	private int anInt4645;

	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "M", descriptor = "Ljavax/sound/sampled/SourceDataLine;")
	private SourceDataLine aSourceDataLine1;

	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "O", descriptor = "Ljavax/sound/sampled/AudioFormat;")
	private AudioFormat anAudioFormat1;

	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "P", descriptor = "[B")
	private byte[] aByteArray64;

	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "N", descriptor = "Z")
	private boolean aBoolean230 = false;

	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "d", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "a", descriptor = "(Ljava/awt/deob.Component;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "c", descriptor = "()I")
	@Override
	protected final int method3569() {
		return this.anInt4645 - (this.aSourceDataLine1.available() >> (Static164.aBoolean192 ? 2 : 1));
	}

	@OriginalMember(owner = "com.jagex3.client.client!qa", name = "a", descriptor = "()V")
	@Override
