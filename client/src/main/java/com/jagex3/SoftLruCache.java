...
@OriginalClass("com.jagex3.client.client!n")
public final class SoftLruCache {

	@OriginalMember(owner = "com.jagex3.client.client!n", name = "k", descriptor = "Lclient!ce;")
	private final secondaryLinkList aClass16_8 = new secondaryLinkList();

	@OriginalMember(owner = "com.jagex3.client.client!n", name = "m", descriptor = "I")
	private final int anInt3970;

	@OriginalMember(owner = "com.jagex3.client.client!n", name = "g", descriptor = "I")
	private int anInt3966;

	@OriginalMember(owner = "com.jagex3.client.client!n", name = "n", descriptor = "Lclient!sc;")
	private final HashTable aClass133_18;

	@OriginalMember(owner = "com.jagex3.client.client!n", name = "<init>", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "a", descriptor = "(BLjava/lang/Object;J)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "a", descriptor = "(JB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "a", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "c", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "b", descriptor = "(JB)Ljava/lang/Object;")
