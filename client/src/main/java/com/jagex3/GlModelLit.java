...
@OriginalClass("com.jagex3.client.client!td")
public final class GlModelLit extends ModelLit {

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "t", descriptor = "[S")
	private short[] aShortArray75;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "v", descriptor = "[S")
	private short[] aShortArray76;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "w", descriptor = "[S")
	private short[] aShortArray77;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "x", descriptor = "Lclient!vi;")
	private GlVertexBufferObject aClass155_5;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "y", descriptor = "[S")
	private short[] aShortArray78;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "z", descriptor = "Lclient!ql;")
	private GlBuffer aClass127_1;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "A", descriptor = "Lclient!ql;")
	private GlBuffer aClass127_2;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "B", descriptor = "[B")
	private byte[] aByteArray71;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "C", descriptor = "Lclient!ql;")
	private GlBuffer aClass127_3;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "E", descriptor = "S")
	private short aShort28;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "F", descriptor = "[B")
	private byte[] aByteArray72;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "H", descriptor = "[I")
	public int[] anIntArray461;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "J", descriptor = "[F")
	private float[] aFloatArray25;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "K", descriptor = "[[I")
	private int[][] anIntArrayArray36;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "L", descriptor = "[S")
	private short[] aShortArray79;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "M", descriptor = "[S")
	private short[] aShortArray80;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "N", descriptor = "[S")
	private short[] aShortArray81;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "O", descriptor = "[[I")
	private int[][] anIntArrayArray37;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "P", descriptor = "[S")
	private short[] aShortArray82;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "Q", descriptor = "[S")
	private short[] aShortArray83;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "R", descriptor = "[S")
	private short[] aShortArray84;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "U", descriptor = "Lclient!ae;")
	public GlBoundingBox aGlBoundingBox_1;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "W", descriptor = "[S")
	private short[] aShortArray85;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "X", descriptor = "[I")
	private int[] anIntArray462;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "Y", descriptor = "Lclient!ql;")
	public GlBuffer aClass127_4;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "Z", descriptor = "[I")
	private int[] anIntArray463;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "ab", descriptor = "[S")
	private short[] aShortArray86;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "cb", descriptor = "Lclient!de;")
	private GlMModel_Class23 aClass23_1;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "db", descriptor = "[I")
	private int[] anIntArray464;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "eb", descriptor = "[I")
	public int[] anIntArray465;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "fb", descriptor = "Lclient!ql;")
	private GlBuffer aClass127_5;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "gb", descriptor = "[F")
	private float[] aFloatArray26;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "hb", descriptor = "[I")
	public int[] anIntArray466;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "ib", descriptor = "S")
	private short aShort29;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "u", descriptor = "Z")
	public boolean aBoolean259 = false;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "I", descriptor = "I")
	public int anInt5295 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "S", descriptor = "I")
	private int anInt5296 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "V", descriptor = "B")
	private byte aByte18 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "kb", descriptor = "B")
	private byte aByte19 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "lb", descriptor = "I")
	private int anInt5297 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "<init>", descriptor = "()V")
	public GlModelLit() {
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "<init>", descriptor = "(Lclient!gb;IIZ)V")
	public GlModelLit(@OriginalArg(0) ModelUnlit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		this.aGlBoundingBox_1 = new GlBoundingBox();
		...
		for (local439 = 0; local439 < this.anInt5297; local439++) {
			...
			if (local902 == 0) {
				...
				@Pc(2004) PointNormal local2004 = arg0.aClass57Array1[local919];
				...
				@Pc(2033) PointNormal local2033 = arg0.aClass57Array1[local1280];
				...
				@Pc(2065) PointNormal local2065 = arg0.aClass57Array1[local2060];
				...
				@Pc(2096) FaceNormal local2096 = arg0.aClass126Array1[local810];
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(ZZZ)Lclient!ak;")
	@Override
	public final ModelLit method4560(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2) {
		return this.method4114(arg0, arg1, arg2, Static237.aClass8_Sub1_Sub1_4, Static237.aClass8_Sub1_Sub1_3);
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(IIIIIIIIJILclient!ga;)V")
	@Override
	public final void method4546(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) long arg8, @OriginalArg(9) int arg9, @OriginalArg(10) ParticleSystem arg10) {
		...
		@Pc(13) short local13 = this.aGlBoundingBox_1.aShort4;
		@Pc(17) short local17 = this.aGlBoundingBox_1.aShort2;
		@Pc(21) short local21 = this.aGlBoundingBox_1.aShort3;
		...
		if (arg8 > 0L && Static39.aBoolean77 && local70 > 0) {
			...
			if (Static150.anInt3582 >= local187 && Static150.anInt3582 <= local191 && Static34.anInt1053 >= local206 && Static34.anInt1053 <= local210) {
				...
				local206 = 999999;
				local210 = -999999;
				@Pc(243) short local243 = this.aGlBoundingBox_1.aShort6;
				@Pc(247) short local247 = this.aGlBoundingBox_1.aShort5;
				@Pc(251) short local251 = this.aGlBoundingBox_1.aShort8;
				@Pc(255) short local255 = this.aGlBoundingBox_1.aShort7;
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "m", descriptor = "()V")
	public final void method4093() {
		...
		this.aGlBoundingBox_1.aBoolean3 = false;
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "n", descriptor = "()I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "g", descriptor = "()I")
	@Override
	public final int method4561() {
		if (!this.aGlBoundingBox_1.aBoolean3) {
			this.method4108();
		}
		return this.aGlBoundingBox_1.aShort5;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "c", descriptor = "()I")
	@Override
	public final int method4550() {
		if (!this.aGlBoundingBox_1.aBoolean3) {
			this.method4108();
		}
		return this.aGlBoundingBox_1.aShort7;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "()Z")
	@Override
	...
	public final int method4576() {
		...
		return this.aGlBoundingBox_1.aShort8;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "c", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "b", descriptor = "(ZZZ)Lclient!ak;")
	@Override
	public final ModelLit method4568(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2) {
		return this.method4114(arg0, arg1, arg2, Static237.aClass8_Sub1_Sub1_6, Static237.aClass8_Sub1_Sub1_5);
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(Lclient!th;IIIZ)V")
	@Override
	public final void method4544(@OriginalArg(0) ModelSource arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		@Pc(2) GlModelLit local2 = (GlModelLit) arg0;
		...
		if (!local2.aGlBoundingBox_1.aBoolean3) {
			local2.method4108();
		}
		@Pc(105) short local105 = local2.aGlBoundingBox_1.aShort2;
		@Pc(109) short local109 = local2.aGlBoundingBox_1.aShort3;
		@Pc(113) short local113 = local2.aGlBoundingBox_1.aShort6;
		@Pc(117) short local117 = local2.aGlBoundingBox_1.aShort5;
		@Pc(121) short local121 = local2.aGlBoundingBox_1.aShort8;
		@Pc(125) short local125 = local2.aGlBoundingBox_1.aShort7;
						...
						if (local175 != -1) {
							for (local189 = 0; local189 < local12; local189++) {
								if (local152 == local15[local189] && local166 == local21[local189] && local138 == local18[local189]) {
									...
									if (local237 != -1) {
										if (local40 == null) {
											this.aClass23_1 = new GlMModel_Class23();
										...
										if (local68 == null) {
											@Pc(325) GlMModel_Class23 local325 = local2.aClass23_1 = new GlMModel_Class23();
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(IIIIIIIJ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(Lclient!gb;IJIIIIFF)S")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(I[IIIIZI[I)V")
	@Override
	...
	public final int calcBoundingCylinder() {
		...
		return this.aGlBoundingBox_1.aShort2;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "o", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "e", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "p", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "b", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "c", descriptor = "(ZZZ)Lclient!ak;")
	@Override
	public final ModelLit method4572(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2) {
		return this.method4114(arg0, arg1, arg2, Static237.aClass8_Sub1_Sub1_2, Static237.aClass8_Sub1_Sub1_1);
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "e", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "f", descriptor = "(I)V")
	public final void method4105(@OriginalArg(0) int arg0) {
		this.aShort29 = (short) arg0;
		this.aClass127_1.aBoolean235 = false;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "d", descriptor = "()Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(SS)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "s", descriptor = "()V")
	private void method4108() {
		...
		this.aGlBoundingBox_1.aShort6 = (short) local1;
		this.aGlBoundingBox_1.aShort5 = (short) local7;
		this.aGlBoundingBox_1.aShort2 = (short) local3;
		this.aGlBoundingBox_1.aShort3 = (short) local9;
		this.aGlBoundingBox_1.aShort8 = (short) local5;
		this.aGlBoundingBox_1.aShort7 = (short) local11;
		this.aGlBoundingBox_1.aShort4 = (short) (Math.sqrt((double) local13) + 0.99D);
		Math.sqrt((double) local15);
		this.aGlBoundingBox_1.aBoolean3 = true;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "b", descriptor = "(SS)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(IILclient!td;[[I[[IIII)V")
	public final void method4110(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) GlModelLit arg2, @OriginalArg(3) int[][] arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (!arg2.aGlBoundingBox_1.aBoolean3) {
			arg2.method4108();
		}
		@Pc(11) int local11 = arg5 + arg2.aGlBoundingBox_1.aShort6;
		@Pc(17) int local17 = arg5 + arg2.aGlBoundingBox_1.aShort5;
		@Pc(23) int local23 = arg7 + arg2.aGlBoundingBox_1.aShort8;
		@Pc(29) int local29 = arg7 + arg2.aGlBoundingBox_1.aShort7;
		...
		if (arg0 == 1) {
			...
			@Pc(374) int local374;
			if (arg0 == 2) {
				@Pc(266) short local266 = arg2.aGlBoundingBox_1.aShort2;
				...
				local150 = arg2.aGlBoundingBox_1.aShort3 - arg2.aGlBoundingBox_1.aShort2;
				for (local161 = 0; local161 < this.anInt5295; local161++) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(ZZZZZZZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(ZZZZZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(ZZZLclient!td;Lclient!td;)Lclient!ak;")
	private ModelLit method4114(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) GlModelLit arg3, @OriginalArg(4) GlModelLit arg4) {
		...
		if (arg3.aGlBoundingBox_1 == null) {
			arg3.aGlBoundingBox_1 = new GlBoundingBox();
		}
		arg3.aGlBoundingBox_1.aBoolean3 = false;
		if (arg0) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(III)Lclient!th;")
	@Override
	public final ModelSource method4539() {
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "t", descriptor = "()I")
	public final int method4115() {
		return this.aShort28;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "u", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(ZZZZZZZZZZZ)Lclient!td;")
	public final GlModelLit method4117(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) boolean arg4, @OriginalArg(6) boolean arg5, @OriginalArg(7) boolean arg6, @OriginalArg(9) boolean arg7, @OriginalArg(10) boolean arg8) {
		@Pc(3) GlModelLit local3 = new GlModelLit();
		...
		if (arg0 && arg1) {
			...
			local3.aGlBoundingBox_1 = this.aGlBoundingBox_1;
		} else {
			local3.aClass127_4 = new GlBuffer();
			local3.aGlBoundingBox_1 = new GlBoundingBox();
		}
		if (arg2) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "i", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(IIIIIIII)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "j", descriptor = "()I")
	@Override
	public final int method4566() {
		if (!this.aGlBoundingBox_1.aBoolean3) {
			this.method4108();
		}
		return this.aGlBoundingBox_1.aShort4;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(I[IIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(IIII)V")
	@Override
	...
	public final int method4562() {
		...
		return this.aGlBoundingBox_1.aShort6;
	}

	@OriginalMember(owner = "com.jagex3.client.client!td", name = "w", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "f", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "x", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "g", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "a", descriptor = "(Lclient!ek;)Lclient!ek;")
	public final SoftwarePix8 method4124(@OriginalArg(0) SoftwarePix8 arg0) {
		if (this.anInt5296 == 0) {
			return null;
		}
		if (!this.aGlBoundingBox_1.aBoolean3) {
		...
		if (Static161.anInt3920 > 0) {
			local26 = this.aGlBoundingBox_1.aShort6 - (this.aGlBoundingBox_1.aShort3 * Static161.anInt3920 >> 8) >> 3;
			local40 = this.aGlBoundingBox_1.aShort5 - (this.aGlBoundingBox_1.aShort2 * Static161.anInt3920 >> 8) >> 3;
		} else {
			local26 = this.aGlBoundingBox_1.aShort6 - (this.aGlBoundingBox_1.aShort2 * Static161.anInt3920 >> 8) >> 3;
			local40 = this.aGlBoundingBox_1.aShort5 - (this.aGlBoundingBox_1.aShort3 * Static161.anInt3920 >> 8) >> 3;
		}
		@Pc(85) int local85;
		@Pc(99) int local99;
		if (Static161.anInt3921 > 0) {
			local85 = this.aGlBoundingBox_1.aShort8 - (this.aGlBoundingBox_1.aShort3 * Static161.anInt3921 >> 8) >> 3;
			local99 = this.aGlBoundingBox_1.aShort7 - (this.aGlBoundingBox_1.aShort2 * Static161.anInt3921 >> 8) >> 3;
		} else {
			local85 = this.aGlBoundingBox_1.aShort8 - (this.aGlBoundingBox_1.aShort2 * Static161.anInt3921 >> 8) >> 3;
			local99 = this.aGlBoundingBox_1.aShort7 - (this.aGlBoundingBox_1.aShort3 * Static161.anInt3921 >> 8) >> 3;
		}
		@Pc(134) int local134 = local40 + 1 - local26;
		@Pc(140) int local140 = local99 + 1 - local85;
		@Pc(151) SoftwarePix8 local151;
		if (arg0 == null || arg0.aByteArray18.length < local134 * local140) {
			local151 = new SoftwarePix8(local134, local140, 0);
		} else {
			local151 = arg0;
	...
	@OriginalMember(owner = "com.jagex3.client.client!td", name = "l", descriptor = "()V")
	@Override
