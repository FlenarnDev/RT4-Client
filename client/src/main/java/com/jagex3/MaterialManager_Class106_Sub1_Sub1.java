...
@OriginalClass("com.jagex3.client.client!ng")
public final class MaterialManager_Class106_Sub1_Sub1 extends MaterialManager_Class106_Sub1 {

	@OriginalMember(owner = "com.jagex3.client.client!ng", name = "O", descriptor = "[B")
	private byte[] aByteArray58;

	@OriginalMember(owner = "com.jagex3.client.client!ng", name = "<init>", descriptor = "()V")
	public MaterialManager_Class106_Sub1_Sub1() {
		super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ng", name = "b", descriptor = "(III)[B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ng", name = "a", descriptor = "(IB)V")
	@Override
