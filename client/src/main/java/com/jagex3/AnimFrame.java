...
import deob.Static168;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!ne")
public final class AnimFrame {

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "c", descriptor = "Lclient!jm;")
	public AnimBase aClass3_Sub20_1 = null;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "b", descriptor = "I")
	public int anInt4070 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "e", descriptor = "Z")
	public boolean aBoolean197 = false;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "a", descriptor = "Z")
	public boolean aBoolean196 = false;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "d", descriptor = "[S")
	public final short[] aShortArray42;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "g", descriptor = "[S")
	public final short[] aShortArray44;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "o", descriptor = "[S")
	public final short[] aShortArray50;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "n", descriptor = "[S")
	public final short[] aShortArray49;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "f", descriptor = "[S")
	public final short[] aShortArray43;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "l", descriptor = "[B")
	public final byte[] aByteArray55;

	@OriginalMember(owner = "com.jagex3.client.client!ne", name = "<init>", descriptor = "([BLclient!jm;)V")
		...
		for (local47 = 0; local47 < local33; local47++) {
			...
			if (local64 > 0) {
				...
				if ((local64 & 0x1) == 0) {
					...
					Static168.aShortArray48[local35] = (short) local26.gsmarts();
				}
				if ((local64 & 0x2) == 0) {
					Static168.aShortArray46[local35] = local77;
				} else {
					Static168.aShortArray46[local35] = (short) local26.gsmarts();
				}
				if ((local64 & 0x4) == 0) {
					Static168.aShortArray45[local35] = local77;
				} else {
					Static168.aShortArray45[local35] = (short) local26.gsmarts();
				}
