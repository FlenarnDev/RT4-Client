...
import deob.Static289;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!en")
public final class BufferedRandomAccessFile {

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "m", descriptor = "J")
	private long aLong67;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "v", descriptor = "I")
	private int anInt1906;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "p", descriptor = "J")
	private long aLong68 = -1L;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "g", descriptor = "I")
	private int anInt1899 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "w", descriptor = "J")
	private long aLong69 = -1L;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "s", descriptor = "Lsignlink!qm;")
	private final FileOnDisk aClass214_1;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "a", descriptor = "J")
	private long aLong64;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "j", descriptor = "J")
	private long aLong65;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "q", descriptor = "[B")
	private final byte[] aByteArray20;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "b", descriptor = "[B")
	private final byte[] aByteArray19;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "k", descriptor = "J")
	private long aLong66;

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "<init>", descriptor = "(Lsignlink!qm;II)V")
	public BufferedRandomAccessFile(@OriginalArg(0) FileOnDisk arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
	...
	@OriginalMember(owner = "com.jagex3.client.client!en", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!en", name = "a", descriptor = "(I)J")
	public final long method1451() {
		return this.aLong65;
	}

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "b", descriptor = "(I)Ljava/io/File;")
	private File method1452() {
		return this.aClass214_1.method5138();
	}

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "a", descriptor = "(I[BII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!en", name = "b", descriptor = "(Z)V")
	public final void method1455() throws IOException {
		this.method1450();
		this.aClass214_1.method5136();
	}

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!en", name = "a", descriptor = "(Z[B)V")
	public final void method1457(@OriginalArg(1) byte[] arg0) throws IOException {
		this.method1453(0, arg0, arg0.length);
	}

	@OriginalMember(owner = "com.jagex3.client.client!en", name = "a", descriptor = "([BIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!en", name = "a", descriptor = "(IJ)V")
