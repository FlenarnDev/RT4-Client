...
import deob.Static286;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!ek")
public final class SoftwarePix8 extends Pix8 {

	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "o", descriptor = "[B")
	public byte[] aByteArray18;

	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "n", descriptor = "[I")
	private final int[] anIntArray144;

	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "<init>", descriptor = "(IIIIII[B[I)V")
	public SoftwarePix8(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte[] arg6, @OriginalArg(7) int[] arg7) {
		this.anInt4279 = arg0;
		this.anInt4276 = arg1;
		this.anInt4280 = arg2;
		this.anInt4273 = arg3;
	...
	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "<init>", descriptor = "(III)V")
	public SoftwarePix8(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "b", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "b", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ek", name = "a", descriptor = "(IIII)V")
