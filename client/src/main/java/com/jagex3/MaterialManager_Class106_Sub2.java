...
@OriginalClass("com.jagex3.client.client!vd")
public class MaterialManager_Class106_Sub2 extends MaterialManager_Class106 {

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "x", descriptor = "I")
	private int anInt5010;

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "H", descriptor = "[B")
	private byte[] aByteArray67;

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "J", descriptor = "I")
	private int anInt5017;

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "G", descriptor = "[I")
	private final int[] anIntArray441 = new int[this.anInt5008];

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "<init>", descriptor = "(IIIIIF)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "a", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "a", descriptor = "(B)V")
	@Override
