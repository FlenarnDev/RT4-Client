...
@OriginalClass("com.jagex3.client.client!k")
public final class Js5CacheQueue implements Runnable {
	...
	@OriginalMember(owner = "com.jagex3.client.client!k", name = "w", descriptor = "Z")
	private boolean aBoolean161 = false;

	@OriginalMember(owner = "com.jagex3.client.client!k", name = "v", descriptor = "Ljava/lang/Thread;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!k", name = "run", descriptor = "()V")
	@Override
