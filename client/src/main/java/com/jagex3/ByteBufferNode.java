...
@OriginalClass("com.jagex3.client.client!ua")
public final class ByteBufferNode extends ByteArrayWrapper {

	@OriginalMember(owner = "com.jagex3.client.client!ua", name = "m", descriptor = "Ljava/nio/ByteBuffer;")
	private ByteBuffer aByteBuffer10;

	@OriginalMember(owner = "com.jagex3.client.client!ua", name = "a", descriptor = "(I[B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ua", name = "a", descriptor = "(I)[B")
	@Override
