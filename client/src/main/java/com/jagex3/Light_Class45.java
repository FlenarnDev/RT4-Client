...
@OriginalClass("com.jagex3.client.client!fj")
public final class Light_Class45 {

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "a", descriptor = "Lclient!vi;")
	private GlVertexBufferObject aClass155_1;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "b", descriptor = "[I")
	private int[] anIntArray177;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "c", descriptor = "[B")
	private byte[] aByteArray23;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "d", descriptor = "[I")
	private int[] anIntArray178;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "e", descriptor = "Lclient!vi;")
	private GlVertexBufferObject aClass155_2;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "f", descriptor = "Ljava/nio/ByteBuffer;")
	private ByteBuffer aByteBuffer1;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "g", descriptor = "[I")
	private int[] anIntArray179;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "h", descriptor = "[I")
	private int[] anIntArray180;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "i", descriptor = "[B")
	private byte[] aByteArray24;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "j", descriptor = "I")
	public int anInt2016;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "k", descriptor = "Ljava/nio/ByteBuffer;")
	private ByteBuffer aByteBuffer2;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "l", descriptor = "I")
	public int anInt2017;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "m", descriptor = "[B")
	private byte[] aByteArray25;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "n", descriptor = "I")
	public int anInt2018;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "o", descriptor = "Lclient!sc;")
	private HashTable aClass133_4;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "p", descriptor = "I")
	public int anInt2019;

	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "a", descriptor = "(Lclient!gi;IIIFFF)I")
	public final int method1553(@OriginalArg(0) Light arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
		...
		if ((arg1 & 0x7F) == 0 || (arg3 & 0x7F) == 0) {
			local1 = arg1 + (arg3 << 16);
			@Pc(23) IntNode local23 = (IntNode) this.aClass133_4.find(local1);
			if (local23 != null) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "b", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fj", name = "a", descriptor = "([I)V")
