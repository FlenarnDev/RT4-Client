...
@OriginalClass("com.jagex3.client.client!di")
public final class JavaSafePixMap extends PixMap implements ImageProducer, ImageObserver {

	@OriginalMember(owner = "com.jagex3.client.client!di", name = "A", descriptor = "Ljava/awt/image/ImageConsumer;")
	private ImageConsumer anImageConsumer1;

	@OriginalMember(owner = "com.jagex3.client.client!di", name = "B", descriptor = "Ljava/awt/image/ColorModel;")
	private ColorModel aColorModel1;

	@OriginalMember(owner = "com.jagex3.client.client!di", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!di", name = "a", descriptor = "(IIIBI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!di", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!di", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V")
	@Override
	public final void startProduction(@OriginalArg(0) ImageConsumer arg0) {
		this.addConsumer(arg0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!di", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!di", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z")
	@Override
	public final synchronized boolean isConsumer(@OriginalArg(0) ImageConsumer arg0) {
		return this.anImageConsumer1 == arg0;
	}

	@OriginalMember(owner = "com.jagex3.client.client!di", name = "a", descriptor = "(IILjava/awt/Graphics;I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!di", name = "a", descriptor = "(IZILjava/awt/deob.Component;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!di", name = "imageUpdate", descriptor = "(Ljava/awt/Image;IIIII)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!di", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V")
	@Override
