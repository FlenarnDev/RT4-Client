...
import deob.Static171;
import deob.Static225;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!wf")
public abstract class MaterialManager_Class106 {

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "c", descriptor = "[S")
	private short[] aShortArray70;

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "a", descriptor = "[S")
	private final short[] aShortArray69 = new short[512];

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "i", descriptor = "I")
	private int anInt5000 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "m", descriptor = "I")
	private int anInt5003 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "l", descriptor = "I")
	private int anInt5002 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "r", descriptor = "I")
	private int anInt5007 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "t", descriptor = "I")
	protected int anInt5008 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "<init>", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "a", descriptor = "(B)V")
	protected abstract void method3842();

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "a", descriptor = "(I)V")
	protected abstract void method3844();

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "a", descriptor = "(III)V")
