...
public final class QuickChatPhraseType extends DoubleLinkable {
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "U", descriptor = "[[I")
	private int[][] anIntArrayArray5;

	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "V", descriptor = "[Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "a", descriptor = "(Lclient!wa;I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "e", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "a", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "c", descriptor = "(II)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "a", descriptor = "(Z)I")
	public final int method767() {
		return this.anIntArray71 == null ? 0 : this.anIntArray71.length;
	}

	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "a", descriptor = "(Lclient!wa;II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "f", descriptor = "(I)Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "a", descriptor = "(ILclient!wa;)Lclient!na;")
