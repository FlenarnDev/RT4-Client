...
@OriginalClass("com.jagex3.client.client!vm")
public final class SpecularMaterialRenderer implements MaterialRenderer {

	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "a", descriptor = "I")
	private int anInt5777 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "c", descriptor = "[I")
	private int[] anIntArray519 = null;

	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "b", descriptor = "Z")
	private boolean aBoolean301 = false;

	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "d", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!vm", name = "e", descriptor = "()V")
