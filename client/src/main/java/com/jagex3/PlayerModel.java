...
public final class PlayerModel {
	...
	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "l", descriptor = "[I")
	private int[] anIntArray233;

	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "m", descriptor = "I")
	private int anInt2497;

	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "q", descriptor = "J")
	private long aLong88;

	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "t", descriptor = "[I")
	private int[] anIntArray236;

	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "w", descriptor = "[[I")
	private int[][] anIntArrayArray19;

	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "x", descriptor = "Z")
	public boolean aBoolean141;

	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "a", descriptor = "(IIIILclient!tk;III)Lclient!ak;")
	public final ModelLit method1946(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) SeqType arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		@Pc(30) ModelLit local30 = (ModelLit) Static139.aClass99_21.method3106(local24);
		if (local30 == null) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "a", descriptor = "(I)V")
	private void method1947() {
		@Pc(8) long local8 = this.aLong88;
		this.aLong88 = -1L;
		@Pc(13) long[] local13 = FaceNormal.aLongArray7;
	...
	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "a", descriptor = "(ZZ)V")
	public final void method1948(@OriginalArg(0) boolean arg0) {
		this.aBoolean141 = arg0;
		this.method1947();
	}

	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "a", descriptor = "([IIZI[II)V")
	public final void method1950(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(4) int[] arg3, @OriginalArg(5) int arg4) {
		...
		if (arg3 == null) {
			...
			for (@Pc(24) int local24 = 0; local24 < 8; local24++) {
				for (@Pc(31) int local31 = 0; local31 < FluType.anInt1716; local31++) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!hh", name = "a", descriptor = "(IZI)V")
	...
	public final ModelLit method1954(@OriginalArg(0) Class147[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) SeqType arg2, @OriginalArg(3) SeqType arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) int arg8) {
		...
		@Pc(154) ModelLit local154 = (ModelLit) Static250.aClass99_33.method3106(local41);
		...
		if (local154 == null) {
			...
			if (local158) {
				if (this.aLong87 != -1L) {
					local154 = (ModelLit) Static250.aClass99_33.method3106(this.aLong87);
				}
				if (local154 == null) {
					return null;
				}
