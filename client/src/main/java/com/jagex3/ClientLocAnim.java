...
@OriginalClass("com.jagex3.client.client!dc")
public final class ClientLocAnim extends ModelSource {

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "U", descriptor = "Lclient!ga;")
	private ParticleSystem aClass47_Sub1_2;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "x", descriptor = "I")
	private int anInt1296 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "t", descriptor = "Z")
	private boolean aBoolean80 = false;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "s", descriptor = "I")
	private int anInt1294 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "B", descriptor = "Z")
	private boolean aBoolean81 = true;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "Q", descriptor = "Lclient!ek;")
	private SoftwarePix8 aClass36_Sub1_2 = null;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "T", descriptor = "I")
	private final int anInt1311 = -32768;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "eb", descriptor = "I")
	private int anInt1319 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "gb", descriptor = "I")
	private int anInt1321 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "ib", descriptor = "I")
	private int anInt1322 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "H", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "N", descriptor = "I")
	private final int anInt1308;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "L", descriptor = "I")
	private final int anInt1307;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "C", descriptor = "I")
	private final int anInt1299;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "D", descriptor = "I")
	private final int anInt1300;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "u", descriptor = "Lclient!tk;")
	private SeqType aClass144_2;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "y", descriptor = "I")
	private int anInt1297;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "I", descriptor = "I")
	private int anInt1304;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "bb", descriptor = "I")
	private int anInt1317;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "fb", descriptor = "I")
	private int anInt1320;

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "<init>", descriptor = "(IIIIIIIZLclient!th;)V")
	public ClientLocAnim(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) ModelSource arg8) {
		this.anInt1303 = arg3;
		this.anInt1295 = arg2;
		this.anInt1308 = arg4;
		this.anInt1307 = arg1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "a", descriptor = "(IIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "a", descriptor = "(IIIIIIIIJILclient!ga;)V")
	@Override
	public final void method4546(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) long arg8, @OriginalArg(9) int arg9, @OriginalArg(10) ParticleSystem arg10) {
		@Pc(3) ModelSource local3 = this.method1049();
		if (local3 != null) {
			local3.method4546(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, this.aClass47_Sub1_2);
		}
	}

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "finalize", descriptor = "()V")
	@Override
	public final void finalize() {
	}

	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "b", descriptor = "(III)V")
	...
	private ModelSource method1048(@OriginalArg(0) boolean arg0) {
		...
		@Pc(69) int local69;
		if (Client.modegame != 0 && this.aBoolean80 && (this.aClass144_2 == null || this.aClass144_2 != null && this.aClass144_2.anInt5361 != local19.anInt4430)) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!dc", name = "d", descriptor = "(I)Lclient!th;")
	public final ModelSource method1049() {
