...
import deob.Static13;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!nd")
public final class MonochromeImageCache {

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "c", descriptor = "[B")
	public static final byte[] aByteArray53 = new byte[32896];

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "f", descriptor = "I")
	private int anInt4062 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "k", descriptor = "I")
	private int anInt4066 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "g", descriptor = "Lclient!ih;")
	private LinkList aClass69_96 = new LinkList();

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "w", descriptor = "Z")
	public boolean aBoolean195 = false;

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "l", descriptor = "I")
	private final int anInt4067;

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "i", descriptor = "I")
	private final int anInt4064;

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "o", descriptor = "[Lclient!lb;")
	private MonochromeImageCacheEntry[] aClass3_Sub23Array1;

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "a", descriptor = "[[[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "<init>", descriptor = "(III)V")
	public MonochromeImageCache(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt4067 = arg1;
		this.anInt4064 = arg0;
		this.aClass3_Sub23Array1 = new MonochromeImageCacheEntry[this.anInt4067];
		this.anIntArrayArrayArray13 = new int[this.anInt4064][3][arg2];
	}

	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "a", descriptor = "(B)[[[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nd", name = "a", descriptor = "(BI)[[I")
	public final int[][] method3173(@OriginalArg(1) int arg0) {
		if (this.anInt4064 == this.anInt4067) {
			...
			@Pc(44) MonochromeImageCacheEntry local44 = this.aClass3_Sub23Array1[arg0];
			if (local44 == null) {
				this.aBoolean195 = true;
				if (this.anInt4066 < this.anInt4064) {
					local44 = new MonochromeImageCacheEntry(arg0, this.anInt4066);
					this.anInt4066++;
				} else {
