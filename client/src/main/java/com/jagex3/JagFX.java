...
@OriginalClass("com.jagex3.client.client!sl")
public final class JagFX {

	@OriginalMember(owner = "com.jagex3.client.client!sl", name = "b", descriptor = "[Lclient!pj;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sl", name = "a", descriptor = "I")
	private int anInt5206;

	@OriginalMember(owner = "com.jagex3.client.client!sl", name = "<init>", descriptor = "(Lclient!wa;)V")
	public JagFX(@OriginalArg(0) Packet arg0) {
