...
import deob.Static74;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex3.client.client!bg")
public final class Js5CachedResourceProvider extends Js5ResourceProvider {

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "m", descriptor = "Lclient!ii;")
	private Js5Index aClass70_1;

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "w", descriptor = "[B")
	private byte[] aByteArray9;

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "T", descriptor = "Z")
	private boolean aBoolean36;

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "u", descriptor = "I")
	private int anInt567 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "p", descriptor = "Lclient!sc;")
	private final HashTable aClass133_1 = new HashTable(16);

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "S", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "L", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "H", descriptor = "I")
	private final int anInt573;

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "W", descriptor = "Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "x", descriptor = "Lclient!il;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "a", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "b", descriptor = "(I)Lclient!ii;")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "c", descriptor = "(I)I")
	public final int method529() {
		return this.anInt567;
	}

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "d", descriptor = "(I)I")
	public final int method533() {
		if (this.aClass70_1 == null) {
			return 0;
		} else if (this.aBoolean35) {
			@Pc(25) Linkable local25 = this.aClass69_17.head();
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "c", descriptor = "(Z)V")
	public final void method534() {
		...
		if (!this.aBoolean37 || this.aLong20 > MonotonicClock.currentTime()) {
			return;
		}
		for (@Pc(331) Js5Request local331 = (Js5Request) this.aClass133_1.search(); local331 != null; local331 = (Js5Request) this.aClass133_1.find()) {
		...
		this.aLong20 = MonotonicClock.currentTime() + 1000L;
	}

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "b", descriptor = "(II)I")
	@Override
	public final int method524(@OriginalArg(0) int arg0) {
		@Pc(15) Js5Request local15 = (Js5Request) this.aClass133_1.find((long) arg0);
		return local15 == null ? 0 : local15.method3553();
	}

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "b", descriptor = "(B)I")
	public final int method535() {
		return this.aClass70_1 == null ? 0 : this.aClass70_1.anInt2902;
	}

	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "a", descriptor = "(III)Lclient!il;")
	private Js5Request method536(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(13) Js5Request local13 = (Js5Request) this.aClass133_1.find((long) arg1);
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "e", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "f", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bg", name = "c", descriptor = "(II)[B")
	@Override
