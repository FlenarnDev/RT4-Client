...
public final class Map extends DoubleLinkable {
	...
	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "L", descriptor = "I")
	public int anInt759 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "S", descriptor = "I")
	public int anInt763 = 12800;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "Z", descriptor = "I")
	public int anInt770 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "cb", descriptor = "I")
	public int anInt771 = 12800;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "P", descriptor = "Z")
	public boolean aBoolean50 = true;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "db", descriptor = "I")
	public int anInt772 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "T", descriptor = "I")
	public final int anInt764;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "bb", descriptor = "Lclient!na;")
	public final JagString aClass100_138;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "Q", descriptor = "Lclient!na;")
	public final JagString aClass100_137;

	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "Y", descriptor = "I")
	...
	public final boolean method664(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		for (@Pc(33) MapChunk local33 = (MapChunk) this.aClass69_23.head(); local33 != null; local33 = (MapChunk) this.aClass69_23.next()) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "f", descriptor = "(B)V")
	public final void method665() {
		this.anInt771 = 12800;
		this.anInt770 = 0;
		this.anInt758 = 0;
		this.anInt763 = 12800;
		for (@Pc(29) MapChunk local29 = (MapChunk) this.aClass69_23.head(); local29 != null; local29 = (MapChunk) this.aClass69_23.next()) {
