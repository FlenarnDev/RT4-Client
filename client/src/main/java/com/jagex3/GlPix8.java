...
@OriginalClass("com.jagex3.client.client!oh")
public final class GlPix8 extends Pix8 {

	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "r", descriptor = "I")
	private int anInt4285;

	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "s", descriptor = "I")
	private int anInt4286;

	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "t", descriptor = "I")
	private int anInt4287;

	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "n", descriptor = "I")
	private int anInt4281 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "p", descriptor = "I")
	private int anInt4283 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "o", descriptor = "I")
	private int anInt4282 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "q", descriptor = "I")
	private int anInt4284 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "<init>", descriptor = "(IIIIII[B[I)V")
	public GlPix8(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte[] arg6, @OriginalArg(7) int[] arg7) {
		this.anInt4279 = arg0;
		this.anInt4276 = arg1;
		this.anInt4280 = arg2;
		this.anInt4273 = arg3;
	...
	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "a", descriptor = "([B[I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "a", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!oh", name = "a", descriptor = "()V")
