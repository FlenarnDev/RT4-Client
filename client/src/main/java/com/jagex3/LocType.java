...
public final class LocType {
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "n", descriptor = "[I")
	private int[] anIntArray378;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "v", descriptor = "[S")
	private short[] aShortArray62;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "B", descriptor = "Lclient!sc;")
	private HashTable aClass133_19;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "H", descriptor = "[S")
	private short[] aShortArray63;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "P", descriptor = "[B")
	private byte[] aByteArray63;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "X", descriptor = "[I")
	private int[] anIntArray379;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "db", descriptor = "[I")
	public int[] anIntArray380;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "hb", descriptor = "I")
	public int anInt4426;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "wb", descriptor = "[I")
	public int[] anIntArray381;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "e", descriptor = "I")
	public int anInt4397 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "i", descriptor = "Z")
	public boolean aBoolean206 = false;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "l", descriptor = "I")
	public int anInt4403 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "C", descriptor = "Z")
	public boolean aBoolean211 = false;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "u", descriptor = "I")
	private int anInt4407 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "E", descriptor = "Lclient!na;")
	public JagString aClass100_830 = Static81.aClass100_475;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "D", descriptor = "Z")
	public boolean aBoolean212 = true;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "t", descriptor = "I")
	public int anInt4406 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "R", descriptor = "I")
	public int anInt4414 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "S", descriptor = "I")
	public int anInt4415 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "G", descriptor = "B")
	private byte aByte15 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "r", descriptor = "Z")
	public boolean aBoolean208 = false;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "T", descriptor = "I")
	public int anInt4416 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "w", descriptor = "I")
	private int anInt4408 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "W", descriptor = "I")
	public int anInt4419 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "h", descriptor = "I")
	public int anInt4400 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "L", descriptor = "Z")
	public boolean aBoolean214 = false;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "Y", descriptor = "I")
	public int anInt4420 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "A", descriptor = "S")
	private short aShort26 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "g", descriptor = "I")
	private int anInt4399 = 128;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "z", descriptor = "[Lclient!na;")
	public JagString[] aClass100Array130 = new JagString[5];

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "d", descriptor = "I")
	private int anInt4396 = 128;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "s", descriptor = "Z")
	public boolean aBoolean209 = true;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "o", descriptor = "I")
	private int anInt4404 = 128;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "y", descriptor = "Z")
	public boolean aBoolean210 = false;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "kb", descriptor = "I")
	public int anInt4429 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "lb", descriptor = "Z")
	public boolean aBoolean216 = false;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "fb", descriptor = "Z")
	public boolean aBoolean215 = true;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "nb", descriptor = "I")
	private int anInt4431 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "bb", descriptor = "I")
	public int anInt4423 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "pb", descriptor = "I")
	public int anInt4433 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "m", descriptor = "Z")
	public boolean aBoolean207 = true;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "qb", descriptor = "I")
	private int anInt4434 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "c", descriptor = "I")
	public int anInt4395 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "jb", descriptor = "I")
	public int anInt4428 = 16;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "tb", descriptor = "Z")
	public boolean aBoolean218 = false;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "N", descriptor = "I")
	private int anInt4411 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "k", descriptor = "I")
	public int anInt4402 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "p", descriptor = "I")
	private int anInt4405 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "mb", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "ub", descriptor = "I")
	public int anInt4435 = 2;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "sb", descriptor = "Z")
	private boolean aBoolean217 = false;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "gb", descriptor = "I")
	private int anInt4425 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "yb", descriptor = "I")
	public int anInt4438 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "zb", descriptor = "Z")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!va", name = "b", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!wc", name = "a", descriptor = "(II)Lclient!pb;")
    public static LocType list(@OriginalArg(1) int arg0) {
        @Pc(15) LocType local15 = (LocType) Static179.aClass99_25.method3106((long) arg0);
        if (local15 != null) {
            return local15;
        }
        @Pc(30) byte[] local30 = locConfig.method4495(Static253.method4328(arg0), Static33.method872(arg0));
        local15 = new LocType();
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "a", descriptor = "(I)Lclient!pb;")
	public final LocType method3417() {
		...
		if (local26 < 0 || local26 >= this.anIntArray380.length - 1 || this.anIntArray380[local26] == -1) {
			...
			return local84 == -1 ? null : list(local84);
		} else {
			return list(this.anIntArray380[local26]);
		}
	}

	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "a", descriptor = "(III)Lclient!gb;")
	private ModelUnlit method3418(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(265) ModelUnlit local265 = new ModelUnlit(local7, arg0 == 0 && !local211 && !local230, this.aShortArray61 == null, this.aShortArray60 == null, true);
		if (arg1 == 4 && arg0 > 3) {
			local265.method1682();
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "d", descriptor = "(I)Z")
	public final boolean method3422() {
		...
		for (@Pc(44) int local44 = 0; local44 < this.anIntArray380.length; local44++) {
			if (this.anIntArray380[local44] != -1) {
				@Pc(70) LocType local70 = list(this.anIntArray380[local44]);
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "a", descriptor = "(IIB)I")
	public final int method3423(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass133_19 == null) {
			return arg0;
		} else {
			@Pc(21) IntNode local21 = (IntNode) this.aClass133_19.find((long) arg1);
	...
	private void method3425(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 == 1) {
			...
			if (this.aClass100Array130[arg1 - 30].equalsIgnoreCase(LocalizedText.HIDDEN)) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "a", descriptor = "(Z)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "a", descriptor = "(IZZI)Lclient!td;")
	private GlModelLit method3427(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) int arg2) {
		@Pc(10) int local10 = this.anInt4407 + 64;
		@Pc(17) int local17 = this.anInt4405 * 5 + 768;
		@Pc(79) GlModelLit local79;
		@Pc(24) int local24;
		@Pc(177) int local177;
		if (this.anIntArray378 == null) {
			if (arg2 != 10) {
			...
			local79 = (GlModelLit) Static169.aClass99_24.method3106(local135);
			if (local79 == null) {
				...
				local79 = new GlModelLit(local175, local10, local17, arg1);
			...
			if (local79 == null) {
				...
				local79 = new GlModelLit(local90, local10, local17, arg1);
		...
		@Pc(351) GlModelLit local351 = local79.method4117(local294, local264, this.aShortArray61 == null, local79.method4094() == local10, arg0 == 0 && !local236, true, local17 == local79.method4115(), !local236, this.aShortArray60 == null);
		if (local236) {
			local351.method4122();
		}
		if (arg2 == 4 && arg0 > 3) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "a", descriptor = "(II[[III[[IZLclient!ek;BZI)Lclient!sm;")
	public final Class139 method3428(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[][] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) SoftwarePix8 arg7, @OriginalArg(9) boolean arg8, @OriginalArg(10) int arg9) {
		@Pc(29) long local29;
		if (GlRenderer.enabled) {
			...
			@Pc(330) GlModelLit local330 = local235.method4117(this.aByte15 != 3, this.aByte15 == 0, true, true, true, !local298, true, true, true);
			if (this.aByte15 != 0) {
		...
		@Pc(60) ModelSource local60 = (ModelSource) Static93.aClass99_14.method3106(local29);
		if (local60 == null) {
		...
		if (this.aByte15 != 0) {
			if (local60 instanceof SoftwareModelLit) {
				local60 = ((SoftwareModelLit) local60).method4586(this.aByte15, this.aShort26, arg2, arg5, arg1, arg4, arg9, true);
			} else if (local60 instanceof ModelUnlit) {
				local60 = ((ModelUnlit) local60).method1670(this.aByte15, this.aShort26, arg2, arg5, arg1, arg4, arg9);
			}
		}
	...
	public final Class139 method3429(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) SoftwarePix8 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) SeqType arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[][] arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(10) int[][] arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12) {
		...
		if (!GlRenderer.enabled) {
			...
			@Pc(195) SoftwareModelLit local195 = (SoftwareModelLit) Static262.aClass99_36.method3106(local30);
			if (local195 == null) {
			...
			if (arg4 != null) {
				local234 = true;
				local195 = (SoftwareModelLit) arg4.method4214(arg8, arg10, local195, arg5, arg12);
			}
			if (arg11 == 10 && arg5 > 3) {
				if (!local234) {
					local234 = true;
					local195 = (SoftwareModelLit) local195.method4568(true, true, true);
				}
		...
		@Pc(46) GlModelLit local46 = (GlModelLit) Static262.aClass99_36.method3106(local30);
		if (local46 == null) {
		...
		if (arg4 != null) {
			local82 = (GlModelLit) arg4.method4216(arg10, arg8, arg12, arg5, local46);
			local80 = true;
		}
		if (arg11 == 10 && arg5 > 3) {
			if (!local80) {
				local82 = (GlModelLit) local82.method4568(true, true, true);
				local80 = true;
			}
	...
	@OriginalMember(owner = "com.jagex3.client.client!pb", name = "a", descriptor = "(Lclient!na;II)Lclient!na;")
	public final JagString method3430(@OriginalArg(0) JagString arg0, @OriginalArg(2) int arg1) {
		if (this.aClass133_19 == null) {
			return arg0;
		} else {
			@Pc(26) StringNode local26 = (StringNode) this.aClass133_19.find((long) arg1);
