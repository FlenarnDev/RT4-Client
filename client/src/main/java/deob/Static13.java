...
public final class Static13 {
    ...
    @OriginalMember(owner = "com.jagex3.client.client!bc", name = "X", descriptor = "I")
	public static int anInt436;

	@OriginalMember(owner = "com.jagex3.client.client!bc", name = "Z", descriptor = "I")
	public static int anInt437;

	@OriginalMember(owner = "com.jagex3.client.client!bc", name = "I", descriptor = "Z")
	...
	public static JagString method471() {
		...
		} else if (Client.shiftClick && ClientKeyboardListener.keyHeld[81] && Client.menuNumEntries > 2) {
		...
		if (Client.menuNumEntries > 2) {
			local32 = JagString.join(new JagString[] { local32, Static1.aClass100_2, JagString.parseInt(Client.menuNumEntries - 2), LocalizedText.MOREOPTIONS});
		}
		return local32;
	}
	...
	public static void drawProgress(@OriginalArg(0) Color arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) JagString arg2, @OriginalArg(4) int arg3) {
		try {
			...
			if (arg1) {
				...
				local6.fillRect(0, 0, GameShell.anInt1448, GameShell.anInt5554);
			}
			if (arg0 == null) {
			...
			try {
				...
				local6.drawImage(Static149.anImage3, GameShell.anInt1448 / 2 - 152, GameShell.anInt5554 / 2 + -18, null);
			} catch (@Pc(134) Exception local134) {
				@Pc(140) int local140 = GameShell.anInt1448 / 2 - 152;
				@Pc(146) int local146 = GameShell.anInt5554 / 2 - 18;
			...
			if (Static278.mainLoadPrimaryText != null) {
				local6.setFont(Static222.aFont1);
				local6.setColor(Color.white);
				Static278.mainLoadPrimaryText.method3112(GameShell.anInt5554 / 2 - 26, GameShell.anInt1448 / 2 - Static278.mainLoadPrimaryText.method3155(Static240.aFontMetrics1) / 2, local6);
			}
