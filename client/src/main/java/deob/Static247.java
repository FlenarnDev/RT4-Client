...
public final class Static247 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ub", name = "h", descriptor = "[Lclient!pe;")
	public static Occlude[] aOccludeArray2;

	@OriginalMember(owner = "com.jagex3.client.client!ub", name = "m", descriptor = "I")
	public static int anInt5405;

	@OriginalMember(owner = "com.jagex3.client.client!ub", name = "a", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ub", name = "a", descriptor = "(Lclient!bj;Z)V")
	public static void method4245(@OriginalArg(0) Square arg0, @OriginalArg(1) boolean arg1) {
		Static7.aClass69_32.push(arg0);
		while (true) {
			@Pc(8) Square local8;
			@Pc(18) int local18;
			@Pc(21) int local21;
							...
							do {
								do {
									while (true) {
										...
										while (true) {
											do {
												local8 = (Square) Static7.aClass69_32.popFront();
												if (local8 == null) {
													return;
												}
											...
											local31 = World.activeTiles[local24];
											@Pc(33) float local33 = 0.0F;
											if (GlRenderer.enabled) {
												if (Static80.anIntArrayArrayArray19 == World.groundh) {
											...
											if (arg1) {
												if (local24 > 0) {
													local153 = World.activeTiles[local24 - 1][local18][local21];
											...
											if (local8.aClass3_Sub5_1 != null) {
												...
												for (local65 = 0; local65 < local153.spriteCount; local65++) {
													...
													if (var25 != null) {
														...
														var25.aClass8_4.method4546(var25.anInt1714, Static109.anInt2886, Static121.anInt3038, Static231.anInt5205, Static81.anInt2222, var25.anInt1699 - Static149.anInt3555, var25.anInt1706 - Static162.anInt3947, var25.anInt1703 - Static217.anInt4903, var25.typecode, local24, null);
													}
												}
												if (GlRenderer.enabled) {
													GlRenderer.method4159(local33);
											...
											if (var24) {
												...
												@Pc(1064) GroundObject local1064 = local8.aClass79_1;
											...
											if (local894 != 0) {
												if (local18 < Static167.anInt4069 && (local894 & 0x4) != 0) {
													...
													if (var32 != null && var32.aBoolean46) {
														Static7.aClass69_32.push(var32);
													}
												}
										...
										if (local8.anInt663 != 0) {
											...
											for (var10 = 0; var10 < local8.spriteCount; var10++) {
												if (local8.sprites[var10].anInt1707 != Static13.anInt437 && (local8.anIntArray59[var10] & local8.anInt663) == local8.anInt665) {
													var24 = false;
													break;
												}
											}
										...
										try {
											...
											while (var10 > 0) {
												...
												if (!Static73.method1599(local27, local1697.anInt1701, local1697.anInt1713, local1697.anInt1696, local1697.anInt1698, local1697.aClass8_4.calcBoundingCylinder())) {
													if (GlRenderer.enabled) {
													...
													local1697.aClass8_4.method4546(local1697.anInt1714, Static109.anInt2886, Static121.anInt3038, Static231.anInt5205, Static81.anInt2222, local1697.anInt1699 - Static149.anInt3555, local1697.anInt1706 - Static162.anInt3947, local1697.anInt1703 - Static217.anInt4903, local1697.typecode, local24, null);
												}
												for (local894 = local1697.anInt1701; local894 <= local1697.anInt1713; local894++) {
													for (local899 = local1697.anInt1696; local899 <= local1697.anInt1698; local899++) {
														...
														if (local1863.anInt663 != 0) {
															Static7.aClass69_32.push(local1863);
			...
			Static211.anInt1142--;
			@Pc(1999) GroundObject local1999 = local8.aClass79_1;
			...
			if (local24 < Static126.anInt3114 - 1) {
				local2388 = World.activeTiles[local24 + 1][local18][local21];
				if (local2388 != null && local2388.aBoolean46) {
					Static7.aClass69_32.push(local2388);
				}
			}
    ...
    @OriginalMember(owner = "com.jagex3.client.client!ub", name = "a", descriptor = "(IB)I")
