...
public final class Static38 {
    ...
    @OriginalMember(owner = "com.jagex3.client.client!cn", name = "L", descriptor = "I")
	public static int anInt1203 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!cn", name = "a", descriptor = "(BIIIIIIII)V")
	public static void method959(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		for (@Pc(11) int local11 = 0; local11 < Static203.aMapElementList_1.anInt5074; local11++) {
			if (Static203.aMapElementList_1.method3890(local11)) {
				@Pc(32) int local32 = Static203.aMapElementList_1.aShortArray73[local11] - Static158.anInt3846;
				@Pc(43) int local43 = Static2.anInt13 + Static181.anInt4296 - Static203.aMapElementList_1.aShortArray72[local11] - 1;
				...
				if (local84 != null) {
					@Pc(211) int local211 = Static114.aClass3_Sub2_Sub9_42.method2867(Static203.aMapElementList_1.aClass100Array153[local11], null, Static45.aClass100Array53);
	...
	@OriginalMember(owner = "com.jagex3.client.client!cn", name = "a", descriptor = "(BB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cn", name = "a", descriptor = "(IIIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cn", name = "a", descriptor = "(ZI)I")
	public static int poll(@OriginalArg(0) boolean arg0) {
		@Pc(4) long local4 = MonotonicClock.currentTime();
		for (@Pc(28) LongNode local28 = arg0 ? (LongNode) Static199.aClass133_20.search() : (LongNode) Static199.aClass133_20.find(); local28 != null; local28 = (LongNode) Static199.aClass133_20.find()) {
			if ((local28.aLong55 & 0x3FFFFFFFFFFFFFFFL) < local4) {
				if ((local28.aLong55 & 0x4000000000000000L) != 0L) {
					@Pc(58) int local58 = (int) local28.key;
					VarCache.var[local58] = VarCache.varServ[local58];
					local28.unlink();
					return local58;
				}
				local28.unlink();
    ...
    @OriginalMember(owner = "com.jagex3.client.client!cn", name = "e", descriptor = "(B)V")
