...
@OriginalClass("com.jagex3.client.client!va")
public final class MidiPlayer extends PcmStream {

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Kb", descriptor = "Z")
	private boolean aBoolean293;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Lb", descriptor = "J")
	private long aLong188;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Mb", descriptor = "I")
	private int anInt5674;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Nb", descriptor = "I")
	private int anInt5675;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Ob", descriptor = "J")
	private long aLong189;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Qb", descriptor = "Lclient!rf;")
	private MidiFile aClass3_Sub29_2;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Rb", descriptor = "I")
	private int anInt5676;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Sb", descriptor = "Z")
	private boolean aBoolean294;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "z", descriptor = "[I")
	private final int[] anIntArray496 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "D", descriptor = "[I")
	private final int[] anIntArray499 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "F", descriptor = "[I")
	private final int[] anIntArray500 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "B", descriptor = "[I")
	private final int[] anIntArray497 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "ab", descriptor = "I")
	private final int anInt5646 = 1000000;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "cb", descriptor = "[[Lclient!mf;")
	private final MidiNote[][] aClass3_Sub25ArrayArray2 = new MidiNote[16][128];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "kb", descriptor = "[I")
	private final int[] anIntArray506 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "C", descriptor = "[I")
	private final int[] anIntArray498 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "U", descriptor = "[I")
	public final int[] anIntArray503 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "x", descriptor = "[I")
	private final int[] anIntArray495 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "ib", descriptor = "[I")
	private final int[] anIntArray505 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "tb", descriptor = "[I")
	public final int[] anIntArray508 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "mb", descriptor = "[I")
	private final int[] anIntArray507 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Cb", descriptor = "[I")
	private final int[] anIntArray510 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "N", descriptor = "[I")
	private final int[] anIntArray502 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Bb", descriptor = "[I")
	public final int[] anIntArray509 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "bb", descriptor = "[[Lclient!mf;")
	private final MidiNote[][] aClass3_Sub25ArrayArray1 = new MidiNote[16][128];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Eb", descriptor = "I")
	private int anInt5668 = 256;

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "H", descriptor = "[I")
	private final int[] anIntArray501 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Z", descriptor = "[I")
	private final int[] anIntArray504 = new int[16];

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "K", descriptor = "Lclient!ki;")
	private final MidiParser aClass84_1 = new MidiParser();

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "Pb", descriptor = "Lclient!te;")
	private final MidiMixer aClass3_Sub3_Sub3_1 = new MidiMixer(this);

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "P", descriptor = "Lclient!sc;")
	private final HashTable aClass133_23 = new HashTable(128);

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "<init>", descriptor = "()V")
	public MidiPlayer() {
		this.method4424();
		this.method4441(true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(Lclient!rf;ILclient!ve;Lclient!le;I)Z")
	public final synchronized boolean method4411(@OriginalArg(0) MidiFile arg0, @OriginalArg(2) Js5 arg1, @OriginalArg(3) WaveCache arg2) {
		arg0.method3741();
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "d", descriptor = "(I)Z")
	public final synchronized boolean method4414() {
		return this.aClass84_1.method2628();
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(ZLclient!rf;ZB)V")
	private synchronized void method4416(@OriginalArg(0) boolean arg0, @OriginalArg(1) MidiFile arg1, @OriginalArg(2) boolean arg2) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "b", descriptor = "(III)V")
	private void method4417(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anIntArray497[arg0] = arg1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "()I")
	@Override
	public final synchronized int method4404() {
		return 0;
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(IZI)V")
	private void method4419(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(BII)V")
	public final synchronized void method4420() {
		this.method4413();
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "c", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "b", descriptor = "(BII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "c", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "d", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(IIII)V")
	private void method4427(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(126) Wave local126 = local118.aClass3_Sub16_Sub1Array1[arg2];
		if (local126 == null) {
			return;
		}
		...
		local133.aSynthEnvelopeSet_1 = local118.aSynthEnvelopeSetArray1[arg2];
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "b", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(ZLclient!rf;I)V")
	public final synchronized void method4431(@OriginalArg(0) boolean arg0, @OriginalArg(1) MidiFile arg1) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(IILclient!mf;B[I)Z")
	public final boolean method4433(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) MidiNote arg2, @OriginalArg(4) int[] arg3) {
		...
		@Pc(103) SynthEnvelopeSet local103 = arg2.aSynthEnvelopeSet_1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "b", descriptor = "()Lclient!qb;")
	@Override
	public final synchronized PcmStream method4406() {
		return this.aClass3_Sub3_Sub3_1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(BIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "f", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "b", descriptor = "(IIII)V")
	private void method4436(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(ILclient!mf;)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "c", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "e", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(BLclient!mf;)I")
	private int method4439(@OriginalArg(1) MidiNote arg0) {
		@Pc(6) SynthEnvelopeSet local6 = arg0.aSynthEnvelopeSet_1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(Z)I")
	public final int method4440() {
		return this.anInt5668;
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(ZB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(Lclient!mf;ZB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "f", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "a", descriptor = "(Lclient!mf;I)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "f", descriptor = "(B)V")
	public final synchronized void method4446() {
		this.method4448(true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "g", descriptor = "(II)V")
	public final synchronized void method4447(@OriginalArg(1) int arg0) {
		this.anInt5668 = arg0;
	}

	@OriginalMember(owner = "com.jagex3.client.client!va", name = "b", descriptor = "(ZB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "b", descriptor = "(BLclient!mf;)I")
	private int method4449(@OriginalArg(1) MidiNote arg0) {
		if (this.anIntArray507[arg0.anInt3773] == 0) {
			return 0;
		}
		@Pc(21) SynthEnvelopeSet local21 = arg0.aSynthEnvelopeSet_1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!va", name = "d", descriptor = "()Lclient!qb;")
	@Override
