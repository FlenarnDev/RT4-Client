...
@OriginalClass("com.jagex3.client.client!hg")
public final class GlSquare extends Linkable {

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "s", descriptor = "Ljava/nio/ByteBuffer;")
	private ByteBuffer aByteBuffer3;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "t", descriptor = "[F")
	private float[] aFloatArray4;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "v", descriptor = "[I")
	private int[] anIntArray226;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "w", descriptor = "[I")
	private int[] anIntArray227;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "x", descriptor = "[I")
	private int[] anIntArray228;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "z", descriptor = "[I")
	private int[] anIntArray229;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "A", descriptor = "Lclient!sc;")
	private HashTable aClass133_8;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "B", descriptor = "[F")
	private float[] aFloatArray5;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "E", descriptor = "[[I")
	private int[][] anIntArrayArray17;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "F", descriptor = "[I")
	private int[] anIntArray230;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "I", descriptor = "[[I")
	private int[][] anIntArrayArray18;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "L", descriptor = "Lclient!vi;")
	private GlVertexBufferObject aClass155_3;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "N", descriptor = "[F")
	private float[] aFloatArray6;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "P", descriptor = "[I")
	private int[] anIntArray231;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "R", descriptor = "[F")
	private float[] aFloatArray7;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "S", descriptor = "[Z")
	private boolean[] aBooleanArray54;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "T", descriptor = "[I")
	private int[] anIntArray232;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "p", descriptor = "I")
	public int anInt2482 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "D", descriptor = "I")
	private int anInt2487 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "G", descriptor = "I")
	private int anInt2488 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "q", descriptor = "I")
	public int anInt2483 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "r", descriptor = "I")
	public int anInt2484 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "O", descriptor = "I")
	private int anInt2489 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "y", descriptor = "I")
	public final int anInt2485;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "V", descriptor = "F")
	private final float aFloat12;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "M", descriptor = "Z")
	public final boolean aBoolean140;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "u", descriptor = "Z")
	private final boolean aBoolean139;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "C", descriptor = "I")
	public final int anInt2486;

	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "<init>", descriptor = "(IFZZI)V")
	public GlSquare(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
		this.anInt2485 = arg0;
		this.aFloat12 = arg1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "b", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "a", descriptor = "(IIIFFFIF)I")
	...
	public final void method1944(@OriginalArg(0) Square[][][] arg0, @OriginalArg(1) float arg1, @OriginalArg(2) boolean arg2) {
	...
	@OriginalMember(owner = "com.jagex3.client.client!hg", name = "a", descriptor = "(III[I[IZ)I")
