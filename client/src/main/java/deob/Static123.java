...
public final class Static123 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!jj", name = "d", descriptor = "Lclient!na;")
	public static final JagString aClass100_592 = Static28.parse("headicons_pk");

	@OriginalMember(owner = "com.jagex3.client.client!jj", name = "e", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jj", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jj", name = "a", descriptor = "()V")
