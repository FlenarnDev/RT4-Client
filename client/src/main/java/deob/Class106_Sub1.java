...
@OriginalClass("com.jagex3.client.client!we")
public class Class106_Sub1 extends Class106 {

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "B", descriptor = "I")
	private int anInt4135;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "D", descriptor = "I")
	private int anInt4137;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "F", descriptor = "[B")
	private byte[] aByteArray57;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "J", descriptor = "I")
	private int anInt4141;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "L", descriptor = "I")
	private int anInt4143;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "A", descriptor = "I")
	private final int anInt4134;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "G", descriptor = "I")
	private final int anInt4139;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "z", descriptor = "I")
	private final int anInt4133;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "u", descriptor = "I")
	private int anInt4129;

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "<init>", descriptor = "(IIIIIFFF)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!we", name = "a", descriptor = "(IB)V")
	protected void method3209(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		this.aByteArray57[arg0] = arg1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!we", name = "a", descriptor = "(B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!we", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!we", name = "a", descriptor = "(I)V")
	@Override
