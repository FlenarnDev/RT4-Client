...
@OriginalClass("com.jagex3.client.client!f")
public final class TextureOp8 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!f", name = "R", descriptor = "I")
	private int anInt1935 = 204;

	@OriginalMember(owner = "com.jagex3.client.client!f", name = "Y", descriptor = "I")
	private int anInt1940 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!f", name = "Q", descriptor = "I")
	private int anInt1934 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!f", name = "<init>", descriptor = "()V")
	public TextureOp8() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!f", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!f", name = "a", descriptor = "(IB)[I")
	@Override
