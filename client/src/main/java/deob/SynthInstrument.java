...
@OriginalClass("com.jagex3.client.client!pj")
public final class SynthInstrument {

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "k", descriptor = "[I")
	private static final int[] anIntArray395 = new int[32768];

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "h", descriptor = "[I")
	private static final int[] anIntArray394;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "a", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_1;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "b", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_2;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "d", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_3;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "e", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_4;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "f", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_5;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "i", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_6;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "l", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_7;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "w", descriptor = "Lclient!nl;")
	private SynthFilter aClass110_1;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "x", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_8;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "y", descriptor = "Lclient!ff;")
	private SynthEnvelope aClass42_9;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "c", descriptor = "I")
	public int anInt4546 = 500;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "g", descriptor = "I")
	private int anInt4547 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "j", descriptor = "I")
	public int anInt4548 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "m", descriptor = "[I")
	private final int[] anIntArray396 = new int[] { 0, 0, 0, 0, 0 };

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "n", descriptor = "[I")
	private final int[] anIntArray397 = new int[] { 0, 0, 0, 0, 0 };

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "u", descriptor = "I")
	private int anInt4549 = 100;

	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "v", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "a", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pj", name = "a", descriptor = "(II)[I")
