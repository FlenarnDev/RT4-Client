...
@OriginalClass("com.jagex3.client.client!nh")
public class TextureOpSprite extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "U", descriptor = "I")
	protected int anInt3239;

	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "X", descriptor = "I")
	protected int anInt3240;

	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "Y", descriptor = "[I")
	protected int[] anIntArray305;

	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "P", descriptor = "I")
	private int anInt3235 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "<init>", descriptor = "()V")
	public TextureOpSprite() {
		super(0, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "h", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "f", descriptor = "(I)I")
	@Override
	public final int method4631() {
		return this.anInt3235;
	}

	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "b", descriptor = "(II)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!nh", name = "e", descriptor = "(B)V")
	@Override
