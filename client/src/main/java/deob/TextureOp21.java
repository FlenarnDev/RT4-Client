...
@OriginalClass("com.jagex3.client.client!nm")
public final class TextureOp21 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!nm", name = "V", descriptor = "I")
	private int anInt4221 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!nm", name = "Z", descriptor = "I")
	private int anInt4223 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!nm", name = "<init>", descriptor = "()V")
	public TextureOp21() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!nm", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!nm", name = "b", descriptor = "(II)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!nm", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
