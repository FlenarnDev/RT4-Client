...
import com.jagex3.client.ClientInvCache;
...
public final class Static15 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Vb", descriptor = "F")
	public static float aFloat4;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "ib", descriptor = "Lclient!na;")
	public static final JagString aClass100_83 = Static28.parse("event_opbase");

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Kb", descriptor = "Z")
	public static boolean aBoolean33 = true;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "ac", descriptor = "Lclient!na;")
	public static JagString aClass100_87 = null;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "kc", descriptor = "J")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "a", descriptor = "(II)I")
