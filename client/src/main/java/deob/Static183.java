...
public final class Static183 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ok", name = "b", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ok", name = "a", descriptor = "(IIIIIII)V")
