...
public final class Static34 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "F", descriptor = "I")
	public static int anInt1049;

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "J", descriptor = "[[[B")
	public static byte[][][] aByteArrayArrayArray3;

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "X", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "d", descriptor = "[I")
	public static final int[] anIntArray80 = new int[] { 1, 0, -1, 0 };

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "T", descriptor = "Lclient!na;")
	private static final JagString aClass100_207 = Static28.parse("Jan");

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "hb", descriptor = "Lclient!na;")
	private static final JagString aClass100_212 = Static28.parse("Feb");

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "gb", descriptor = "Lclient!na;")
	private static final JagString aClass100_211 = Static28.parse("Mar");

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "db", descriptor = "Lclient!na;")
	private static final JagString aClass100_210 = Static28.parse("Apr");

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "n", descriptor = "Lclient!na;")
	private static final JagString aClass100_199 = Static28.parse("May");

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "L", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "V", descriptor = "Lclient!na;")
	private static final JagString aClass100_208 = Static28.parse("Sep");

	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "S", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ck", name = "f", descriptor = "[Lclient!na;")
	...
	public static SpotType method877(@OriginalArg(1) int arg0) {
		...
		@Pc(26) byte[] local26 = SpotType.spotConfig.method4495(Static206.method3681(arg0), Static133.method4010(arg0));
