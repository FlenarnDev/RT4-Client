...
@OriginalClass("com.jagex3.client.client!jg")
public final class IntHashTable {

	@OriginalMember(owner = "com.jagex3.client.client!jg", name = "f", descriptor = "[I")
	private final int[] anIntArray285;

	@OriginalMember(owner = "com.jagex3.client.client!jg", name = "<init>", descriptor = "([I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jg", name = "a", descriptor = "(II)I")
