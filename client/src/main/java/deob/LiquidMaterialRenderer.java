...
@OriginalClass("com.jagex3.client.client!rd")
public final class LiquidMaterialRenderer implements MaterialRenderer {

	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "a", descriptor = "I")
	private int anInt4829 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "e", descriptor = "I")
	private int anInt4831 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "c", descriptor = "I")
	private int anInt4830;

	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "b", descriptor = "Ljava/nio/FloatBuffer;")
	private FloatBuffer aFloatBuffer1;

	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "f", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!rd", name = "a", descriptor = "(I)V")
	@Override
