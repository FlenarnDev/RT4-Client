...
public final class IfType {
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "q", descriptor = "[Lclient!na;")
	public JagString[] aClass100Array18;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "s", descriptor = "[Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "v", descriptor = "[Ljava/lang/Object;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "fb", descriptor = "[Ljava/lang/Object;")
	public Object[] anObjectArray12;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "gb", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Jb", descriptor = "[Ljava/lang/Object;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "rc", descriptor = "[Ljava/lang/Object;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Xc", descriptor = "[Ljava/lang/Object;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "qd", descriptor = "[Ljava/lang/Object;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "R", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "h", descriptor = "B")
	public byte xMode = 0;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "jb", descriptor = "I")
	public int y = 0;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "nb", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "D", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "hb", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "i", descriptor = "Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Qb", descriptor = "B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Wb", descriptor = "I")
	public int anInt489 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "sb", descriptor = "Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Q", descriptor = "I")
	public int objId = -1;
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Dc", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "hc", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "qc", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "vc", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "hd", descriptor = "B")
	public byte aByte5 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Wc", descriptor = "I")
	private int anInt518 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "pd", descriptor = "I")
	public int anInt526 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "ld", descriptor = "I")
	public int modelYAngle = 0;

	@OriginalMember(owner = "com.jagex3.client.client!be", name = "T", descriptor = "Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "Kc", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "a", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!be", name = "a", descriptor = "(BLclient!na;I)V")
	...
	public final AbstractPix32 method482(@OriginalArg(1) int arg0) {
		...
		@Pc(43) AbstractPix32 local43 = (AbstractPix32) Static190.aClass99_26.method3106((long) local29);
		if (local43 != null) {
			return local43;
		}
	...
	public final PixFontGeneric method491(@OriginalArg(0) Pix8[] arg0) {
		...
		@Pc(21) PixFontGeneric local21 = (PixFontGeneric) Static87.aClass99_12.method3106((long) this.anInt502);
		if (local21 != null) {
			return local21;
		}
