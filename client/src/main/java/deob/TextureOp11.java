...
@OriginalClass("com.jagex3.client.client!gg")
public final class TextureOp11 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!gg", name = "V", descriptor = "I")
	private int anInt2220 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!gg", name = "R", descriptor = "I")
	private int anInt2216 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!gg", name = "<init>", descriptor = "()V")
	public TextureOp11() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!gg", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!gg", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!gg", name = "b", descriptor = "(II)[[I")
	@Override
