...
@OriginalClass("com.jagex3.client.client!ra")
public final class ClientProj extends ModelSource {

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "u", descriptor = "D")
	private double aDouble2;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "A", descriptor = "D")
	public double aDouble3;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "N", descriptor = "D")
	private double aDouble4;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "Q", descriptor = "Lclient!ga;")
	private ParticleSystem aClass47_Sub1_6;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "U", descriptor = "D")
	private double aDouble5;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "X", descriptor = "D")
	public double aDouble6;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "ab", descriptor = "I")
	private int anInt4818;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "bb", descriptor = "D")
	private double aDouble7;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "db", descriptor = "D")
	public double aDouble8;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "eb", descriptor = "D")
	private double aDouble9;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "hb", descriptor = "I")
	public int anInt4821;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "v", descriptor = "I")
	private int anInt4796 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "I", descriptor = "Z")
	private boolean aBoolean239 = false;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "x", descriptor = "I")
	private int anInt4798 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "fb", descriptor = "I")
	private int anInt4820 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "T", descriptor = "I")
	private int anInt4814 = -32768;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "z", descriptor = "I")
	public final int anInt4800;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "E", descriptor = "I")
	private final int anInt4804;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "cb", descriptor = "I")
	public final int anInt4819;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "Y", descriptor = "I")
	private final int anInt4816;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "M", descriptor = "I")
	public final int anInt4810;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "mb", descriptor = "I")
	private final int anInt4825;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "Z", descriptor = "I")
	private final int anInt4817;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "F", descriptor = "I")
	public final int anInt4805;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "w", descriptor = "I")
	private final int anInt4797;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "ib", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "gb", descriptor = "Lclient!tk;")
	private final SeqType aClass144_3;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "<init>", descriptor = "(IIIIIIIIIII)V")
	public ClientProj(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		this.anInt4800 = arg6;
		this.anInt4804 = arg2;
		this.anInt4819 = arg9;
		this.anInt4816 = arg0;
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "a", descriptor = "(IIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "b", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "b", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "a", descriptor = "(IIIIIIIIJILclient!ga;)V")
	@Override
