...
@OriginalClass("com.jagex3.client.client!je")
public final class TextureOp15 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!je", name = "<init>", descriptor = "()V")
	public TextureOp15() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!je", name = "a", descriptor = "(IBI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!je", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!je", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!je", name = "b", descriptor = "(II)[[I")
	@Override
