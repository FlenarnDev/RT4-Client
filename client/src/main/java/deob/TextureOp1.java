...
@OriginalClass("com.jagex3.client.client!ag")
public final class TextureOp1 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!ag", name = "S", descriptor = "I")
	private int anInt100 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!ag", name = "X", descriptor = "I")
	private int anInt105 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!ag", name = "W", descriptor = "I")
	private int anInt104 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!ag", name = "<init>", descriptor = "()V")
	public TextureOp1() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ag", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ag", name = "e", descriptor = "(I)V")
	@Override
	public final void method4630() {
		Static9.method185();
	}

	@OriginalMember(owner = "com.jagex3.client.client!ag", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
