...
@OriginalClass("com.jagex3.client.client!qg")
public final class TextureOp25 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!qg", name = "<init>", descriptor = "()V")
	public TextureOp25() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!qg", name = "a", descriptor = "(IB)[I")
	@Override
