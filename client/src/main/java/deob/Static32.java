...
public final class Static32 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "t", descriptor = "I")
	public static int anInt1016;

	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "q", descriptor = "Lclient!ek;")
	public static SoftwarePix8 aClass36_Sub1_1 = null;

    @OriginalMember(owner = "com.jagex3.client.client!ci", name = "a", descriptor = "([I[ILclient!e;B[I)V")
	public static void method865(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) ClientPlayer arg2, @OriginalArg(4) int[] arg3) {
