...
public final class Static54 {
	...
	public static void method1305(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) IfType arg3) {
		...
		if (Static270.anInt5795 != 2 && Static270.anInt5795 != 5 && Static89.aClass3_Sub2_Sub1_5 != null) {
			...
			if (GlRenderer.enabled) {
				((GlPix32) Static89.aClass3_Sub2_Sub1_5).method1427(arg2, arg1, arg3.anInt445, arg3.anInt459, local57, local67, local48, Static273.anInt4130 + 256, (GlPix32) arg3.method489(false));
			} else {
				((Pix32) Static89.aClass3_Sub2_Sub1_5).method310(arg2, arg1, arg3.anInt445, arg3.anInt459, local57, local67, local48, Static273.anInt4130 + 256, arg3.anIntArray37, arg3.anIntArray45);
			}
			@Pc(146) int local146;
			@Pc(181) int local181;
			@Pc(150) int local150;
			...
			if (Static235.aMapElementList_2 != null) {
				for (@Pc(117) int local117 = 0; local117 < Static235.aMapElementList_2.anInt5074; local117++) {
					if (Static235.aMapElementList_2.method3892(local117)) {
						local146 = (Static235.aMapElementList_2.aShortArray73[local117] - Static225.originX) * 4 + 2 - Static173.self.anInt3412 / 32;
						local150 = Pix3D.anIntArray223[local48];
						local154 = Pix3D.anIntArray225[local48];
						@Pc(156) PixFontGeneric local156 = Static114.aClass3_Sub2_Sub9_42;
						@Pc(164) int local164 = local150 * 256 / (Static273.anInt4130 + 256);
						local181 = (Static235.aMapElementList_2.aShortArray72[local117] - Static142.originZ) * 4 + 2 - Static173.self.anInt3421 / 32;
						@Pc(189) int local189 = local154 * 256 / (Static273.anInt4130 + 256);
						local200 = local181 * local189 - local146 * local164 >> 16;
						if (Static235.aMapElementList_2.method3894(local117) == 1) {
							local156 = Static215.aClass3_Sub2_Sub9_32;
						}
						if (Static235.aMapElementList_2.method3894(local117) == 2) {
							local156 = Static280.aClass3_Sub2_Sub9_43;
						}
						local231 = local164 * local181 + local189 * local146 >> 16;
						local239 = local156.method2856(Static235.aMapElementList_2.aClass100Array153[local117], 100);
						...
						if (local245 >= -arg3.anInt445 && local245 <= arg3.anInt445 && local200 >= -arg3.anInt459 && local200 <= arg3.anInt459) {
							local271 = 16777215;
							if (Static235.aMapElementList_2.anIntArray444[local117] != -1) {
								local271 = Static235.aMapElementList_2.anIntArray444[local117];
							}
							if (GlRenderer.enabled) {
								Static46.method1188((GlPix32) arg3.method489(false));
							} else {
								Static129.method2486(arg3.anIntArray37, arg3.anIntArray45);
							}
							local156.method2869(Static235.aMapElementList_2.aClass100Array153[local117], arg2 + local245 + arg3.anInt445 / 2, arg1 + arg3.anInt459 / 2 + -local200, local239, 50, local271, 0, 1, 0, 0);
							if (GlRenderer.enabled) {
								Static46.method1173();
							} else {
			...
			for (local146 = 0; local146 < 104; local146++) {
				for (local181 = 0; local181 < 104; local181++) {
					@Pc(439) LinkList local439 = Static159.aClass69ArrayArrayArray1[Static55.level][local146][local181];
					if (local439 != null) {
			...
			for (local146 = 0; local146 < Static272.anInt5214; local146++) {
				@Pc(498) ClientNPC local498 = Static175.aClass8_Sub4_Sub2Array1[Static33.anIntArray79[local146]];
			...
			for (local146 = 0; local146 < Static267.anInt5774; local146++) {
				@Pc(591) ClientPlayer local591 = Static159.aClass8_Sub4_Sub1Array1[Static105.anIntArray256[local146]];
				if (local591 != null && local591.method2682()) {
					...
					for (local271 = 0; local271 < Static214.anInt5577; local271++) {
						if (local624 == Static199.aFriendChatUserArray1[local271].aLong192) {
							local660 = true;
							break;
						}
					}
			...
			for (local181 = 0; local181 < local756.length; local181++) {
				...
				if (local770 != null && local770.anInt4058 != 0 && Static83.anInt372 % 20 < 10) {
					if (local770.anInt4058 == 1 && local770.anInt4057 >= 0 && local770.anInt4057 < Static175.aClass8_Sub4_Sub2Array1.length) {
						@Pc(804) ClientNPC local804 = Static175.aClass8_Sub4_Sub2Array1[local770.anInt4057];
						if (local804 != null) {
					...
					if (local770.anInt4058 == 10 && local770.anInt4057 >= 0 && Static159.aClass8_Sub4_Sub1Array1.length > local770.anInt4057) {
						@Pc(905) ClientPlayer local905 = Static159.aClass8_Sub4_Sub1Array1[local770.anInt4057];
						if (local905 != null) {
			...
			@Pc(1041) AbstractPix32 local1041 = arg3.method489(false);
			if (local1041 != null) {
		...
		for (@Pc(5) int local5 = 0; local5 < Static189.anInt4451; local5++) {
			...
			if (Static164.anIntArray362[local5] >= -10) {
				...
				if (Static164.anIntArray362[local5] < 0) {
					...
					if (local209 > 0) {
						@Pc(223) Wave local223 = local79.method3989().method2648(Static56.aClass156_1);
