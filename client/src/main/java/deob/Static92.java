...
public final class Static92 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!hd", name = "e", descriptor = "Lclient!qf;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!hd", name = "i", descriptor = "I")
	public static int anInt2433 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hd", name = "l", descriptor = "Lclient!na;")
	...
	public static void method1881(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg4 == 2) {
			...
			@Pc(255) Sprite local255 = Static133.method4008(arg0, arg5, arg3);
			if (local255 != null) {
				local255.aClass8_4 = new ClientLocAnim((int) (local255.aLong56 >>> 32) & Integer.MAX_VALUE, arg2, arg1, arg0, arg5, arg3, arg6, false, local255.aClass8_4);
			}
		}
		if (arg4 == 3) {
