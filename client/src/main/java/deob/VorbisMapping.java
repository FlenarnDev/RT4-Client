...
@OriginalClass("com.jagex3.client.client!uk")
public final class VorbisMapping {

	@OriginalMember(owner = "com.jagex3.client.client!uk", name = "d", descriptor = "I")
	public final int anInt5563;

	@OriginalMember(owner = "com.jagex3.client.client!uk", name = "a", descriptor = "I")
	public int anInt5562;

	@OriginalMember(owner = "com.jagex3.client.client!uk", name = "b", descriptor = "[I")
	public final int[] anIntArray490;

	@OriginalMember(owner = "com.jagex3.client.client!uk", name = "c", descriptor = "[I")
	public final int[] anIntArray491;

	@OriginalMember(owner = "com.jagex3.client.client!uk", name = "<init>", descriptor = "()V")
