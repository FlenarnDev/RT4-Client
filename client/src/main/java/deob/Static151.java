...
public final class Static151 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "c", descriptor = "Ljava/nio/ByteBuffer;")
	private static ByteBuffer aByteBuffer6;

	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "d", descriptor = "Ljava/nio/ByteBuffer;")
	private static ByteBuffer aByteBuffer7;

	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "e", descriptor = "Z")
	public static boolean aBoolean176;

	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "a", descriptor = "[I")
	public static int[] anIntArray340 = null;

	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "b", descriptor = "[I")
	public static int[] anIntArray341 = null;

	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "f", descriptor = "I")
	public static int anInt3587 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "g", descriptor = "I")
	public static int anInt3588 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "b", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!lm", name = "f", descriptor = "()V")
