...
public final class Static161 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "c", descriptor = "I")
	public static int anInt3920;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "d", descriptor = "I")
	public static int anInt3921;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "i", descriptor = "F")
	private static float aFloat21;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "a", descriptor = "[F")
	public static final float[] aFloatArray18 = new float[4];

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "b", descriptor = "I")
	private static int anInt3919 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "e", descriptor = "I")
	public static int anInt3922 = 13156520;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "f", descriptor = "F")
	private static float aFloat19 = -1.0F;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "g", descriptor = "F")
	private static float aFloat20 = -1.0F;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "h", descriptor = "[F")
	public static final float[] aFloatArray19 = new float[4];

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "j", descriptor = "[F")
	private static final float[] aFloatArray20 = new float[4];

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "k", descriptor = "I")
	public static int anInt3923 = 16777215;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "l", descriptor = "I")
	private static int anInt3924 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "m", descriptor = "I")
	private static int anInt3925 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "b", descriptor = "()F")
	public static float method3059() {
		return aFloat19;
	}

	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "a", descriptor = "(IFFF)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "a", descriptor = "(FFF)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "a", descriptor = "([F)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mk", name = "f", descriptor = "()V")
