...
@OriginalClass("com.jagex3.client.client!wi")
public final class TextureOpCurve extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "Q", descriptor = "[I")
	private int[] anIntArray566;

	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "gb", descriptor = "[I")
	private int[] anIntArray567;

	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "ib", descriptor = "[[I")
	private int[][] anIntArrayArray47;

	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "cb", descriptor = "[S")
	private final short[] aShortArray96 = new short[257];

	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "Z", descriptor = "I")
	private int anInt5852 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "<init>", descriptor = "()V")
	public TextureOpCurve() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "h", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "e", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!wi", name = "a", descriptor = "(BI)[I")
