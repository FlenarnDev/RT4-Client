...
public final class Static136 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!kk", name = "i", descriptor = "I")
	public static int anInt3324;

	@OriginalMember(owner = "com.jagex3.client.client!kk", name = "g", descriptor = "I")
	public static int anInt3322 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!kk", name = "j", descriptor = "I")
	public static int anInt3325 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!kk", name = "m", descriptor = "Lclient!na;")
	public static final JagString aClass100_633 = Static28.parse("Clientscript error )2 check log for details");

	@OriginalMember(owner = "com.jagex3.client.client!kk", name = "a", descriptor = "(IIB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!kk", name = "a", descriptor = "(ZLjava/awt/event/KeyEvent;)I")
