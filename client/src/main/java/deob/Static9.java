...
public final class Static9 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!al", name = "e", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!al", name = "r", descriptor = "Lclient!na;")
	public static final JagString aClass100_35 = Static28.parse("showVideoAd");

	@OriginalMember(owner = "com.jagex3.client.client!al", name = "a", descriptor = "(Lclient!pb;BIIIIIII)V")
