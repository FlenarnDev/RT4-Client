...
public final class Static224 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!sd", name = "I", descriptor = "I")
	public static int anInt5057;

	@OriginalMember(owner = "com.jagex3.client.client!sd", name = "R", descriptor = "I")
	public static int anInt5062;

	@OriginalMember(owner = "com.jagex3.client.client!sd", name = "S", descriptor = "I")
