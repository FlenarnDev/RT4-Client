...
@OriginalClass("com.jagex3.client.client!si")
public final class TextureOp29 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!si", name = "U", descriptor = "[Lclient!kf;")
	private TextureOp29SubOp[] aClass18Array1;

	@OriginalMember(owner = "com.jagex3.client.client!si", name = "<init>", descriptor = "()V")
	public TextureOp29() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!si", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!si", name = "a", descriptor = "(I[[I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!si", name = "b", descriptor = "(II)[[I")
	@Override
