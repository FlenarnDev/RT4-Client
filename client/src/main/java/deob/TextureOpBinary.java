...
@OriginalClass("com.jagex3.client.client!ca")
public final class TextureOpBinary extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!ca", name = "T", descriptor = "I")
	private int anInt861 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!ca", name = "P", descriptor = "I")
	private int anInt857 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!ca", name = "<init>", descriptor = "()V")
	public TextureOpBinary() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ca", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ca", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
