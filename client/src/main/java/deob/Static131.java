...
public final class Static131 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!kd", name = "pb", descriptor = "I")
	public static int anInt3252;

	@OriginalMember(owner = "com.jagex3.client.client!kd", name = "ub", descriptor = "I")
	public static int anInt3255;

	@OriginalMember(owner = "com.jagex3.client.client!kd", name = "Cb", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!kd", name = "yb", descriptor = "S")
	public static short aShort21 = 32767;

	@OriginalMember(owner = "com.jagex3.client.client!kd", name = "zb", descriptor = "I")
	public static int anInt3259 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!kd", name = "Bb", descriptor = "I")
	public static int anInt3260 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!kd", name = "a", descriptor = "([IIIII)V")
	...
	public static PixMap method2579(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Component arg2) {
		try {
			@Pc(12) Class local12 = Class.forName("deob.JavaPixMap");
