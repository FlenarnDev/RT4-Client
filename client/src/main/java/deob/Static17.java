...
public final class Static17 {
	...
	public static void method527() {
		...
		if (local23 == 1) {
			...
			local64 = Client.in.method2238(1);
			Static55.level = Client.in.method2238(2);
	...
	public static void method531(@OriginalArg(0) IfType arg0, @OriginalArg(1) boolean arg1) {
		...
		Static266.method4190(arg0.anInt507, arg1, local20, local32, IfType.list[arg0.anInt507 >> 16]);
		if (arg0.createdComponents != null) {
			Static266.method4190(arg0.anInt507, arg1, local20, local32, arg0.createdComponents);
		}
		@Pc(66) SubInterface local66 = (SubInterface) Static119.aClass133_9.method3863((long) arg0.anInt507);
		if (local66 != null) {
