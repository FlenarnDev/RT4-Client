...
public final class Static229 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!si", name = "R", descriptor = "[[[B")
	public static byte[][][] aByteArrayArrayArray12;

	@OriginalMember(owner = "com.jagex3.client.client!si", name = "S", descriptor = "[Lclient!na;")
	public static JagString[] aClass100Array156;

	@OriginalMember(owner = "com.jagex3.client.client!si", name = "ab", descriptor = "I")
	public static int anInt5138;

	@OriginalMember(owner = "com.jagex3.client.client!si", name = "cb", descriptor = "[B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!si", name = "a", descriptor = "(ZB)I")
	public static int method3933(@OriginalArg(1) byte arg0) {
		return arg0 & 0xFF;
	}

	@OriginalMember(owner = "com.jagex3.client.client!si", name = "a", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!si", name = "a", descriptor = "(BLclient!na;)I")
	public static int method3937(@OriginalArg(1) JagString arg0) {
		return arg0.length() + 1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!si", name = "b", descriptor = "(IIB)V")
