...
@OriginalClass("com.jagex3.client.client!mg")
public final class TextureOp18 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!mg", name = "R", descriptor = "I")
	private int anInt3812 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!mg", name = "Z", descriptor = "I")
	private int anInt3816 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!mg", name = "X", descriptor = "I")
	private int anInt3815 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!mg", name = "<init>", descriptor = "()V")
	public TextureOp18() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!mg", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!mg", name = "b", descriptor = "(II)[[I")
	@Override
