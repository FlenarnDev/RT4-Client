...
public final class Static90 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!hb", name = "v", descriptor = "[[[B")
	public static byte[][][] aByteArrayArrayArray8;

	@OriginalMember(owner = "com.jagex3.client.client!hb", name = "t", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!hb", name = "a", descriptor = "(ZI)Lclient!ck;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!hb", name = "a", descriptor = "(Z)V")
