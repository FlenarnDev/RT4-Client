...
public final class Static209 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "R", descriptor = "Z")
	public static boolean aBoolean240 = true;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "jb", descriptor = "J")
	public static volatile long aLong161 = 0L;

	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "a", descriptor = "(ILclient!pb;BII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "a", descriptor = "(BI)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "a", descriptor = "(BIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ra", name = "b", descriptor = "(III)I")
