...
public final class Static265 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "d", descriptor = "I")
	public static int anInt5765;

	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "j", descriptor = "Lclient!dd;")
	public static PixFont aClass3_Sub2_Sub9_Sub1_2;

	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "m", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vj", name = "a", descriptor = "(IIILclient!ve;)[Lclient!mm;")
	public static Pix32[] method4523(@OriginalArg(2) int arg0, @OriginalArg(3) Js5 arg1) {
