...
@OriginalClass("com.jagex3.client.client!an")
public final class TextureOp3 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!an", name = "R", descriptor = "I")
	private int anInt316 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!an", name = "bb", descriptor = "Z")
	private boolean aBoolean11 = true;

	@OriginalMember(owner = "com.jagex3.client.client!an", name = "<init>", descriptor = "()V")
	public TextureOp3() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!an", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!an", name = "b", descriptor = "(II)[[I")
	@Override
