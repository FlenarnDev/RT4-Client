...
public final class Static48 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!dl", name = "c", descriptor = "I")
	public static int anInt1447 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!dl", name = "a", descriptor = "(IIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dl", name = "a", descriptor = "(B)Lclient!wa;")
