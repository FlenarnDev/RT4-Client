...
public class LocalizedText {
    ...
    @OriginalMember(owner = "com.jagex3.client.client!ui", name = "ob", descriptor = "Lclient!na;")
    private static final JagString ENG_ATTACK = Static28.parse("Attack");

    @OriginalMember(owner = "com.jagex3.client.client!vf", name = "d", descriptor = "Lclient!na;")
    private static final JagString ENG_ATTEMPT_TO_REESTABLISH = Static28.parse("Please wait )2 attempting to reestablish)3");

    @OriginalMember(owner = "com.jagex3.client.client!wb", name = "i", descriptor = "Lclient!na;")
    private static final JagString ENG_CANCEL = Static28.parse("Cancel");

    @OriginalMember(owner = "com.jagex3.client.client!bk", name = "I", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL0 = Static28.parse("yellow:");

    @OriginalMember(owner = "com.jagex3.client.client!lb", name = "x", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL1 = Static28.parse("red:");

    @OriginalMember(owner = "com.jagex3.client.client!h", name = "Bb", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL2 = Static28.parse("green:");

    @OriginalMember(owner = "com.jagex3.client.client!com.jagex3.client.client", name = "eb", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL3 = Static28.parse("cyan:");

    @OriginalMember(owner = "com.jagex3.client.client!hd", name = "h", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL4 = Static28.parse("purple:");

    @OriginalMember(owner = "com.jagex3.client.client!bf", name = "y", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL5 = Static28.parse("white:");

    @OriginalMember(owner = "com.jagex3.client.client!mg", name = "U", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL6 = Static28.parse("flash1:");

    @OriginalMember(owner = "com.jagex3.client.client!tm", name = "n", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL7 = Static28.parse("flash2:");

    @OriginalMember(owner = "com.jagex3.client.client!km", name = "Cc", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL8 = Static28.parse("flash3:");

    @OriginalMember(owner = "com.jagex3.client.client!aa", name = "r", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL9 = Static28.parse("glow1:");

    @OriginalMember(owner = "com.jagex3.client.client!vf", name = "j", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATCOL10 = Static28.parse("glow2:");

    @OriginalMember(owner = "com.jagex3.client.client!ah", name = "m", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!pg", name = "ib", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATEFFECT2 = Static28.parse("wave2:");

    @OriginalMember(owner = "com.jagex3.client.client!rm", name = "h", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATEFFECT3 = Static28.parse("shake:");

    @OriginalMember(owner = "com.jagex3.client.client!ef", name = "m", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATEFFECT4 = Static28.parse("scroll:");

    @OriginalMember(owner = "com.jagex3.client.client!eg", name = "B", descriptor = "Lclient!na;")
    private static final JagString ENG_CHATEFFECT5 = Static28.parse("slide:");

    @OriginalMember(owner = "com.jagex3.client.client!bm", name = "d", descriptor = "Lclient!na;")
    private static final JagString ENG_CHECKING_FOR_UPDATES = Static28.parse("Checking for updates )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!ta", name = "q", descriptor = "Lclient!na;")
    private static final JagString ENG_CHOOSE_OPTION = Static28.parse("Choose Option");

    @OriginalMember(owner = "com.jagex3.client.client!d", name = "fb", descriptor = "Lclient!na;")
    private static final JagString ENG_CLOSE = Static28.parse("Close");

    @OriginalMember(owner = "com.jagex3.client.client!sm", name = "f", descriptor = "Lclient!na;")
    private static final JagString ENG_CONLOST = Static28.parse("Connection lost)3");

    @OriginalMember(owner = "com.jagex3.client.client!ig", name = "c", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!li", name = "u", descriptor = "Lclient!na;")
    private static final JagString ENG_EXAMINE = Static28.parse("Examine");

    @OriginalMember(owner = "com.jagex3.client.client!sd", name = "M", descriptor = "Lclient!na;")
    private static final JagString ENG_FACEHERE = Static28.parse("Face here");

    @OriginalMember(owner = "com.jagex3.client.client!ii", name = "g", descriptor = "Lclient!na;")
    private static final JagString ENG_FRIENDCANTADDSELF = Static28.parse("You can(Wt add yourself to your own friend list)3");

    @OriginalMember(owner = "com.jagex3.client.client!lk", name = "S", descriptor = "Lclient!na;")
    private static final JagString ENG_FRIENDLISTDUPE = Static28.parse(" is already on your friend list)3");

    @OriginalMember(owner = "com.jagex3.client.client!t", name = "B", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!cn", name = "J", descriptor = "Lclient!na;")
    private static final JagString ENG_MAINLOAD140 = Static28.parse("Starting 3d Library");

    @OriginalMember(owner = "com.jagex3.client.client!rg", name = "u", descriptor = "Lclient!na;")
    private static final JagString ENG_MAINLOAD150B = Static28.parse("Started 3d Library");

    @OriginalMember(owner = "com.jagex3.client.client!qc", name = "Z", descriptor = "Lclient!na;")
    private static final JagString ENG_MEMBERS_OBJECT = Static28.parse("Members object");

    @OriginalMember(owner = "com.jagex3.client.client!fh", name = "W", descriptor = "Lclient!na;")
    private static final JagString ENG_MILLION_SUFFIX = Static28.parse("M");

    @OriginalMember(owner = "com.jagex3.client.client!qk", name = "l", descriptor = "Lclient!na;")
    private static final JagString ENG_MINISEPARATOR = Static28.parse(" ");

    @OriginalMember(owner = "com.jagex3.client.client!ui", name = "ab", descriptor = "Lclient!na;")
    private static final JagString ENG_MOREOPTIONS = Static28.parse(" more options");

    @OriginalMember(owner = "com.jagex3.client.client!ph", name = "c", descriptor = "Lclient!na;")
    private static final JagString ENG_OK = Static28.parse("Ok");

    @OriginalMember(owner = "com.jagex3.client.client!bj", name = "z", descriptor = "Lclient!na;")
    private static final JagString ENG_PLEASEWAIT = Static28.parse("Please wait)3)3)3");

    @OriginalMember(owner = "com.jagex3.client.client!mf", name = "T", descriptor = "Lclient!na;")
    private static final JagString ENG_RATING = Static28.parse("rating: ");

    @OriginalMember(owner = "com.jagex3.client.client!pm", name = "gb", descriptor = "Lclient!na;")
    private static final JagString ENG_REMOVEFRIEND = Static28.parse(" from your friend list first)3");

    @OriginalMember(owner = "com.jagex3.client.client!rc", name = "v", descriptor = "Lclient!na;")
    private static final JagString ENG_REMOVEIGNORE = Static28.parse(" from your ignore list first)3");

    @OriginalMember(owner = "com.jagex3.client.client!fk", name = "b", descriptor = "Lclient!na;")
    private static final JagString ENG_REMOVESOCIAL = Static28.parse("Please remove ");

    @OriginalMember(owner = "com.jagex3.client.client!se", name = "o", descriptor = "Lclient!na;")
    private static final JagString ENG_SELECT = Static28.parse("Select");

    @OriginalMember(owner = "com.jagex3.client.client!ef", name = "k", descriptor = "Lclient!na;")
    private static final JagString ENG_SKILL = Static28.parse("skill: ");

    @OriginalMember(owner = "com.jagex3.client.client!si", name = "hb", descriptor = "Lclient!na;")
    private static final JagString ENG_TAKE = Static28.parse("Take");

    @OriginalMember(owner = "com.jagex3.client.client!cl", name = "N", descriptor = "Lclient!na;")
    private static final JagString ENG_THOUSAND_SUFFIX = Static28.parse("K");

    @OriginalMember(owner = "com.jagex3.client.client!ea", name = "q", descriptor = "Lclient!na;")
    private static final JagString ENG_TRADEREQ = Static28.parse("wishes to trade with you)3");

    @OriginalMember(owner = "com.jagex3.client.client!gi", name = "f", descriptor = "Lclient!na;")
    private static final JagString ENG_UNABLETOFIND = Static28.parse("Unable to find ");

    @OriginalMember(owner = "com.jagex3.client.client!sa", name = "U", descriptor = "Lclient!na;")
    private static final JagString ENG_USE = Static28.parse("Use");

    @OriginalMember(owner = "com.jagex3.client.client!ib", name = "m", descriptor = "Lclient!na;")
    private static final JagString ENG_WALKHERE = Static28.parse("Walk here");
    //endregion

    //region Stable Translations (chat effects/colors)
    @OriginalMember(owner = "com.jagex3.client.client!bk", name = "R", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL0 = ENG_CHATCOL0;

    @OriginalMember(owner = "com.jagex3.client.client!lb", name = "D", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL1 = ENG_CHATCOL1;

    @OriginalMember(owner = "com.jagex3.client.client!h", name = "wb", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL2 = ENG_CHATCOL2;

    @OriginalMember(owner = "com.jagex3.client.client!com.jagex3.client.client", name = "cb", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL3 = ENG_CHATCOL3;

    @OriginalMember(owner = "com.jagex3.client.client!hd", name = "p", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL4 = ENG_CHATCOL4;

    @OriginalMember(owner = "com.jagex3.client.client!bf", name = "N", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL5 = ENG_CHATCOL5;

    @OriginalMember(owner = "com.jagex3.client.client!mg", name = "T", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL6 = ENG_CHATCOL6;

    @OriginalMember(owner = "com.jagex3.client.client!tm", name = "k", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL7 = ENG_CHATCOL7;

    @OriginalMember(owner = "com.jagex3.client.client!km", name = "wc", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL8 = ENG_CHATCOL8;

    @OriginalMember(owner = "com.jagex3.client.client!aa", name = "d", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL9 = ENG_CHATCOL9;

    @OriginalMember(owner = "com.jagex3.client.client!vf", name = "h", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL10 = ENG_CHATCOL10;

    @OriginalMember(owner = "com.jagex3.client.client!ah", name = "r", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATCOL11 = ENG_CHATCOL11;

    @OriginalMember(owner = "com.jagex3.client.client!dc", name = "S", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATEFFECT1 = ENG_CHATEFFECT1;

    @OriginalMember(owner = "com.jagex3.client.client!pg", name = "X", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATEFFECT2 = ENG_CHATEFFECT2;

    @OriginalMember(owner = "com.jagex3.client.client!rm", name = "k", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATEFFECT3 = ENG_CHATEFFECT3;

    @OriginalMember(owner = "com.jagex3.client.client!ef", name = "t", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATEFFECT4 = ENG_CHATEFFECT4;

    @OriginalMember(owner = "com.jagex3.client.client!eg", name = "u", descriptor = "Lclient!na;")
    public static final JagString STABLE_CHATEFFECTC5 = ENG_CHATEFFECT5;
    //endregion

    // TODO: unsorted
    //region Active
    @OriginalMember(owner = "com.jagex3.client.client!vj", name = "b", descriptor = "Lclient!na;")
    public static JagString MAINLOAD30 = ENG_MAINLOAD30;

    @OriginalMember(owner = "com.jagex3.client.client!lb", name = "q", descriptor = "Lclient!na;")
    public static JagString CHATCOL1 = ENG_CHATCOL1;

    @OriginalMember(owner = "com.jagex3.client.client!sd", name = "O", descriptor = "Lclient!na;")
    public static JagString FACEHERE = ENG_FACEHERE;

    @OriginalMember(owner = "com.jagex3.client.client!vc", name = "Q", descriptor = "Lclient!na;")
    public static JagString MAINLOAD80 = ENG_MAINLOAD80;

    @OriginalMember(owner = "com.jagex3.client.client!mf", name = "U", descriptor = "Lclient!na;")
    public static JagString RATING = ENG_RATING;

    @OriginalMember(owner = "com.jagex3.client.client!qc", name = "Y", descriptor = "Lclient!na;")
    public static JagString MEMBERS_OBJECT = ENG_MEMBERS_OBJECT;

    @OriginalMember(owner = "com.jagex3.client.client!si", name = "db", descriptor = "Lclient!na;")
    public static JagString TAKE = ENG_TAKE;

    @OriginalMember(owner = "com.jagex3.client.client!ni", name = "j", descriptor = "Lclient!na;")
    public static JagString MAINLOAD110B = ENG_MAINLOAD110B;

    @OriginalMember(owner = "com.jagex3.client.client!ib", name = "j", descriptor = "Lclient!na;")
    public static JagString WALKHERE = ENG_WALKHERE;

    @OriginalMember(owner = "com.jagex3.client.client!qk", name = "i", descriptor = "Lclient!na;")
    public static JagString MINISEPARATOR = ENG_MINISEPARATOR;

    @OriginalMember(owner = "com.jagex3.client.client!gi", name = "b", descriptor = "Lclient!na;")
    public static JagString UNABLETOFIND = ENG_UNABLETOFIND;

    @OriginalMember(owner = "com.jagex3.client.client!nb", name = "c", descriptor = "Lclient!na;")
    public static JagString IGNORECANTADDSELF = ENG_IGNORECANTADDSELF;

    @OriginalMember(owner = "com.jagex3.client.client!ph", name = "d", descriptor = "Lclient!na;")
    public static JagString OK = ENG_OK;

    @OriginalMember(owner = "com.jagex3.client.client!rg", name = "E", descriptor = "Lclient!na;")
    public static JagString MAINLOAD150B = ENG_MAINLOAD150B;

    @OriginalMember(owner = "com.jagex3.client.client!rc", name = "s", descriptor = "Lclient!na;")
    public static JagString REMOVEIGNORE = ENG_REMOVEIGNORE;

    @OriginalMember(owner = "com.jagex3.client.client!tm", name = "p", descriptor = "Lclient!na;")
    public static JagString CHATCOL7 = ENG_CHATCOL7;

    @OriginalMember(owner = "com.jagex3.client.client!ta", name = "w", descriptor = "Lclient!na;")
    public static JagString CHOOSE_OPTION = ENG_CHOOSE_OPTION;

    @OriginalMember(owner = "com.jagex3.client.client!vf", name = "i", descriptor = "Lclient!na;")
    public static JagString CHATCOL10 = ENG_CHATCOL10;

    @OriginalMember(owner = "com.jagex3.client.client!vf", name = "e", descriptor = "Lclient!na;")
    public static JagString ATTEMPT_TO_REESTABLISH = ENG_ATTEMPT_TO_REESTABLISH;

    @OriginalMember(owner = "com.jagex3.client.client!ig", name = "g", descriptor = "Lclient!na;")
    public static JagString CONTINUE = ENG_CONTINUE;

    @OriginalMember(owner = "com.jagex3.client.client!sc", name = "r", descriptor = "Lclient!na;")
    public static JagString MAINLOAD80B = ENG_MAINLOAD80B;

    @OriginalMember(owner = "com.jagex3.client.client!r", name = "a", descriptor = "Lclient!na;")
    public static JagString MAINLOAD135 = ENG_MAINLOAD135;

    @OriginalMember(owner = "com.jagex3.client.client!sa", name = "X", descriptor = "Lclient!na;")
    public static JagString USE = ENG_USE;

    @OriginalMember(owner = "com.jagex3.client.client!ub", name = "e", descriptor = "Lclient!na;")
    public static JagString MAINLOAD90 = ENG_MAINLOAD90;

    @OriginalMember(owner = "com.jagex3.client.client!hd", name = "f", descriptor = "Lclient!na;")
    public static JagString CHATCOL4 = ENG_CHATCOL4;

    @OriginalMember(owner = "com.jagex3.client.client!hd", name = "c", descriptor = "Lclient!na;")
    public static JagString FRIENDLOGOUT = ENG_FRIENDLOGOUT;

    @OriginalMember(owner = "com.jagex3.client.client!nh", name = "W", descriptor = "Lclient!na;")
    public static JagString LOADING = ENG_LOADING;

    @OriginalMember(owner = "com.jagex3.client.client!h", name = "zb", descriptor = "Lclient!na;")
    public static JagString CHATCOL2 = ENG_CHATCOL2;

    @OriginalMember(owner = "com.jagex3.client.client!wa", name = "eb", descriptor = "Lclient!na;")
    public static JagString MAINLOAD130B = ENG_MAINLOAD130B;

    @OriginalMember(owner = "com.jagex3.client.client!u", name = "f", descriptor = "Lclient!na;")
    public static JagString IGNORELISTFULL = ENG_IGNORELISTFULL;

    @OriginalMember(owner = "com.jagex3.client.client!sm", name = "d", descriptor = "Lclient!na;")
    public static JagString CONLOST = ENG_CONLOST;

    @OriginalMember(owner = "com.jagex3.client.client!il", name = "M", descriptor = "Lclient!na;")
    public static JagString MAINLOAD10B = ENG_MAINLOAD10B;

    @OriginalMember(owner = "com.jagex3.client.client!wb", name = "h", descriptor = "Lclient!na;")
    public static JagString CANCEL = ENG_CANCEL;

    @OriginalMember(owner = "com.jagex3.client.client!t", name = "D", descriptor = "Lclient!na;")
    public static JagString FRIENDLISTFULL = ENG_FRIENDLISTFULL;

    @OriginalMember(owner = "com.jagex3.client.client!km", name = "Dc", descriptor = "Lclient!na;")
    public static JagString CHATCOL8 = ENG_CHATCOL8;

    @OriginalMember(owner = "com.jagex3.client.client!mg", name = "W", descriptor = "Lclient!na;")
    public static JagString CHATCOL6 = ENG_CHATCOL6;

    @OriginalMember(owner = "com.jagex3.client.client!kd", name = "Ab", descriptor = "Lclient!na;")
    public static JagString MAINLOAD0 = ENG_MAINLOAD0;

    @OriginalMember(owner = "com.jagex3.client.client!rm", name = "j", descriptor = "Lclient!na;")
    public static JagString CHATEFFECT3 = ENG_CHATEFFECT3;

    @OriginalMember(owner = "com.jagex3.client.client!pm", name = "fb", descriptor = "Lclient!na;")
    public static JagString REMOVEFRIEND = ENG_REMOVEFRIEND;

    @OriginalMember(owner = "com.jagex3.client.client!tl", name = "h", descriptor = "Lclient!na;")
    public static JagString MAINLOAD50B = ENG_MAINLOAD50B;

    @OriginalMember(owner = "com.jagex3.client.client!dm", name = "d", descriptor = "Lclient!na;")
    public static JagString MAINLOAD60 = ENG_MAINLOAD60;

    @OriginalMember(owner = "com.jagex3.client.client!se", name = "v", descriptor = "Lclient!na;")
    public static JagString MAINLOAD45B = ENG_MAINLOAD45B;

    @OriginalMember(owner = "com.jagex3.client.client!se", name = "k", descriptor = "Lclient!na;")
    public static JagString SELECT = ENG_SELECT;

    @OriginalMember(owner = "com.jagex3.client.client!li", name = "i", descriptor = "Lclient!na;")
    public static JagString MAINLOAD120 = ENG_MAINLOAD120;

    @OriginalMember(owner = "com.jagex3.client.client!li", name = "f", descriptor = "Lclient!na;")
    public static JagString EXAMINE = ENG_EXAMINE;

    @OriginalMember(owner = "com.jagex3.client.client!gm", name = "cb", descriptor = "Lclient!na;")
    public static JagString MAINLOAD90B = ENG_MAINLOAD90B;

    @OriginalMember(owner = "com.jagex3.client.client!ii", name = "q", descriptor = "Lclient!na;")
    public static JagString FRIENDCANTADDSELF = ENG_FRIENDCANTADDSELF;

    @OriginalMember(owner = "com.jagex3.client.client!pl", name = "g", descriptor = "Lclient!na;")
    public static JagString MAINLOAD120B = ENG_MAINLOAD120B;

    @OriginalMember(owner = "com.jagex3.client.client!ol", name = "db", descriptor = "Lclient!na;")
    public static JagString IGNORELISTDUPE = ENG_IGNORELISTDUPE;

    @OriginalMember(owner = "com.jagex3.client.client!lk", name = "X", descriptor = "Lclient!na;")
    public static JagString MAINLOAD50 = ENG_MAINLOAD50;

    @OriginalMember(owner = "com.jagex3.client.client!lk", name = "ab", descriptor = "Lclient!na;")
    public static JagString FRIENDLISTDUPE = ENG_FRIENDLISTDUPE;

    @OriginalMember(owner = "com.jagex3.client.client!pg", name = "hb", descriptor = "Lclient!na;")
    public static JagString CHATEFFECT2 = ENG_CHATEFFECT2;

    @OriginalMember(owner = "com.jagex3.client.client!od", name = "h", descriptor = "Lclient!na;")
    public static JagString MAINLOAD30B = ENG_MAINLOAD30B;

    @OriginalMember(owner = "com.jagex3.client.client!na", name = "D", descriptor = "Lclient!na;")
    public static JagString MAINLOAD0B = ENG_MAINLOAD0B;

    @OriginalMember(owner = "com.jagex3.client.client!fk", name = "h", descriptor = "Lclient!na;")
    public static JagString REMOVESOCIAL1 = ENG_REMOVESOCIAL;

    @OriginalMember(owner = "com.jagex3.client.client!ui", name = "Y", descriptor = "Lclient!na;")
    public static JagString ATTACK = ENG_ATTACK;

    @OriginalMember(owner = "com.jagex3.client.client!ui", name = "V", descriptor = "Lclient!na;")
    public static JagString MOREOPTIONS = ENG_MOREOPTIONS;

    @OriginalMember(owner = "com.jagex3.client.client!fn", name = "R", descriptor = "Lclient!na;")
    public static JagString MAINLOAD70B = ENG_MAINLOAD70B;

    @OriginalMember(owner = "com.jagex3.client.client!fk", name = "o", descriptor = "Lclient!na;")
    public static JagString REMOVESOCIAL2 = ENG_REMOVESOCIAL;

    @OriginalMember(owner = "com.jagex3.client.client!fh", name = "bb", descriptor = "Lclient!na;")
    public static JagString MILLION_SHORT = ENG_MILLION_SUFFIX;

    @OriginalMember(owner = "com.jagex3.client.client!fh", name = "T", descriptor = "Lclient!na;")
    public static JagString MILLION = ENG_MILLION_SUFFIX;

    @OriginalMember(owner = "com.jagex3.client.client!eg", name = "z", descriptor = "Lclient!na;")
    public static JagString CHATEFFECT5 = ENG_CHATEFFECT5;

    @OriginalMember(owner = "com.jagex3.client.client!ef", name = "q", descriptor = "Lclient!na;")
    public static JagString LEVEL = ENG_LEVEL;

    @OriginalMember(owner = "com.jagex3.client.client!ef", name = "n", descriptor = "Lclient!na;")
    public static JagString SKILL = ENG_SKILL;

    @OriginalMember(owner = "com.jagex3.client.client!ef", name = "o", descriptor = "Lclient!na;")
    public static JagString CHATEFFECT4 = ENG_CHATEFFECT4;

    @OriginalMember(owner = "com.jagex3.client.client!ec", name = "k", descriptor = "Lclient!na;")
    public static JagString GAME0_LOADING = ENG_GAME0_LOADING;

    @OriginalMember(owner = "com.jagex3.client.client!ea", name = "p", descriptor = "Lclient!na;")
    public static JagString TRADEREQ = ENG_TRADEREQ;

    @OriginalMember(owner = "com.jagex3.client.client!dm", name = "e", descriptor = "Lclient!na;")
    public static JagString LOADINGDOTDOTDOT = ENG_LOADINGDOTDOTDOT;

    @OriginalMember(owner = "com.jagex3.client.client!dl", name = "k", descriptor = "Lclient!na;")
    public static JagString MAINLOAD65B = ENG_MAINLOAD65B;

    @OriginalMember(owner = "com.jagex3.client.client!dc", name = "hb", descriptor = "Lclient!na;")
    public static JagString CHATEFFECT1 = ENG_CHATEFFECT1;

    @OriginalMember(owner = "com.jagex3.client.client!dc", name = "Y", descriptor = "Lclient!na;")
    public static JagString DROP = ENG_DROP;

    @OriginalMember(owner = "com.jagex3.client.client!d", name = "gb", descriptor = "Lclient!na;")
    public static JagString CLOSE = ENG_CLOSE;

    @OriginalMember(owner = "com.jagex3.client.client!cn", name = "q", descriptor = "Lclient!na;")
    public static JagString MAINLOAD140 = ENG_MAINLOAD140;

    @OriginalMember(owner = "com.jagex3.client.client!com.jagex3.client.client", name = "X", descriptor = "Lclient!na;")
    public static JagString CHATCOL3 = ENG_CHATCOL3;

    @OriginalMember(owner = "com.jagex3.client.client!cl", name = "T", descriptor = "Lclient!na;")
    public static JagString THOUSAND_SHORT = ENG_THOUSAND_SUFFIX;

    @OriginalMember(owner = "com.jagex3.client.client!cl", name = "Q", descriptor = "Lclient!na;")
    public static JagString THOUSAND = ENG_THOUSAND_SUFFIX;

    @OriginalMember(owner = "com.jagex3.client.client!ck", name = "y", descriptor = "Lclient!na;")
    public static JagString MAINLOAD135B = ENG_MAINLOAD135B;

    @OriginalMember(owner = "com.jagex3.client.client!ck", name = "i", descriptor = "Lclient!na;")
    public static JagString LENT_ITEM_RETURN = ENG_LENT_ITEM_RETURN;

    @OriginalMember(owner = "com.jagex3.client.client!cb", name = "db", descriptor = "Lclient!na;")
    public static JagString MAINLOAD60B = ENG_MAINLOAD60B;

    @OriginalMember(owner = "com.jagex3.client.client!c", name = "Z", descriptor = "Lclient!na;")
    public static JagString FRIENDLOGIN = ENG_FRIENDLOGIN;

    @OriginalMember(owner = "com.jagex3.client.client!bm", name = "l", descriptor = "Lclient!na;")
    public static JagString CHECKING_FOR_UPDATES = ENG_CHECKING_FOR_UPDATES;

    @OriginalMember(owner = "com.jagex3.client.client!bk", name = "L", descriptor = "Lclient!na;")
    public static JagString CHATCOL0 = ENG_CHATCOL0;

    @OriginalMember(owner = "com.jagex3.client.client!bk", name = "N", descriptor = "Lclient!na;")
    public static JagString MAINLOAD70 = ENG_MAINLOAD70;

    @OriginalMember(owner = "com.jagex3.client.client!bj", name = "q", descriptor = "Lclient!na;")
    public static JagString PLEASEWAIT = ENG_PLEASEWAIT;

    @OriginalMember(owner = "com.jagex3.client.client!bg", name = "P", descriptor = "Lclient!na;")
    public static JagString MAINLOAD130 = ENG_MAINLOAD130;

    @OriginalMember(owner = "com.jagex3.client.client!bf", name = "D", descriptor = "Lclient!na;")
    public static JagString CHATCOL5 = ENG_CHATCOL5;

    @OriginalMember(owner = "com.jagex3.client.client!ba", name = "z", descriptor = "Lclient!na;")
    public static JagString MAINLOAD40B = ENG_MAINLOAD40B;

    @OriginalMember(owner = "com.jagex3.client.client!an", name = "cb", descriptor = "Lclient!na;")
    public static JagString HIDDEN = ENG_HIDDEN;

    @OriginalMember(owner = "com.jagex3.client.client!ah", name = "q", descriptor = "Lclient!na;")
    public static JagString CHATCOL11 = ENG_CHATCOL11;

    @OriginalMember(owner = "com.jagex3.client.client!aa", name = "g", descriptor = "Lclient!na;")
    public static JagString CHATCOL9 = ENG_CHATCOL9;
    //endregion

    // TODO: unsorted
    //region German Translations
    @OriginalMember(owner = "com.jagex3.client.client!vk", name = "l", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD135 = Static28.parse("Lade Liste der Welten");

    @OriginalMember(owner = "com.jagex3.client.client!eg", name = "A", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD80B = Static28.parse("Sprites geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!eh", name = "h", descriptor = "Lclient!na;")
    public static final JagString GER_TRADEREQ = Static28.parse("m-Ochte mit Ihnen handeln)3");

    @OriginalMember(owner = "com.jagex3.client.client!eh", name = "i", descriptor = "Lclient!na;")
    public static final JagString GER_REMOVEFRIEND = Static28.parse(" zuerst von Ihrer Freunde)2Liste(Q");

    @OriginalMember(owner = "com.jagex3.client.client!ed", name = "r", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD120B = Static28.parse("Wordpack geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!dk", name = "i", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL6 = Static28.parse("blinken1:");

    @OriginalMember(owner = "com.jagex3.client.client!dm", name = "h", descriptor = "Lclient!na;")
    public static final JagString GER_REMOVESOCIAL = Static28.parse("Bitte entfernen Sie ");

    @OriginalMember(owner = "com.jagex3.client.client!ck", name = "c", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD70 = Static28.parse("Lade Konfiguration )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!cm", name = "h", descriptor = "Lclient!na;")
    public static final JagString GER_CONLOST = Static28.parse("Verbindung abgebrochen)3");

    @OriginalMember(owner = "com.jagex3.client.client!cn", name = "s", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL4 = Static28.parse("lila:");

    @OriginalMember(owner = "com.jagex3.client.client!cn", name = "C", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL1 = Static28.parse("rot:");

    @OriginalMember(owner = "com.jagex3.client.client!cd", name = "y", descriptor = "Lclient!na;")
    public static final JagString GER_CHECKING_FOR_UPDATES = Static28.parse("Suche nach Updates )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!cd", name = "D", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD120 = Static28.parse("Lade Wordpack )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!ce", name = "m", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD90 = Static28.parse("Lade Texturen )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!cg", name = "d", descriptor = "Lclient!na;")
    public static final JagString GER_LENT_ITEM_RETURN = Static28.parse("Ablegen");

    @OriginalMember(owner = "com.jagex3.client.client!bj", name = "p", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD70B = Static28.parse("Konfig geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!bj", name = "U", descriptor = "Lclient!na;")
    public static final JagString GER_CHATEFFECT2 = Static28.parse("welle2:");

    @OriginalMember(owner = "com.jagex3.client.client!bk", name = "P", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD0 = Static28.parse("Speicher wird zugewiesen)3");

    @OriginalMember(owner = "com.jagex3.client.client!bd", name = "d", descriptor = "Lclient!na;")
    public static final JagString GER_SELECT = Static28.parse("Ausw-=hlen");

    @OriginalMember(owner = "com.jagex3.client.client!bb", name = "N", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL0 = Static28.parse("gelb:");

    @OriginalMember(owner = "com.jagex3.client.client!an", name = "eb", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD50 = Static28.parse("Lade Schrifts-=tze )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!ba", name = "E", descriptor = "Lclient!na;")
    public static final JagString GER_LEVEL = Static28.parse("Stufe: ");

    @OriginalMember(owner = "com.jagex3.client.client!af", name = "f", descriptor = "Lclient!na;")
    public static final JagString GER_MEMBERS_OBJECT = Static28.parse("Gegenstand f-Ur Mitglieder");

    @OriginalMember(owner = "com.jagex3.client.client!be", name = "Zc", descriptor = "Lclient!na;")
    public static final JagString GER_TAKE = Static28.parse("Nehmen");

    @OriginalMember(owner = "com.jagex3.client.client!se", name = "s", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD110B = Static28.parse("Eingabeprozedur geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!gm", name = "eb", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD80 = Static28.parse("Lade Sprites )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!qj", name = "h", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD90B = Static28.parse("Texturen geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!rb", name = "e", descriptor = "Lclient!na;")
    public static final JagString GER_HIDDEN = Static28.parse("Versteckt");

    @OriginalMember(owner = "com.jagex3.client.client!tk", name = "x", descriptor = "Lclient!na;")
    public static final JagString GER_FRIENDLISTDUPE = Static28.parse(" steht bereits auf Ihrer Freunde)2Liste(Q");

    @OriginalMember(owner = "com.jagex3.client.client!nk", name = "o", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD65B = Static28.parse("Titelbild ge-Offnet)3");

    @OriginalMember(owner = "com.jagex3.client.client!nm", name = "R", descriptor = "Lclient!na;")
    public static final JagString GER_CLOSE = Static28.parse("Schlie-8en");

    @OriginalMember(owner = "com.jagex3.client.client!s", name = "j", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!oe", name = "k", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL11 = Static28.parse("leuchten3:");

    @OriginalMember(owner = "com.jagex3.client.client!pg", name = "W", descriptor = "Lclient!na;")
    public static final JagString GER_FRIENDLOGIN = Static28.parse(" loggt sich ein)3");

    @OriginalMember(owner = "com.jagex3.client.client!pg", name = "Y", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL9 = Static28.parse("leuchten1:");

    @OriginalMember(owner = "com.jagex3.client.client!g", name = "b", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!ui", name = "hb", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD50B = Static28.parse("Schrifts-=tze geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!na", name = "p", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!fc", name = "d", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD130 = Static28.parse("Lade Benutzeroberfl-=che )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!em", name = "A", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL8 = Static28.parse("blinken3:");

    @OriginalMember(owner = "com.jagex3.client.client!q", name = "b", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD30B = Static28.parse("Verbindung zum Update)2Server hergestellt)3");

    @OriginalMember(owner = "com.jagex3.client.client!gi", name = "l", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL3 = Static28.parse("blaugr-Un:");

    @OriginalMember(owner = "com.jagex3.client.client!jm", name = "w", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD150B = Static28.parse("3D)2Softwarebibliothek gestartet)3");

    @OriginalMember(owner = "com.jagex3.client.client!ig", name = "e", descriptor = "Lclient!na;")
    public static final JagString GER_LOADING = Static28.parse("Ladevorgang )2 bitte warten Sie)3");

    @OriginalMember(owner = "com.jagex3.client.client!ta", name = "m", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD0B = Static28.parse("Zugewiesener Speicher)3");

    @OriginalMember(owner = "com.jagex3.client.client!sc", name = "k", descriptor = "Lclient!na;")
    public static final JagString GER_FACEHERE = Static28.parse("Hierhin drehen");

    @OriginalMember(owner = "com.jagex3.client.client!ub", name = "a", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL7 = Static28.parse("blinken2:");

    @OriginalMember(owner = "com.jagex3.client.client!h", name = "yb", descriptor = "Lclient!na;")
    public static final JagString GER_REMOVEIGNORE = Static28.parse(" zuerst von Ihrer Ignorieren)2Liste(Q");

    @OriginalMember(owner = "com.jagex3.client.client!nh", name = "S", descriptor = "Lclient!na;")
    public static final JagString GER_LOADINGDOTDOTDOT = Static28.parse("Lade)3)3)3");

    @OriginalMember(owner = "com.jagex3.client.client!nh", name = "V", descriptor = "Lclient!na;")
    public static final JagString GER_CHATEFFECT3 = Static28.parse("sch-Utteln:");

    @OriginalMember(owner = "com.jagex3.client.client!pi", name = "bb", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!ug", name = "f", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL5 = Static28.parse("weiss:");

    @OriginalMember(owner = "com.jagex3.client.client!nc", name = "d", descriptor = "Lclient!na;")
    public static final JagString GER_RATING = Static28.parse("Kampfstufe: ");

    @OriginalMember(owner = "com.jagex3.client.client!pk", name = "eb", descriptor = "Lclient!na;")
    public static final JagString GER_ATTACK = Static28.parse("Angreifen");

    @OriginalMember(owner = "com.jagex3.client.client!pf", name = "l", descriptor = "Lclient!na;")
    public static final JagString GER_MOREOPTIONS = Static28.parse(" weitere Optionen");

    @OriginalMember(owner = "com.jagex3.client.client!la", name = "g", descriptor = "Lclient!na;")
    public static final JagString GER_IGNORELISTDUPE = Static28.parse(" steht bereits auf Ihrer Ignorieren)2Liste(Q");

    @OriginalMember(owner = "com.jagex3.client.client!jg", name = "k", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD60B = Static28.parse("Titelbild geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!lg", name = "j", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL2 = Static28.parse("gr-Un:");

    @OriginalMember(owner = "com.jagex3.client.client!nd", name = "u", descriptor = "Lclient!na;")
    public static final JagString GER_CANCEL = Static28.parse("Abbrechen");

    @OriginalMember(owner = "com.jagex3.client.client!uh", name = "fb", descriptor = "Lclient!na;")
    public static final JagString GER_GAME0_LOADING = Static28.parse("RuneScape wird geladen )2 bitte warten)3)3)3");

    @OriginalMember(owner = "com.jagex3.client.client!hb", name = "p", descriptor = "Lclient!na;")
    public static final JagString GER_MILLION_SUFFIX = Static28.parse("M");

    @OriginalMember(owner = "com.jagex3.client.client!hb", name = "x", descriptor = "Lclient!na;")
    public static final JagString GER_PLEASEWAIT = Static28.parse("Bitte warten Sie)3)3)3");

    @OriginalMember(owner = "com.jagex3.client.client!lj", name = "q", descriptor = "Lclient!na;")
    public static final JagString GER_DROP = Static28.parse("Fallen lassen");

    @OriginalMember(owner = "com.jagex3.client.client!uh", name = "O", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD130B = Static28.parse("Benutzeroberfl-=che geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!pe", name = "q", descriptor = "Lclient!na;")
    public static final JagString GER_MINISEPARATOR = Static28.parse(": ");

    @OriginalMember(owner = "com.jagex3.client.client!pe", name = "d", descriptor = "Lclient!na;")
    public static final JagString GER_CHATEFFECT1 = Static28.parse("welle:");

    @OriginalMember(owner = "com.jagex3.client.client!si", name = "ib", descriptor = "Lclient!na;")
    public static final JagString GER_CONTINUE = Static28.parse("Weiter");

    @OriginalMember(owner = "com.jagex3.client.client!ic", name = "i", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!mf", name = "S", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD140 = Static28.parse("Starte 3D)2Softwarebibliothek)3");

    @OriginalMember(owner = "com.jagex3.client.client!lh", name = "x", descriptor = "Lclient!na;")
    public static final JagString GER_CHATEFFECT4 = Static28.parse("scrollen:");

    @OriginalMember(owner = "com.jagex3.client.client!sk", name = "cb", descriptor = "Lclient!na;")
    public static final JagString GER_EXAMINE = Static28.parse("Untersuchen");

    @OriginalMember(owner = "com.jagex3.client.client!sk", name = "eb", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD45B = Static28.parse("Musik)2Engine vorbereitet)3");

    @OriginalMember(owner = "com.jagex3.client.client!sd", name = "P", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD135B = Static28.parse("Liste der Welten geladen");

    @OriginalMember(owner = "com.jagex3.client.client!vh", name = "i", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD30 = Static28.parse("Verbindung mit Update)2Server)3)3)3");

    @OriginalMember(owner = "com.jagex3.client.client!re", name = "r", descriptor = "Lclient!na;")
    public static final JagString GER_WALKHERE = Static28.parse("Hierhin gehen");

    @OriginalMember(owner = "com.jagex3.client.client!qf", name = "U", descriptor = "Lclient!na;")
    public static final JagString GER_CHOOSE_OPTION = Static28.parse("W-=hlen Sie eine Option");

    @OriginalMember(owner = "com.jagex3.client.client!hj", name = "i", descriptor = "Lclient!na;")
    public static final JagString GER_USE = Static28.parse("Benutzen");

    @OriginalMember(owner = "com.jagex3.client.client!ql", name = "k", descriptor = "Lclient!na;")
    public static final JagString GER_CHATEFFECT5 = Static28.parse("gleiten:");

    @OriginalMember(owner = "com.jagex3.client.client!ok", name = "g", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD60 = Static28.parse("Lade Titelbild )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!gk", name = "a", descriptor = "Lclient!na;")
    public static final JagString GER_CHATCOL10 = Static28.parse("leuchten2:");

    @OriginalMember(owner = "com.jagex3.client.client!wd", name = "c", descriptor = "Lclient!na;")
    public static final JagString GER_UNABLETOFIND = Static28.parse("Spieler kann nicht gefunden werden: ");

    @OriginalMember(owner = "com.jagex3.client.client!og", name = "h", descriptor = "Lclient!na;")
    public static final JagString GER_FRIENDLOGOUT = Static28.parse(" loggt sich aus)3");

    @OriginalMember(owner = "com.jagex3.client.client!ml", name = "S", descriptor = "Lclient!na;")
    public static final JagString GER_THOUSAND_SUFFIX = Static28.parse("T");

    @OriginalMember(owner = "com.jagex3.client.client!va", name = "v", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD10B = Static28.parse("Spielwelt erstellt)3");

    @OriginalMember(owner = "com.jagex3.client.client!mf", name = "q", descriptor = "Lclient!na;")
    public static final JagString GER_OK = Static28.parse("Okay");

    @OriginalMember(owner = "com.jagex3.client.client!ob", name = "c", descriptor = "Lclient!na;")
    public static final JagString GER_SKILL = Static28.parse("Fertigkeit: ");

    @OriginalMember(owner = "com.jagex3.client.client!wf", name = "h", descriptor = "Lclient!na;")
    public static final JagString GER_MAINLOAD40B = Static28.parse("Update)2Liste geladen)3");

    @OriginalMember(owner = "com.jagex3.client.client!lk", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!kc", name = "r", descriptor = "Lclient!na;")
    public static final JagString FR_THOUSAND_SUFFIX = Static28.parse("K");

    @OriginalMember(owner = "com.jagex3.client.client!qj", name = "g", descriptor = "Lclient!na;")
    public static final JagString FR_CHATCOL1 = Static28.parse("rouge:");

    @OriginalMember(owner = "com.jagex3.client.client!oe", name = "m", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!ii", name = "j", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD130B = Static28.parse("Interfaces charg-Bes");

    @OriginalMember(owner = "com.jagex3.client.client!pl", name = "d", descriptor = "Lclient!na;")
    public static final JagString FR_RATING = Static28.parse("classement ");

    @OriginalMember(owner = "com.jagex3.client.client!ol", name = "S", descriptor = "Lclient!na;")
    public static final JagString FR_CONLOST = Static28.parse("Connexion perdue)3");

    @OriginalMember(owner = "com.jagex3.client.client!ui", name = "nb", descriptor = "Lclient!na;")
    public static final JagString FR_CHATCOL0 = Static28.parse("jaune:");

    @OriginalMember(owner = "com.jagex3.client.client!fm", name = "T", descriptor = "Lclient!na;")
    public static final JagString FR_MINISEPARATOR = Static28.parse(" ");

    @OriginalMember(owner = "com.jagex3.client.client!fk", name = "c", descriptor = "Lclient!na;")
    public static final JagString FR_CHECKING_FOR_UPDATES = Static28.parse("V-Brification des mises -9 jour )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!fk", name = "p", descriptor = "Lclient!na;")
    public static final JagString FR_CHATEFFECT2 = Static28.parse("ondulation2:");

    @OriginalMember(owner = "com.jagex3.client.client!fh", name = "V", descriptor = "Lclient!na;")
    public static final JagString FR_CHATCOL2 = Static28.parse("vert:");

    @OriginalMember(owner = "com.jagex3.client.client!fc", name = "g", descriptor = "Lclient!na;")
    public static final JagString FR_USE = Static28.parse("Utiliser");

    @OriginalMember(owner = "com.jagex3.client.client!ab", name = "m", descriptor = "Lclient!na;")
    public static final JagString FR_MEMBERS_OBJECT = Static28.parse("Objet d(Wabonn-Bs");

    @OriginalMember(owner = "com.jagex3.client.client!ah", name = "u", descriptor = "Lclient!na;")
    public static final JagString FR_REMOVESOCIAL = Static28.parse("Veuillez commencer par supprimer ");

    @OriginalMember(owner = "com.jagex3.client.client!bf", name = "A", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!bm", name = "h", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD60B = Static28.parse(",Mcran)2titre charg-B");

    @OriginalMember(owner = "com.jagex3.client.client!ca", name = "bb", descriptor = "Lclient!na;")
    public static final JagString FR_EXAMINE = Static28.parse("Examiner");

    @OriginalMember(owner = "com.jagex3.client.client!cd", name = "v", descriptor = "Lclient!na;")
    public static final JagString FR_WALKHERE = Static28.parse("Atteindre");

    @OriginalMember(owner = "com.jagex3.client.client!cj", name = "b", descriptor = "Lclient!na;")
    public static final JagString FR_CHATCOL5 = Static28.parse("blanc:");

    @OriginalMember(owner = "com.jagex3.client.client!cl", name = "P", descriptor = "Lclient!na;")
    public static final JagString FR_CHATCOL11 = Static28.parse("brillant3:");

    @OriginalMember(owner = "com.jagex3.client.client!cl", name = "R", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD65B = Static28.parse(",Mcran)2titre ouvert");

    @OriginalMember(owner = "com.jagex3.client.client!cm", name = "e", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!cm", name = "i", descriptor = "Lclient!na;")
    public static final JagString FR_SKILL = Static28.parse("comp-Btence ");

    @OriginalMember(owner = "com.jagex3.client.client!cn", name = "x", descriptor = "Lclient!na;")
    ...
    @OriginalMember(owner = "com.jagex3.client.client!k", name = "n", descriptor = "Lclient!na;")
    public static final JagString FR_CHATCOL9 = Static28.parse("brillant1:");

    @OriginalMember(owner = "com.jagex3.client.client!k", name = "u", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD80 = Static28.parse("Chargement des sprites )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!ij", name = "n", descriptor = "Lclient!na;")
    public static final JagString FR_REMOVEIGNORE = Static28.parse(" de votre liste noire)3");

    @OriginalMember(owner = "com.jagex3.client.client!ic", name = "d", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD40B = Static28.parse("Liste des mises -9 jour charg-Be");

    @OriginalMember(owner = "com.jagex3.client.client!ic", name = "m", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD80B = Static28.parse("Sprites charg-Bs");

    @OriginalMember(owner = "com.jagex3.client.client!mf", name = "K", descriptor = "Lclient!na;")
    public static final JagString FR_DROP = Static28.parse("Poser");

    @OriginalMember(owner = "com.jagex3.client.client!rh", name = "q", descriptor = "Lclient!na;")
    public static final JagString FR_OK = Static28.parse("OK");

    @OriginalMember(owner = "com.jagex3.client.client!pk", name = "Q", descriptor = "Lclient!na;")
    public static final JagString FR_CHATEFFECT5 = Static28.parse("glissement:");

    @OriginalMember(owner = "com.jagex3.client.client!kh", name = "a", descriptor = "Lclient!na;")
    public static final JagString FR_ATTACK = Static28.parse("Attaquer");

    @OriginalMember(owner = "com.jagex3.client.client!tc", name = "b", descriptor = "Lclient!na;")
    public static final JagString FR_TAKE = Static28.parse("Prendre");

    @OriginalMember(owner = "com.jagex3.client.client!tc", name = "c", descriptor = "Lclient!na;")
    public static final JagString FR_REMOVEFRIEND = Static28.parse(" de votre liste d(Wamis)3");

    @OriginalMember(owner = "com.jagex3.client.client!hm", name = "lb", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD45B = Static28.parse("Moteur son pr-Bpar-B");

    @OriginalMember(owner = "com.jagex3.client.client!kk", name = "a", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD0 = Static28.parse("M-Bmoire en cours d(Wattribution");

    @OriginalMember(owner = "com.jagex3.client.client!wj", name = "k", descriptor = "Lclient!na;")
    public static final JagString FR_CONTINUE = Static28.parse("Continuer");

    @OriginalMember(owner = "com.jagex3.client.client!oi", name = "k", descriptor = "Lclient!na;")
    public static final JagString FR_CHATCOL3 = Static28.parse("cyan:");

    @OriginalMember(owner = "com.jagex3.client.client!sj", name = "x", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD30 = Static28.parse("Connexion au serveur de mise -9 jour en cours");

    @OriginalMember(owner = "com.jagex3.client.client!la", name = "k", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOLAD120 = Static28.parse("Chargement du module texte )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!hi", name = "h", descriptor = "Lclient!na;")
    public static final JagString FR_MAINLOAD60 = Static28.parse("Chargement de l(W-Bcran)2titre )2 ");

    @OriginalMember(owner = "com.jagex3.client.client!gg", name = "jb", descriptor = "Lclient!na;")
    public static final JagString FR_IGNORELISTDUPE = Static28.parse(" est d-Bj-9 dans votre liste noire)3");

    @OriginalMember(owner = "com.jagex3.client.client!uf", name = "d", descriptor = "Lclient!na;")
    public static final JagString FR_MOREOPTIONS = Static28.parse(" autres options");

    @OriginalMember(owner = "com.jagex3.client.client!gg", name = "Q", descriptor = "Lclient!na;")
    public static final JagString FR_FRIENDLOGIN = Static28.parse(" s(West connect-B)3");

    @OriginalMember(owner = "com.jagex3.client.client!bb", name = "a", descriptor = "(B)V")
