...
public final class Static72 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!fl", name = "b", descriptor = "(II)Lclient!cl;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fl", name = "a", descriptor = "(IIIIII)V")
