...
public final class Static211 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!rc", name = "R", descriptor = "Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!rc", name = "K", descriptor = "Lclient!na;")
	public static final JagString aClass100_232 = Static28.parse("::rect_debug");

	@OriginalMember(owner = "com.jagex3.client.client!rc", name = "M", descriptor = "Z")
	public static boolean aBoolean73 = false;

	@OriginalMember(owner = "com.jagex3.client.client!rc", name = "a", descriptor = "(Lclient!na;Z)Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!rc", name = "a", descriptor = "(Z)V")
