...
@OriginalClass("com.jagex3.client.client!mh")
public final class TextureOp19 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "P", descriptor = "I")
	private int anInt3843 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "T", descriptor = "I")
	private int anInt3847 = 12288;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "bb", descriptor = "I")
	private int anInt3854 = 2048;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "U", descriptor = "I")
	private int anInt3848 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "ib", descriptor = "I")
	private int anInt3860 = 2048;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "Q", descriptor = "I")
	private int anInt3844 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "kb", descriptor = "I")
	private int anInt3862 = 8192;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "<init>", descriptor = "()V")
	public TextureOp19() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "a", descriptor = "(BII)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "e", descriptor = "(I)V")
	@Override
	public final void method4630() {
		Static9.method185();
	}

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "b", descriptor = "(IIB)Z")
