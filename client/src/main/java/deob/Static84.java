		...
		if ((arg0 & 0x80) != 0) {
			...
			if (arg2.aClass100_364 != null && arg2.aClass59_1 != null) {
				...
				if (!local50 && Static11.anInt384 == 0) {
					...
					if (local17 == 2) {
						Static154.method2928(local106, local35 ? 17 : 1, local127, null, JagString.join(new JagString[] { Static44.aClass100_336, arg2.method1264() }));
					} else if (local17 == 1) {
						Static154.method2928(local106, local35 ? 17 : 1, local127, null, JagString.join(new JagString[] { Static65.aClass100_435, arg2.method1264() }));
					} else {
