...
public final class Static2 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!aa", name = "h", descriptor = "[S")
	...
	public static boolean method8(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(11) int arg10) {
		...
		@Pc(71) int[][] local71 = Client.levelCollisionMap[Static55.level].anIntArrayArray30;
		@Pc(193) int local193;
		while (local61 != local64) {
			...
			if (arg1 != 0) {
				if ((arg1 < 5 || arg1 == 10) && Client.levelCollisionMap[Static55.level].method3042(arg4, local3, local8, arg8, arg1 - 1, 2, arg7)) {
					local59 = true;
					break;
				}
				if (arg1 < 10 && Client.levelCollisionMap[Static55.level].method3046(arg4, arg1 - 1, arg8, local8, 2, arg7, local3)) {
					local59 = true;
					break;
				}
			}
			if (arg0 != 0 && arg6 != 0 && Client.levelCollisionMap[Static55.level].method3052(arg8, local8, local3, 2, arg0, arg2, arg4, arg6)) {
				local59 = true;
				break;
			}
