...
public final class Static264 {
    ...
    @OriginalMember(owner = "com.jagex3.client.client!vh", name = "c", descriptor = "Lclient!na;")
	public static final JagString aClass100_875 = Static28.parse(":");

	@OriginalMember(owner = "com.jagex3.client.client!vh", name = "p", descriptor = "[I")
	public static final int[] anIntArray412 = new int[] { 1, 0, 0, 0, 1, 0, 2, 1, 1, 1, 0, 2, 0, 0, 1, 0 };

    @OriginalMember(owner = "com.jagex3.client.client!vh", name = "u", descriptor = "[I")
	...
	public static void method3574(@OriginalArg(0) ModelSource arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg2 < Static152.anInt3594) {
			local12 = World.activeTiles[arg1][arg2 + 1][arg3];
