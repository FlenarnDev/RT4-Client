...
@OriginalClass("com.jagex3.client.client!sa")
public final class TextureOp28 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "T", descriptor = "I")
	private int anInt4971 = 585;

	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "<init>", descriptor = "()V")
	public TextureOp28() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
