...
@OriginalClass("com.jagex3.client.client!nk")
public final class WorldTextureProvider implements TextureProvider {

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "z", descriptor = "Z")
	private boolean aBoolean200 = false;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "J", descriptor = "I")
	private int anInt4186 = 50;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "b", descriptor = "Lclient!ve;")
	private final Js5 aClass153_72;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "i", descriptor = "Lclient!ve;")
	private final Js5 aClass153_73;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "P", descriptor = "Lclient!gn;")
	private LruCache aClass54_12;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "G", descriptor = "Lclient!gn;")
	private LruCache aClass54_11;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "Q", descriptor = "[B")
	private final byte[] aByteArray61;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "l", descriptor = "[B")
	private final byte[] aByteArray60;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "h", descriptor = "[B")
	private final byte[] aByteArray59;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "F", descriptor = "[S")
	private final short[] aShortArray59;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "R", descriptor = "[B")
	private final byte[] aByteArray62;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "k", descriptor = "[Z")
	private final boolean[] aBooleanArray91;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "a", descriptor = "[Z")
	private final boolean[] aBooleanArray89;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "c", descriptor = "[Z")
	private final boolean[] aBooleanArray90;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "s", descriptor = "[Z")
	private final boolean[] aBooleanArray92;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "D", descriptor = "[Z")
	private final boolean[] aBooleanArray93;

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "<init>", descriptor = "(Lclient!ve;Lclient!ve;Lclient!ve;IZ)V")
	public WorldTextureProvider(@OriginalArg(0) Js5 arg0, @OriginalArg(1) Js5 arg1, @OriginalArg(2) Js5 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		this.aClass153_72 = arg2;
		this.aBoolean200 = arg4;
		this.anInt4186 = arg3;
		this.aClass153_73 = arg0;
		this.aClass54_12 = new LruCache(this.anInt4186);
		if (GlRenderer.enabled) {
			this.aClass54_11 = new LruCache(this.anInt4186);
		} else {
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "a", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "e", descriptor = "(II)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "a", descriptor = "(IZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "i", descriptor = "(II)Lclient!uh;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "b", descriptor = "(IZ)I")
	@Override
	public final int method3228(@OriginalArg(0) int arg0) {
		return this.aByteArray61[arg0] & 0xFF;
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "g", descriptor = "(II)I")
	@Override
	public final int method3237(@OriginalArg(0) int arg0) {
		return this.aByteArray62[arg0] & 0xFF;
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "a", descriptor = "(II)I")
	@Override
	public final int method3229(@OriginalArg(1) int arg0) {
		return this.aByteArray59[arg0] & 0xFF;
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "a", descriptor = "(BI)Z")
	@Override
	public final boolean method3226(@OriginalArg(1) int arg0) {
		return this.aBooleanArray91[arg0];
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "j", descriptor = "(II)Lclient!sd;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "b", descriptor = "(II)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "b", descriptor = "(ZI)V")
	public final void method3245(@OriginalArg(0) boolean arg0) {
		this.aBoolean200 = arg0;
		this.method3247();
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "c", descriptor = "(II)Z")
	@Override
	public final boolean method3231(@OriginalArg(0) int arg0) {
		return this.aBooleanArray93[arg0];
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "h", descriptor = "(II)I")
	@Override
	public final int method3238(@OriginalArg(1) int arg0) {
		return this.aByteArray60[arg0] & 0xFF;
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "d", descriptor = "(II)I")
	@Override
	public final int method3234(@OriginalArg(0) int arg0) {
		return this.aShortArray59[arg0] & 0xFFFF;
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "b", descriptor = "(BI)Z")
	@Override
	public final boolean method3233(@OriginalArg(1) int arg0) {
		return this.aBoolean200 || this.aBooleanArray89[arg0];
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "k", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "f", descriptor = "(II)Z")
	@Override
	public final boolean method3236(@OriginalArg(0) int arg0) {
		return this.aBooleanArray90[arg0];
	}

	@OriginalMember(owner = "com.jagex3.client.client!nk", name = "a", descriptor = "(IZF)[I")
	@Override
