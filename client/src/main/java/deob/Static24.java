...
public final class Static24 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "N", descriptor = "Lclient!be;")
	public static IfType component;
	...
	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "a", descriptor = "(BZLclient!na;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "a", descriptor = "(IIB)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bn", name = "d", descriptor = "(II)Z")
