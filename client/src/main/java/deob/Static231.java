...
public final class Static231 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "jb", descriptor = "I")
	public static int anInt5203;

	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "mb", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "a", descriptor = "(IIIIBIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "a", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "a", descriptor = "(JI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "c", descriptor = "(II)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "a", descriptor = "(Lclient!ve;I)Z")
