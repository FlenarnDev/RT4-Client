...
@OriginalClass("com.jagex3.client.client!vc")
public final class TextureOp33 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "P", descriptor = "I")
	private int anInt5709 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "U", descriptor = "I")
	private int anInt5712 = 2000;

	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "Z", descriptor = "I")
	private int anInt5715 = 16;

	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "Y", descriptor = "I")
	private int anInt5714 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "cb", descriptor = "I")
	private int anInt5716 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "<init>", descriptor = "()V")
	public TextureOp33() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "e", descriptor = "(I)V")
	@Override
	public final void method4630() {
		Static9.method185();
	}

	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!vc", name = "a", descriptor = "(IB)[I")
	@Override
