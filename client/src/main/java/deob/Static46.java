...
public final class Static46 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "c", descriptor = "I")
	public static int anInt1439 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "d", descriptor = "I")
	private static int anInt1440 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "e", descriptor = "I")
	public static int anInt1441 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "a", descriptor = "()V")
	public static void method1173() {
		aClass3_Sub2_Sub1_Sub2_1 = null;
	}

	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "b", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "a", descriptor = "([IIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "a", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "b", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "c", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "c", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "d", descriptor = "()V")
	public static void method1184() {
		GlRenderer.gl.glClear(GL2.GL_DEPTH_BUFFER_BIT | GL2.GL_COLOR_BUFFER_BIT);
	}

	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "b", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "c", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!dj", name = "d", descriptor = "(IIII)V")
