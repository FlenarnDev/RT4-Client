...
@OriginalClass("com.jagex3.client.client!ea")
public final class Class3_Sub9 extends Node {

	@OriginalMember(owner = "com.jagex3.client.client!ea", name = "s", descriptor = "[I")
	public static final int[] anIntArray135 = new int[32];

	@OriginalMember(owner = "com.jagex3.client.client!ea", name = "t", descriptor = "[B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ea", name = "<init>", descriptor = "([B)V")
