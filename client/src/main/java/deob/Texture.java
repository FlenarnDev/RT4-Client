...
@OriginalClass("com.jagex3.client.client!lc")
public final class Texture {

	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "k", descriptor = "[I")
	private final int[] anIntArray328;

	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "b", descriptor = "[I")
	private final int[] anIntArray327;

	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "d", descriptor = "Lclient!j;")
	private final TextureOp aClass3_Sub1_1;

	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "i", descriptor = "Lclient!j;")
	private final TextureOp aClass3_Sub1_2;

	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "g", descriptor = "[Lclient!j;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "a", descriptor = "(IZIDILclient!ve;Lclient!m;Z)[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "a", descriptor = "(IIZLclient!m;DILclient!ve;)[B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "a", descriptor = "(ZLclient!m;Lclient!ve;)Z")
