...
@OriginalClass("com.jagex3.client.client!wg")
public final class UnderwaterMaterialRenderer implements MaterialRenderer {

	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "c", descriptor = "I")
	private int anInt5805 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "a", descriptor = "[F")
	private final float[] aFloatArray29 = new float[4];

	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "d", descriptor = "I")
	private int anInt5806 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "d", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "a", descriptor = "(I)V")
	@Override
