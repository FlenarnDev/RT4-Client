...
@OriginalClass("com.jagex3.client.client!tb")
public final class TextureOp31 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!tb", name = "<init>", descriptor = "()V")
	public TextureOp31() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!tb", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!tb", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!tb", name = "b", descriptor = "(II)[[I")
	@Override
