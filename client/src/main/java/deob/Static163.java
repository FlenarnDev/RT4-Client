...
public final class Static163 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "b", descriptor = "I")
	public static int anInt3962;

	@OriginalMember(owner = "com.jagex3.client.client!n", name = "h", descriptor = "[[[B")
	public static byte[][][] aByteArrayArrayArray11;

	@OriginalMember(owner = "com.jagex3.client.client!n", name = "e", descriptor = "Lclient!na;")
	public static final JagString aClass100_767 = Static28.parse(")2");

	@OriginalMember(owner = "com.jagex3.client.client!n", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!n", name = "a", descriptor = "(IIIIII)V")
