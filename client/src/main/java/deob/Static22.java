...
public final class Static22 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!bl", name = "W", descriptor = "I")
	public static int anInt729 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!bl", name = "X", descriptor = "I")
	public static int anInt730 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!bl", name = "a", descriptor = "(IIIIIIII)V")
