...
@OriginalClass("com.jagex3.client.client!ff")
public final class SynthEnvelope {

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "b", descriptor = "I")
	public int anInt1958;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "d", descriptor = "I")
	public int anInt1959;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "f", descriptor = "I")
	public int anInt1960;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "g", descriptor = "I")
	private int anInt1961;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "h", descriptor = "I")
	private int anInt1962;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "i", descriptor = "I")
	private int anInt1963;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "j", descriptor = "I")
	private int anInt1964;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "k", descriptor = "I")
	private int anInt1965;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "a", descriptor = "I")
	private int anInt1957 = 2;

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "e", descriptor = "[I")
	private int[] anIntArray157 = new int[2];

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "c", descriptor = "[I")
	private int[] anIntArray156 = new int[2];

	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "a", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "a", descriptor = "(Lclient!wa;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ff", name = "b", descriptor = "(Lclient!wa;)V")
