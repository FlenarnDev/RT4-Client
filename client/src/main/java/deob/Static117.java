...
public final class Static117 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "p", descriptor = "[F")
	public static float[] aFloatArray9;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "q", descriptor = "[F")
	public static float[] aFloatArray10;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "t", descriptor = "[I")
	public static int[] anIntArray276;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "u", descriptor = "[Lclient!vb;")
	public static VorbisResidue[] aClass152Array1;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "v", descriptor = "[Z")
	public static boolean[] aBooleanArray63;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "y", descriptor = "I")
	public static int anInt2975;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "A", descriptor = "[Lclient!uk;")
	public static VorbisMapping[] aClass151Array1;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "B", descriptor = "[F")
	public static float[] aFloatArray12;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "C", descriptor = "[F")
	public static float[] aFloatArray13;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "E", descriptor = "I")
	public static int anInt2978;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "F", descriptor = "[F")
	public static float[] aFloatArray14;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "G", descriptor = "I")
	private static int anInt2979;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "I", descriptor = "[Lclient!ji;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "Q", descriptor = "I")
	private static int anInt2982;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "S", descriptor = "[F")
	public static float[] aFloatArray16;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "T", descriptor = "[B")
	private static byte[] aByteArray42;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "W", descriptor = "[I")
	public static int[] anIntArray278;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "H", descriptor = "Z")
	private static boolean aBoolean149 = false;

	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "c", descriptor = "(I)F")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "a", descriptor = "(Lclient!ve;)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "b", descriptor = "()I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "a", descriptor = "([BI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "b", descriptor = "([B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!jc", name = "e", descriptor = "(I)I")
