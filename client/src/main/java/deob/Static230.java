	...
	public static void method3954(@OriginalArg(1) JagString arg0) {
		...
		try {
			...
			if (arg0.length() == 0) {
				...
				local48 = Static34.method882(new JagString[] { local48, Static263.aClass100_1082, Static33.method873(MonotonicClock.currentTime() + 94608000000L), Static64.aClass100_431, Static154.method2929(94608000L) });
			}
