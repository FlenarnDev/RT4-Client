...
@OriginalClass("com.jagex3.client.client!pk")
public final class TextureOp24 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "U", descriptor = "[I")
	private final int[] anIntArray406 = new int[3];

	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "S", descriptor = "I")
	private int anInt4577 = 3216;

	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "X", descriptor = "I")
	private int anInt4580 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "db", descriptor = "I")
	private int anInt4584 = 3216;

	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "<init>", descriptor = "()V")
	public TextureOp24() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "e", descriptor = "(I)V")
	@Override
	public final void method4630() {
		this.method3533();
	}

	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!pk", name = "g", descriptor = "(B)V")
