...
@OriginalClass("com.jagex3.client.client!gm")
public final class TextureOp12 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!gm", name = "Z", descriptor = "I")
	private int anInt2298 = 1365;

	@OriginalMember(owner = "com.jagex3.client.client!gm", name = "ab", descriptor = "I")
	private int anInt2299 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!gm", name = "V", descriptor = "I")
	private int anInt2296 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!gm", name = "Y", descriptor = "I")
	private int anInt2297 = 20;

	@OriginalMember(owner = "com.jagex3.client.client!gm", name = "<init>", descriptor = "()V")
	public TextureOp12() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!gm", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!gm", name = "a", descriptor = "(IB)[I")
	@Override
