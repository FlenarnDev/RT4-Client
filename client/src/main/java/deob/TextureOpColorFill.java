...
@OriginalClass("com.jagex3.client.client!fm")
public final class TextureOpColorFill extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!fm", name = "P", descriptor = "I")
	private int anInt2073;

	@OriginalMember(owner = "com.jagex3.client.client!fm", name = "X", descriptor = "I")
	private int anInt2078;

	@OriginalMember(owner = "com.jagex3.client.client!fm", name = "Z", descriptor = "I")
	private int anInt2080;

	@OriginalMember(owner = "com.jagex3.client.client!fm", name = "<init>", descriptor = "(I)V")
	private TextureOpColorFill(@OriginalArg(0) int arg0) {
		super(0, false);
		this.method1595(arg0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!fm", name = "<init>", descriptor = "()V")
	public TextureOpColorFill() {
		this(0);
	}

	@OriginalMember(owner = "com.jagex3.client.client!fm", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fm", name = "b", descriptor = "(II)[[I")
	@Override
