...
public final class Static274 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "b", descriptor = "[I")
	public static int[] anIntArray440;

	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "d", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wf", name = "a", descriptor = "(II)I")
