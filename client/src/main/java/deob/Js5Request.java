...
public abstract class Js5Request extends SecondaryNode {
	...
	@OriginalMember(owner = "com.jagex3.client.client!il", name = "T", descriptor = "Z")
	public boolean aBoolean227;

	@OriginalMember(owner = "com.jagex3.client.client!il", name = "P", descriptor = "Z")
	public volatile boolean aBoolean226 = true;

	@OriginalMember(owner = "com.jagex3.client.client!il", name = "a", descriptor = "(Z)I")
	public abstract int method3553();

	@OriginalMember(owner = "com.jagex3.client.client!il", name = "b", descriptor = "(Z)[B")
