										...
										if (local1921 != null) {
											...
											if (local30.aBoolean32 && local30.objId != -1) {
												...
												if ((local1989.anInt2336 == 1 || local30.objCount != 1) && local30.objCount != -1) {
													local1934 = JagString.join(new JagString[] { Static8.aClass100_32, local1934, Static54.aClass100_375, Static70.method1548(local30.objCount) });
												}
											}
													...
													for (local503 = 0; local503 < local30.baseWidth; local503++) {
														if (local30.objTypes[local276] > 0) {
															...
															if (local2611.anInt2336 != 1 && local30.objCounts[local276] == 1) {
																local3159 = JagString.join(new JagString[] { Static8.aClass100_32, local2611.aClass100_495, Static230.aClass100_978 });
															} else {
																local3159 = JagString.join(new JagString[] { Static8.aClass100_32, local2611.aClass100_495, Static54.aClass100_375, Static70.method1548(local30.objCounts[local276]) });
															}
