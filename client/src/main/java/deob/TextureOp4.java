...
@OriginalClass("com.jagex3.client.client!bi")
public final class TextureOp4 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "ib", descriptor = "[S")
	private short[] aShortArray3;

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "lb", descriptor = "[S")
	private short[] aShortArray4;

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "X", descriptor = "I")
	public int anInt641 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "eb", descriptor = "I")
	public int anInt646 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "kb", descriptor = "Z")
	public boolean aBoolean44 = true;

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "gb", descriptor = "I")
	public int anInt648 = 1638;

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "ab", descriptor = "[B")
	private byte[] aByteArray10 = new byte[512];

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "Z", descriptor = "I")
	public int anInt642 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "mb", descriptor = "I")
	public int anInt650 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "<init>", descriptor = "()V")
	public TextureOp4() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "a", descriptor = "(ZI[I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "e", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "b", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "a", descriptor = "(IIIIIII)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bi", name = "a", descriptor = "(IB)[I")
	@Override
