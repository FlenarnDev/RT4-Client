...
public final class Static196 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!pl", name = "a", descriptor = "[Lclient!ba;")
	public static GWCWorld[] aClass10_Sub1Array2;

	@OriginalMember(owner = "com.jagex3.client.client!pl", name = "c", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pl", name = "f", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pl", name = "a", descriptor = "(I)Lclient!mm;")
