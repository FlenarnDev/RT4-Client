...
@OriginalClass("com.jagex3.client.client!kc")
public final class TextureOp29SubOp2 extends TextureOp29SubOp {

	@OriginalMember(owner = "com.jagex3.client.client!kc", name = "B", descriptor = "I")
	private final int anInt3168;

	@OriginalMember(owner = "com.jagex3.client.client!kc", name = "y", descriptor = "I")
	private final int anInt3165;

	@OriginalMember(owner = "com.jagex3.client.client!kc", name = "v", descriptor = "I")
	private final int anInt3163;

	@OriginalMember(owner = "com.jagex3.client.client!kc", name = "m", descriptor = "I")
	private final int anInt3159;

	@OriginalMember(owner = "com.jagex3.client.client!kc", name = "<init>", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!kc", name = "c", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!kc", name = "a", descriptor = "(IZI)V")
	@Override
	public final void method4009(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
	}

	@OriginalMember(owner = "com.jagex3.client.client!kc", name = "a", descriptor = "(III)V")
	@Override
