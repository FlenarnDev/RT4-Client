...
@OriginalClass("com.jagex3.client.client!sk")
public final class TextureOp30 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "Y", descriptor = "I")
	private int anInt5197 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "X", descriptor = "I")
	private int anInt5196 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "fb", descriptor = "I")
	private int anInt5201 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "W", descriptor = "I")
	private int anInt5195 = 409;

	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "V", descriptor = "[I")
	private final int[] anIntArray450 = new int[3];

	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "<init>", descriptor = "()V")
	public TextureOp30() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!sk", name = "b", descriptor = "(II)[[I")
	@Override
