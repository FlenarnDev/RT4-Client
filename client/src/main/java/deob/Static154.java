...
public final class Static154 {
    ...
    @OriginalMember(owner = "com.jagex3.client.client!md", name = "S", descriptor = "I")
	public static int anInt3709;

	@OriginalMember(owner = "com.jagex3.client.client!md", name = "Q", descriptor = "Lclient!na;")
	public static final JagString aClass100_735 = Static28.parse("::mm");

	@OriginalMember(owner = "com.jagex3.client.client!md", name = "T", descriptor = "Lclient!na;")
	public static final JagString aClass100_736 = Static28.parse("Shift)2click disabled)3");

	@OriginalMember(owner = "com.jagex3.client.client!md", name = "V", descriptor = "[[S")
	...
	@OriginalMember(owner = "com.jagex3.client.client!md", name = "a", descriptor = "(JB)Lclient!na;")
