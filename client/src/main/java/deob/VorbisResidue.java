...
@OriginalClass("com.jagex3.client.client!vb")
public final class VorbisResidue {

	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "c", descriptor = "I")
	private final int anInt5679 = Static117.method2350(16);

	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "b", descriptor = "I")
	private final int anInt5678 = Static117.method2350(24);

	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "d", descriptor = "I")
	private final int anInt5680 = Static117.method2350(24);

	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "e", descriptor = "I")
	private final int anInt5681 = Static117.method2350(24) + 1;

	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "g", descriptor = "I")
	private final int anInt5682 = Static117.method2350(6) + 1;

	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "a", descriptor = "I")
	private final int anInt5677 = Static117.method2350(8);

	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "f", descriptor = "[I")
	private final int[] anIntArray511;

	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vb", name = "a", descriptor = "([FIZ)V")
