...
import com.jagex3.client.PixMap;
...
public final class Static260 {
	...
	public static PixMap aClass27_2;

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "v", descriptor = "Lclient!na;")
	public static final JagString aClass100_944 = Static28.parse("hitbar_default");

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "B", descriptor = "[S")
	public static final short[] aShortArray71 = new short[] { 6798, 8741, 25238, 4626, 4550 };

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "C", descriptor = "I")
	public static int anInt5014 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "F", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vd", name = "b", descriptor = "(IIII)Z")
