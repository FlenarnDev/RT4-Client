...
public final class Static4 {
	...
	public static boolean method26() throws IOException {
		...
		@Pc(14) int local14 = Client.loginStream.available();
		if (local14 == 0) {
			return false;
		}
		if (Static164.anInt3985 == -1) {
			local14--;
			Client.loginStream.read(0, 1, Client.in.data);
			Client.in.pos = 0;
			Static164.anInt3985 = Client.in.method2243();
		...
		if (Static223.anInt5028 == -1) {
			...
			Client.loginStream.read(0, 1, Client.in.data);
			local14--;
			Static223.anInt5028 = Client.in.data[0] & 0xFF;
		}
		if (Static223.anInt5028 == -2) {
			...
			local14 -= 2;
			Client.loginStream.read(0, 2, Client.in.data);
			Client.in.pos = 0;
			Static223.anInt5028 = Client.in.g2();
		}
		if (Static223.anInt5028 > local14) {
			return false;
		}
		Client.in.pos = 0;
		Client.loginStream.read(0, Static223.anInt5028, Client.in.data);
		...
		if (Static164.anInt3985 == 60) {
			local133 = Client.in.g2_alt2();
			@Pc(137) byte local137 = Client.in.g1neg();
		...
		if (Static164.anInt3985 == 115) {
			local133 = Client.in.g2();
			local156 = Client.in.gjstr();
			...
			for (local171 = local156.length() - 1; local171 >= 0; local171--) {
				if (local156.method3149(local171) == 115) {
					local163[local171 + 1] = Client.in.gjstr();
				} else {
					local163[local171 + 1] = Integer.valueOf(Client.in.g4());
				}
			}
			local163[0] = Integer.valueOf(Client.in.g4());
		...
		if (Static164.anInt3985 == 70) {
			@Pc(245) JagString local245 = Client.in.gjstr();
		...
		if (Static164.anInt3985 == 123) {
			local133 = Client.in.g2_alt1();
			local786 = Client.in.g2_alt2();
			local790 = Client.in.gjstr();
			...
			Static180.anInt4264 = Client.in.g1_alt1();
			Static115.anInt2940 = Client.in.g1_alt3();
			while (Static223.anInt5028 > Client.in.pos) {
				Static164.anInt3985 = Client.in.g1();
				Static75.method1634();
			}
			Static164.anInt3985 = -1;
			return true;
			...
			if (Static164.anInt3985 == 220) {
				local133 = Client.in.g4_alt3();
				local786 = Client.in.g2_alt1();
				local864 = Client.in.g2();
			...
			if (Static164.anInt3985 == 81) {
				local884 = Client.in.g8();
				Client.in.g1b();
				local275 = Client.in.g8();
				local899 = Client.in.g2();
				local904 = Client.in.g3();
				local908 = Client.in.g1();
				@Pc(910) boolean local910 = false;
				local916 = Client.in.g2();
				...
				if (!local910 && Static11.anInt384 == 0) {
					...
					@Pc(999) JagString local999 = Static230.method3953(local916).method770(Client.in);
					if (local908 == 2 || local908 == 3) {
						Static154.method2928(local916, 20, local999, Static79.decode37(local275).method3125(), JagString.join(new JagString[] { Static44.aClass100_336, Static79.decode37(local884).method3125() }));
					} else if (local908 == 1) {
						Static154.method2928(local916, 20, local999, Static79.decode37(local275).method3125(), JagString.join(new JagString[] { Static65.aClass100_435, Static79.decode37(local884).method3125() }));
					} else {
			...
			if (Static164.anInt3985 == 55) {
				...
				Static50.aByte6 = Client.in.g1b();
				local1146 = Client.in.g1();
				if (local1146 == 255) {
					Static164.anInt3985 = -1;
					return true;
				}
				...
				for (local1160 = 0; local1160 < Static214.anInt5577; local1160++) {
					...
					local1158[local1160].aLong192 = Client.in.g8();
					local1158[local1160].aClass100_636 = Static79.decode37(local1158[local1160].aLong192);
					local1158[local1160].anInt3340 = Client.in.g2();
					local1158[local1160].aByte9 = Client.in.g1b();
					local1158[local1160].aClass100_635 = Client.in.gjstr();
				...
				Static59.anInt1812 = Client.in.g1();
				Static49.anInt1459 = Client.in.g1();
				Static84.anInt2256 = Client.in.g1();
				Static164.anInt3985 = -1;
				return true;
			} else {
				@Pc(1409) JagString local1409;
				if (Static164.anInt3985 == 44) {
					local133 = Client.in.g2_alt3();
					if (local133 == 65535) {
						local133 = -1;
					}
					local786 = Client.in.g1();
					local864 = Client.in.g1();
					local1409 = Client.in.gjstr();
					...
					local133 = Client.in.g4();
					local786 = Client.in.g2_alt2();
					Static170.method2575(local133, local786);
					Static164.anInt3985 = -1;
					return true;
				} else if (Static164.anInt3985 == 21) {
					local133 = Client.in.g1_alt2();
					local786 = Client.in.g2();
					local864 = Client.in.g4_alt1();
					if (Static248.method3288(local786)) {
					...
					local133 = Client.in.g2_alt3();
					local786 = Client.in.g4();
					local864 = Client.in.g2_alt2();
					if (Static248.method3288(local133)) {
					...
					local786 = Client.in.g1();
					local864 = Client.in.g1();
					local171 = Client.in.g2();
					local1146 = Client.in.g1();
					local277 = Client.in.g1();
					if (Static248.method3288(local133)) {
					...
					if (Static164.anInt3985 == 9) {
						local133 = Client.in.g2_alt3();
						local786 = Client.in.g4_alt1();
						local864 = Client.in.g2_alt2();
						local171 = Client.in.g2_alt1();
						if (local171 == 65535) {
							local171 = -1;
						}
						local1146 = Client.in.g2_alt2();
						if (local1146 == 65535) {
							local1146 = -1;
						}
						if (Static248.method3288(local864)) {
							for (local277 = local1146; local277 <= local171; local277++) {
								...
								local1804 = (ServerActive) Static210.aClass133_21.method3863(local904);
								if (local1804 != null) {
									local1814 = new ServerActive(local1804.anInt546, local133);
									local1804.method4658();
								} else if (local277 == -1) {
									local1814 = new ServerActive(Static5.getComponent(local786).aClass3_Sub4_1.anInt546, local133);
								} else {
					...
					if (Static164.anInt3985 == 56) {
						local133 = Client.in.g2();
						local786 = Client.in.g2_alt1();
						local864 = Client.in.g4_alt2();
						local171 = Client.in.g2_alt3();
						if (local864 >> 30 == 0) {
						...
						Static103.method2245();
						local133 = Client.in.g1_alt1();
						local786 = Client.in.g4_alt2();
						local864 = Client.in.g1();
						...
						local786 = Client.in.g4();
						if (Static248.method3288(local133)) {
							@Pc(2441) SubInterface local2441 = (SubInterface) Static119.aClass133_9.method3863((long) local786);
							if (local2441 != null) {
						...
						Static115.anInt2940 = Client.in.g1();
						Static180.anInt4264 = Client.in.g1_alt2();
						...
						for (@Pc(2604) LocChange local2604 = (LocChange) Static26.aClass69_27.method2289(); local2604 != null; local2604 = (LocChange) Static26.aClass69_27.method2288()) {
						...
						local133 = Client.in.g4_alt3();
						@Pc(2666) IfType local2666 = Static5.getComponent(local133);
						...
						local133 = Client.in.g4_alt1();
						local786 = Client.in.g2_alt3();
						local864 = Client.in.g2_alt2();
						if (local864 == 65535) {
							local864 = -1;
						}
						...
						Static270.anInt5795 = Client.in.g1();
						Static164.anInt3985 = -1;
						return true;
					} else if (Static164.anInt3985 == 13) {
						local133 = Client.in.g1_alt3();
						local786 = Client.in.g1_alt1();
						local864 = Client.in.g1();
						...
						if (Static164.anInt3985 == 62) {
							...
							for (local1986 = 0; local1986 < Static9.anInt178; local1986++) {
								if (local884 == Static92.aLongArray3[local1986]) {
									if (local864 != Static104.anIntArray255[local1986]) {
										...
										if (local864 > 0) {
											Static103.method2231(Static186.aClass100_827, 5, JagString.join(new JagString[] { local2834, LocalizedText.FRIENDLOGIN}));
										}
										if (local864 == 0) {
											Static103.method2231(Static186.aClass100_827, 5, JagString.join(new JagString[] { local2834, LocalizedText.FRIENDLOGOUT}));
										}
									}
							...
							if (Static223.anInt5028 == 0) {
								...
								Static195.aClass100_859 = Client.in.gjstr();
							}
							Static164.anInt3985 = -1;
							return true;
							...
							local884 = Client.in.g8();
							local275 = Client.in.g2();
							local899 = Client.in.g3();
							local1160 = Client.in.g1();
							local1986 = Client.in.g2();
							...
							if (!local3263 && Static11.anInt384 == 0) {
								...
								Static251.anInt5447 = (Static251.anInt5447 + 1) % 100;
								local3020 = Static230.method3953(local1986).method770(Client.in);
								if (local1160 == 2) {
									Static154.method2928(local1986, 18, local3020, null, JagString.join(new JagString[] { Static44.aClass100_336, Static79.decode37(local884).method3125() }));
								} else if (local1160 == 1) {
									Static154.method2928(local1986, 18, local3020, null, JagString.join(new JagString[] { Static65.aClass100_435, Static79.decode37(local884).method3125() }));
								} else {
							...
							if (Static164.anInt3985 == 176) {
								...
								local864 = Client.in.g4_alt2();
								if (Static248.method3288(local786)) {
									@Pc(3449) SubInterface local3449 = (SubInterface) Static119.aClass133_9.method3863((long) local133);
									local3456 = (SubInterface) Static119.aClass133_9.method3863((long) local864);
									if (local3456 != null) {
									...
									@Pc(3490) IfType local3490 = Static5.getComponent(local133);
									if (local3490 != null) {
								...
								Static60.rebootTimer = Client.in.g2() * 30;
								Static164.anInt3985 = -1;
								Static209.miscTransmitAt = Static119.transmitTimer;
								return true;
							} else if (Static164.anInt3985 == 114) {
								Static202.method3654(GameShell.signLink, Client.in, Static223.anInt5028);
								Static164.anInt3985 = -1;
								return true;
							} else if (Static164.anInt3985 == 65) {
								local133 = Client.in.g2_alt1();
								local786 = Client.in.g1_alt2();
								local864 = Client.in.g2_alt3();
								if (Static248.method3288(local133)) {
									Static132.method2606(local864, local786);
								}
								...
								Static103.method2245();
								Static12.anInt400 = Client.in.g1();
								Static209.miscTransmitAt = Static119.transmitTimer;
								Static164.anInt3985 = -1;
								return true;
								...
								Static103.method2245();
								Static251.anInt5456 = Client.in.g2b();
								Static209.miscTransmitAt = Static119.transmitTimer;
								Static164.anInt3985 = -1;
								return true;
							} else if (Static164.anInt3985 == 71) {
								local884 = Client.in.g8();
								local790 = Static218.method2862(Static65.method1497(Client.in).method3116());
								...
								Client.in.method2237(local3848, Static223.anInt5028);
								...
								local133 = Client.in.g2_alt2();
								local786 = Client.in.g4_alt3();
								local864 = Client.in.g2_alt3();
								local171 = Client.in.g2_alt1();
								local1146 = Client.in.g2_alt3();
								if (Static248.method3288(local133)) {
								...
								local133 = Client.in.g1();
								local786 = Client.in.g4_alt3();
								local864 = Client.in.g2_alt2();
								local171 = Client.in.g2();
								if (Static248.method3288(local864)) {
									local3456 = (SubInterface) Static119.aClass133_9.method3863((long) local786);
									if (local3456 != null) {
								...
								local4084.anInt4048 = Client.in.g1();
								if (local4084.anInt4048 >= 0 && local4084.anInt4048 < Static276.aClass3_Sub2_Sub1Array11.length) {
									if (local4084.anInt4058 == 1 || local4084.anInt4058 == 10) {
										local4084.anInt4057 = Client.in.g2();
										Client.in.pos += 3;
										...
										local4084.anInt4053 = Client.in.g2();
										local4084.anInt4046 = Client.in.g2();
										local4084.anInt4050 = Client.in.g1();
									}
									local4084.anInt4052 = Client.in.g2();
								...
								for (local133 = 0; local133 < Static35.anInt1093; local133++) {
									Static190.aLongArray6[local133] = Client.in.g8();
								...
								local133 = Client.in.g2_alt2();
								local786 = Client.in.g4_alt1();
								local864 = Client.in.g2b();
								local171 = Client.in.g2b_alt2();
								if (Static248.method3288(local133)) {
								...
								local1146 = Client.in.g2();
								local277 = Client.in.g4();
								if (local1146 == 65535) {
									local1146 = -1;
								}
								...
								if (!local4425 && Static11.anInt384 == 0) {
									...
									Static251.anInt5447 = (Static251.anInt5447 + 1) % 100;
									@Pc(4518) JagString local4518 = Static218.method2862(Static65.method1497(Client.in).method3116());
									if (local1160 == 2 || local1160 == 3) {
										Static103.method2231(JagString.join(new JagString[] { Static44.aClass100_336, Static79.decode37(local884).method3125() }), 7, local4518);
									} else if (local1160 == 1) {
										Static103.method2231(JagString.join(new JagString[] { Static65.aClass100_435, Static79.decode37(local884).method3125() }), 7, local4518);
									} else {
								...
								if (!local4632 && Static11.anInt384 == 0) {
									...
									Static251.anInt5447 = (Static251.anInt5447 + 1) % 100;
									local3038 = Static218.method2862(Static65.method1497(Client.in).method3116());
									if (local908 == 2 || local908 == 3) {
										Static73.method1598(local3038, JagString.join(new JagString[] { Static44.aClass100_336, Static79.decode37(local884).method3125() }), Static79.decode37(local275).method3125());
									} else if (local908 == 1) {
										Static73.method1598(local3038, JagString.join(new JagString[] { Static65.aClass100_435, Static79.decode37(local884).method3125() }), Static79.decode37(local275).method3125());
									} else {
								...
								if (Static164.anInt3985 == 22) {
									...
									while (Client.in.pos < Static223.anInt5028) {
										local171 = Client.in.gsmart();
										local1146 = Client.in.g2();
										local277 = 0;
										if (local1146 != 0) {
											local277 = Client.in.g1();
									...
									if (Client.in.g1() == 0) {
										...
										Client.in.pos--;
										Static229.aClass136Array1[local133] = new StockMarketOffer(Client.in);
									}
									Static164.anInt3985 = -1;
									...
									local864 = Client.in.g4();
									local171 = Client.in.g2_alt2();
									local1146 = Client.in.g4_alt2();
									if (local171 == 65535) {
										local171 = -1;
									}
									if (Static248.method3288(local133)) {
										for (local277 = local171; local277 <= local786; local277++) {
											...
											if (local1804 != null) {
												...
												local1814 = new ServerActive(local1146, Static5.getComponent(local864).aClass3_Sub4_1.anInt540);
											} else {
									...
									Static166.anInt4054 = Client.in.g1();
									Static185.anInt4369 = Static119.transmitTimer;
									Static164.anInt3985 = -1;
									return true;
									...
									local884 = Client.in.g8();
									local864 = Client.in.g2();
									@Pc(5325) byte local5325 = Client.in.g1b();
									local262 = false;
									...
									if (local262) {
										...
										local884 &= Long.MAX_VALUE;
										for (local277 = 0; Static214.anInt5577 > local277 && (local884 != Static199.aFriendChatUserArray1[local277].aLong192 || local864 != Static199.aFriendChatUserArray1[local277].anInt3340); local277++) {
										}
										...
										for (local1986 = Static214.anInt5577 - 1; local1986 >= 0; local1986--) {
											local908 = Static199.aFriendChatUserArray1[local1986].aClass100_636.method3139(local5347.aClass100_636);
											if (local908 == 0) {
												Static199.aFriendChatUserArray1[local1986].anInt3340 = local864;
												Static199.aFriendChatUserArray1[local1986].aByte9 = local5325;
									...
									if (Static248.method3288(local171)) {
										@Pc(5603) IfType local5603 = Static5.getComponent(local786);
									...
									for (local1146 = 0; local1146 < local171; local1146++) {
										local277 = Client.in.g1_alt3();
										if (local277 == 255) {
											local277 = Client.in.g4();
										}
										local1160 = Client.in.g2();
									...
									Static230.method3954(Client.in.gjstr());
									Static164.anInt3985 = -1;
									return true;
								} else if (Static164.anInt3985 == 26) {
									Static115.anInt2940 = Client.in.g1_alt2();
									Static180.anInt4264 = Client.in.g1();
									Static164.anInt3985 = -1;
									return true;
			...
			if (Static22.anInt723 == 0) {
				if (Static138.aBoolean172) {
					...
					if (Static56.aClass13_12 != null && Static36.method938(Static105.aClass13_14) != null) {
						Client.out.p1isaac(79);
						Client.out.p4_alt3(Static105.aClass13_14.anInt507);
						Client.out.p2_alt1(Static56.aClass13_12.componentId);
						Client.out.p4(Static56.aClass13_12.anInt507);
						Client.out.p2_alt1(Static105.aClass13_14.componentId);
					}
