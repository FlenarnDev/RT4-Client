...
public final class Static270 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!wb", name = "b", descriptor = "[I")
	public static int[] anIntArray562;

	@OriginalMember(owner = "com.jagex3.client.client!wb", name = "l", descriptor = "Lclient!fd;")
	public static WorldMapFont aClass41_9;

	@OriginalMember(owner = "com.jagex3.client.client!wb", name = "a", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wb", name = "m", descriptor = "Lclient!na;")
	public static JagString aClass100_1094 = null;

	@OriginalMember(owner = "com.jagex3.client.client!wb", name = "a", descriptor = "(IIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wb", name = "a", descriptor = "(Lclient!ba;IILclient!ba;Z)I")
