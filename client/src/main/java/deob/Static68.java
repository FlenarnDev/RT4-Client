...
public final class Static68 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "d", descriptor = "[I")
	public static final int[] anIntArray159 = new int[6];

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "i", descriptor = "[[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "j", descriptor = "[[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "l", descriptor = "[I")
	public static final int[] anIntArray164 = new int[6];

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "m", descriptor = "[I")
	public static final int[] anIntArray165 = new int[6];

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "r", descriptor = "[I")
	public static final int[] anIntArray169 = new int[6];

	@OriginalMember(owner = "com.jagex3.client.client!fg", name = "t", descriptor = "[I")
