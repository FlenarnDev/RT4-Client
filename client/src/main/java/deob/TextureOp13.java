...
@OriginalClass("com.jagex3.client.client!hk")
public final class TextureOp13 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "Q", descriptor = "I")
	private int anInt2543;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "Z", descriptor = "I")
	private int anInt2551;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "cb", descriptor = "I")
	private int anInt2553;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "gb", descriptor = "I")
	private int anInt2554;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "ib", descriptor = "I")
	private int anInt2556;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "jb", descriptor = "I")
	private int anInt2557;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "T", descriptor = "I")
	private int anInt2546 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "U", descriptor = "I")
	private int anInt2547 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "X", descriptor = "I")
	private int anInt2549 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "<init>", descriptor = "()V")
	public TextureOp13() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "a", descriptor = "(BIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!hk", name = "b", descriptor = "(II)[[I")
	@Override
