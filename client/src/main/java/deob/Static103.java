...
public final class Static103 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!i", name = "Ub", descriptor = "[Lclient!na;")
	public static JagString[] aClass100Array88;

	@OriginalMember(owner = "com.jagex3.client.client!i", name = "ec", descriptor = "[I")
	public static int[] anIntArray254;

	@OriginalMember(owner = "com.jagex3.client.client!i", name = "ac", descriptor = "[I")
	...
	public static void method2232(@OriginalArg(1) int arg0) {
		...
		if (local23 == 1006) {
			...
			if (local693 == null || local693.objCounts[local15] < 100000) {
				...
				method2231(Static186.aClass100_827, 0, JagString.join(new JagString[] { JagString.parseInt(local693.objCounts[local15]), Static249.aClass100_1039, Static71.method1439(local36).aClass100_495 }));
			}
			Static72.anInt2043 = 0;
			Static257.aClass13_7 = Static5.getComponent(local19);
			Static250.anInt5444 = local15;
		...
		if (local23 == 32) {
			...
			if (local693 != null) {
				...
				if (local693.aBoolean32) {
					...
					Static78.aClass100_466 = JagString.join(new JagString[] { Static42.aClass100_332, local693.aClass100_85, Static204.aClass100_896 });
				}
			}
			return;
		}
		...
		if (local23 == 22) {
			...
			Static34.aClass100_203 = JagString.join(new JagString[] { Static8.aClass100_32, Static71.method1439(local36).aClass100_495, Static204.aClass100_896 });
	...
	@OriginalMember(owner = "com.jagex3.client.client!i", name = "b", descriptor = "(IIIII)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!i", name = "e", descriptor = "(BI)I")
