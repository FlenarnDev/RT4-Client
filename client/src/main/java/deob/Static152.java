...
public final class Static152 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ma", name = "i", descriptor = "I")
	public static int anInt3594;

	@OriginalMember(owner = "com.jagex3.client.client!ma", name = "q", descriptor = "Lclient!fd;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ma", name = "a", descriptor = "(IIBIIII)V")
	...
	public static void method2835(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(7) Square local7 = World.activeTiles[arg2][arg3][arg4];
		if (local7 == null) {
			return;
		}
