...
public final class Static158 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "S", descriptor = "I")
	public static int anInt3846;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "hb", descriptor = "Lclient!bn;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "Y", descriptor = "Z")
	public static boolean aBoolean187 = false;

	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "eb", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mh", name = "c", descriptor = "(II)V")
