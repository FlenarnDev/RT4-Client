...
@OriginalClass("com.jagex3.client.client!fd")
public final class WorldMapFont {

	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "d", descriptor = "Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "f", descriptor = "[I")
	private static final int[] anIntArray155 = new int[256];

	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "c", descriptor = "I")
	private int anInt1955 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "b", descriptor = "Z")
	private boolean aBoolean112 = false;

	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "a", descriptor = "[B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "<init>", descriptor = "(IZLjava/awt/deob.Component;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "a", descriptor = "(Lclient!na;IIIZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "a", descriptor = "()I")
	public final int method1503() {
		return this.aByteArray21[8] - 1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "a", descriptor = "([I[BIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "a", descriptor = "(IIII[B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "b", descriptor = "([I[BIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "b", descriptor = "(Lclient!na;IIIZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "a", descriptor = "(Ljava/awt/deob.Font;Ljava/awt/FontMetrics;CIZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fd", name = "a", descriptor = "(Lclient!na;)I")
