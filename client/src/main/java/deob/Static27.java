...
public final class Static27 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "cb", descriptor = "Lclient!na;")
	public static final JagString aClass100_165 = Static28.parse("titlebg");

	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "eb", descriptor = "Lclient!na;")
	public static final JagString aClass100_167 = Static28.parse("name_icons");

	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "fb", descriptor = "Lclient!na;")
	public static final JagString aClass100_168 = Static28.parse(": ");

	@OriginalMember(owner = "com.jagex3.client.client!cb", name = "b", descriptor = "(III)V")
