...
public final class Static232 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!sm", name = "a", descriptor = "(IIIIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sm", name = "a", descriptor = "(II)V")
