...
public final class Static181 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!oi", name = "h", descriptor = "Lclient!qf;")
	public static AbstractPix32 aClass3_Sub2_Sub1_9;

	@OriginalMember(owner = "com.jagex3.client.client!oi", name = "m", descriptor = "I")
	public static int anInt4296;

	@OriginalMember(owner = "com.jagex3.client.client!oi", name = "b", descriptor = "Lclient!na;")
	public static final JagString aClass100_810 = Static28.parse("::qa_op_test");

	@OriginalMember(owner = "com.jagex3.client.client!oi", name = "j", descriptor = "Lclient!na;")
	public static final JagString aClass100_811 = Static28.parse("::wm1");

	@OriginalMember(owner = "com.jagex3.client.client!oi", name = "a", descriptor = "(IIIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oi", name = "b", descriptor = "(II)V")
	public static void method3345(@OriginalArg(0) int arg0) {
		@Pc(8) DelayedStateChange local8 = Static238.method4143(5, arg0);
		local8.method1007();
	}

	@OriginalMember(owner = "com.jagex3.client.client!oi", name = "a", descriptor = "(I[I[Ljava/lang/Object;)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!oi", name = "b", descriptor = "(I)V")
