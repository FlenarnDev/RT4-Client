...
@OriginalClass("com.jagex3.client.client!fn")
public final class TextureOp10 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!fn", name = "<init>", descriptor = "()V")
	public TextureOp10() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!fn", name = "a", descriptor = "(IB)[I")
	@Override
