			...
			for (local138 = (local31 - 6) / 8; local138 <= (local31 + 6) / 8; local138++) {
				for (local151 = (local60 - 6) / 8; local151 <= (local60 + 6) / 8; local151++) {
					...
					if (local100 && (local151 == 49 || local151 == 149 || local151 == 147 || local138 == 50 || local138 == 49 && local151 == 47)) {
						...
						Static238.anIntArray470[local20] = local169;
						Static36.anIntArray84[local20] = Client.maps.method4482(Static34.method882(new JagString[] { Static103.aClass100_558, Static123.method2423(local138), Static86.aClass100_488, Static123.method2423(local151) }));
						Static172.anIntArray366[local20] = Client.maps.method4482(Static34.method882(new JagString[] { Static270.aClass100_1090, Static123.method2423(local138), Static86.aClass100_488, Static123.method2423(local151) }));
						Static99.anIntArray239[local20] = Client.maps.method4482(Static34.method882(new JagString[] { Static165.aClass100_772, Static123.method2423(local138), Static86.aClass100_488, Static123.method2423(local151) }));
						Static35.anIntArray82[local20] = Client.maps.method4482(Static34.method882(new JagString[] { Static278.aClass100_1103, Static123.method2423(local138), Static86.aClass100_488, Static123.method2423(local151) }));
					}
					local20++;
				}
			}
				...
				for (local151 = 0; local151 < 13; local151++) {
					...
					if (local169 != -1) {
						...
						if (local571 != -1) {
							...
							Static36.anIntArray84[local60] = Client.maps.method4482(Static34.method882(new JagString[] { Static103.aClass100_558, Static123.method2423(local573), Static86.aClass100_488, Static123.method2423(local609) }));
							Static172.anIntArray366[local60] = Client.maps.method4482(Static34.method882(new JagString[] { Static270.aClass100_1090, Static123.method2423(local573), Static86.aClass100_488, Static123.method2423(local609) }));
							Static99.anIntArray239[local60] = Client.maps.method4482(Static34.method882(new JagString[] { Static165.aClass100_772, Static123.method2423(local573), Static86.aClass100_488, Static123.method2423(local609) }));
							Static35.anIntArray82[local60] = Client.maps.method4482(Static34.method882(new JagString[] { Static278.aClass100_1103, Static123.method2423(local573), Static86.aClass100_488, Static123.method2423(local609) }));
							local60++;
						}
					}
				}
		...
		if (Static164.anInt3985 == 195) {
			...
			if (Static164.anInt3985 == 121) {
				...
				if (Static164.anInt3985 == 202) {
					...
					@Pc(605) byte local605 = Client.in.g1b_alt1();
					@Pc(609) byte local609 = Client.in.g1b_alt1();
					@Pc(613) byte local613 = Client.in.g1b_alt3();
					local228 = Client.in.g2_alt2();
					local232 = Client.in.g2_alt1();
					@Pc(625) byte local625 = Client.in.g1b();
					local247 = Client.in.g2();
					local633 = Client.in.g2b_alt3();
				...
				if (Static164.anInt3985 == 14) {
					...
					local15 = Client.in.g2_alt3();
					local23 = Client.in.g1_alt2();
