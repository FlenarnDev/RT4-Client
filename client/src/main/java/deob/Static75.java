			...
			for (local138 = (local31 - 6) / 8; local138 <= (local31 + 6) / 8; local138++) {
				for (local151 = (local60 - 6) / 8; local151 <= (local60 + 6) / 8; local151++) {
					...
					if (local100 && (local151 == 49 || local151 == 149 || local151 == 147 || local138 == 50 || local138 == 49 && local151 == 47)) {
						...
						Static238.anIntArray470[local20] = local169;
						Static36.anIntArray84[local20] = Client.maps.method4482(JagString.join(new JagString[] { Static103.aClass100_558, JagString.parseInt(local138), Static86.aClass100_488, JagString.parseInt(local151) }));
						Static172.anIntArray366[local20] = Client.maps.method4482(JagString.join(new JagString[] { Static270.aClass100_1090, JagString.parseInt(local138), Static86.aClass100_488, JagString.parseInt(local151) }));
						Static99.anIntArray239[local20] = Client.maps.method4482(JagString.join(new JagString[] { Static165.aClass100_772, JagString.parseInt(local138), Static86.aClass100_488, JagString.parseInt(local151) }));
						Static35.anIntArray82[local20] = Client.maps.method4482(JagString.join(new JagString[] { Static278.aClass100_1103, JagString.parseInt(local138), Static86.aClass100_488, JagString.parseInt(local151) }));
					}
					local20++;
				}
			}
				...
				for (local151 = 0; local151 < 13; local151++) {
					...
					if (local169 != -1) {
						...
						if (local571 != -1) {
							...
							Static36.anIntArray84[local60] = Client.maps.method4482(JagString.join(new JagString[] { Static103.aClass100_558, JagString.parseInt(local573), Static86.aClass100_488, JagString.parseInt(local609) }));
							Static172.anIntArray366[local60] = Client.maps.method4482(JagString.join(new JagString[] { Static270.aClass100_1090, JagString.parseInt(local573), Static86.aClass100_488, JagString.parseInt(local609) }));
							Static99.anIntArray239[local60] = Client.maps.method4482(JagString.join(new JagString[] { Static165.aClass100_772, JagString.parseInt(local573), Static86.aClass100_488, JagString.parseInt(local609) }));
							Static35.anIntArray82[local60] = Client.maps.method4482(JagString.join(new JagString[] { Static278.aClass100_1103, JagString.parseInt(local573), Static86.aClass100_488, JagString.parseInt(local609) }));
							local60++;
						}
					}
				}
