...
public final class Static261 {
    ...
    @OriginalMember(owner = "com.jagex3.client.client!ve", name = "t", descriptor = "I")
	public static int anInt5731;

	@OriginalMember(owner = "com.jagex3.client.client!ve", name = "F", descriptor = "I")
	public static int anInt5741;

	@OriginalMember(owner = "com.jagex3.client.client!ve", name = "w", descriptor = "Z")
	public static boolean aBoolean298 = false;

	@OriginalMember(owner = "com.jagex3.client.client!ve", name = "a", descriptor = "(BIIII)V")
