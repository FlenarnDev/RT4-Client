...
@OriginalClass("com.jagex3.client.client!ha")
public final class GzipDecompressor {

	@OriginalMember(owner = "com.jagex3.client.client!ha", name = "j", descriptor = "Ljava/util/zip/Inflater;")
	private Inflater anInflater1;

	@OriginalMember(owner = "com.jagex3.client.client!ha", name = "<init>", descriptor = "()V")
	public GzipDecompressor() {
		this(-1, 1000000, 1000000);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ha", name = "<init>", descriptor = "(III)V")
