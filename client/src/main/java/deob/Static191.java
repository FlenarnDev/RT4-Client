...
public final class Static191 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "Q", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "cb", descriptor = "[I")
	public static final int[] anIntArray389 = new int[anInt4506];

	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "db", descriptor = "Lclient!na;")
	public static final JagString aClass100_845 = Static28.parse(":assistreq:");

	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "eb", descriptor = "[I")
	public static final int[] anIntArray390 = new int[anInt4506];

	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "kb", descriptor = "[I")
	public static final int[] anIntArray391 = new int[anInt4506];

	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "lb", descriptor = "[I")
