...
@OriginalClass("com.jagex3.client.client!ci")
public final class TextureOp29SubOp1 extends TextureOp29SubOp {

	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "s", descriptor = "I")
	private final int anInt1015;

	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "o", descriptor = "I")
	private final int anInt1012;

	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "m", descriptor = "I")
	private final int anInt1010;

	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "v", descriptor = "I")
	private final int anInt1017;

	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "<init>", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "a", descriptor = "(III)V")
	@Override
	public final void method4007(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "c", descriptor = "(III)V")
	@Override
	public final void method4013(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	}

	@OriginalMember(owner = "com.jagex3.client.client!ci", name = "a", descriptor = "(IZI)V")
	@Override
