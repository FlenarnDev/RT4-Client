...
@OriginalClass("com.jagex3.client.client!ej")
public final class TextureOp7 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!ej", name = "P", descriptor = "Z")
	private boolean aBoolean104 = true;

	@OriginalMember(owner = "com.jagex3.client.client!ej", name = "Y", descriptor = "Z")
	private boolean aBoolean105 = true;

	@OriginalMember(owner = "com.jagex3.client.client!ej", name = "<init>", descriptor = "()V")
	public TextureOp7() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ej", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ej", name = "b", descriptor = "(II)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ej", name = "a", descriptor = "(IB)[I")
	@Override
