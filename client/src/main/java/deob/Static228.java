...
public final class Static228 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!sh", name = "j", descriptor = "Lclient!na;")
	public static final JagString aClass100_968 = Static28.parse("headicons_prayer");

	@OriginalMember(owner = "com.jagex3.client.client!sh", name = "k", descriptor = "Z")
	public static final boolean aBoolean248 = false;

	@OriginalMember(owner = "com.jagex3.client.client!sh", name = "l", descriptor = "[J")
	public static final long[] aLongArray8 = new long[32];

	@OriginalMember(owner = "com.jagex3.client.client!sh", name = "a", descriptor = "(II)[B")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sh", name = "a", descriptor = "(IZBIZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sh", name = "a", descriptor = "(I[JII[Ljava/lang/Object;)V")
