...
@OriginalClass("com.jagex3.client.client!bl")
public final class TextureOp5 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!bl", name = "<init>", descriptor = "()V")
	public TextureOp5() {
		super(3, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!bl", name = "b", descriptor = "(II)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!bl", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!bl", name = "a", descriptor = "(IB)[I")
	@Override
