...
@OriginalClass("com.jagex3.client.client!uh")
public final class GlTexture extends DoubleLinkable {

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "K", descriptor = "F")
	private float aFloat35;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "X", descriptor = "I")
	private int anInt5492;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "Z", descriptor = "[I")
	private int[] anIntArray481;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "bb", descriptor = "I")
	private int anInt5493 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "eb", descriptor = "Z")
	public boolean aBoolean287 = false;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "db", descriptor = "I")
	private int anInt5495 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "W", descriptor = "Lclient!lc;")
	private final Texture aClass88_1;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "U", descriptor = "Z")
	private final boolean aBoolean286;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "jb", descriptor = "Z")
	private final boolean aBoolean288;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "Q", descriptor = "Z")
	private final boolean aBoolean285;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "J", descriptor = "Z")
	private final boolean aBoolean284;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "L", descriptor = "I")
	private final int anInt5485;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "hb", descriptor = "I")
	private final int anInt5497;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "M", descriptor = "I")
	private final int anInt5486;

	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "S", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "a", descriptor = "(Lclient!m;IFLclient!ve;Z)[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "a", descriptor = "(Lclient!ve;Lclient!m;IZ)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "a", descriptor = "(ZZLclient!m;Lclient!ve;)[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "a", descriptor = "(ILclient!m;Lclient!ve;)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "a", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!uh", name = "finalize", descriptor = "()V")
	@Override
