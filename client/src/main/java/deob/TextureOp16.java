...
@OriginalClass("com.jagex3.client.client!ke")
public final class TextureOp16 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!ke", name = "V", descriptor = "I")
	private int anInt3292 = 32768;

	@OriginalMember(owner = "com.jagex3.client.client!ke", name = "<init>", descriptor = "()V")
	public TextureOp16() {
		super(3, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ke", name = "b", descriptor = "(II)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ke", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ke", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ke", name = "e", descriptor = "(I)V")
	@Override
