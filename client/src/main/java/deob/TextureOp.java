...
import com.jagex3.client.ColorImageCache;
import com.jagex3.client.Linkable;
import com.jagex3.client.MonochromeImageCache;
...
public abstract class TextureOp extends Linkable {
	...
	@OriginalMember(owner = "com.jagex3.client.client!j", name = "G", descriptor = "I")
	public int anInt5840;

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "H", descriptor = "Lclient!pf;")
	protected ColorImageCache aClass121_41;

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "u", descriptor = "[Lclient!j;")
	public final TextureOp[] aClass3_Sub1Array42;

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "p", descriptor = "Z")
	public boolean aBoolean309;

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "<init>", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!j", name = "a", descriptor = "(III)[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!j", name = "a", descriptor = "(IB)[I")
	public int[] method4626(@OriginalArg(0) int arg0) {
		throw new IllegalStateException("This operation does not have a monochrome output");
	}

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "d", descriptor = "(B)I")
	public int method4627() {
		return -1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "a", descriptor = "(ILclient!wa;Z)V")
	public void method4629(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1) {
	}

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "e", descriptor = "(I)V")
	public void method4630() {
	}

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "f", descriptor = "(I)I")
	public int method4631() {
		return -1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!j", name = "b", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!j", name = "e", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!j", name = "a", descriptor = "(IIB)[[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!j", name = "b", descriptor = "(II)[[I")
