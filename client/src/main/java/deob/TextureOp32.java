...
@OriginalClass("com.jagex3.client.client!ui")
public final class TextureOp32 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "U", descriptor = "[I")
	private int[] anIntArray483;

	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "gb", descriptor = "I")
	private int anInt5535;

	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "ib", descriptor = "I")
	private int anInt5536;

	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "lb", descriptor = "I")
	private int anInt5539 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "<init>", descriptor = "()V")
	public TextureOp32() {
		super(0, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "b", descriptor = "(II)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "a", descriptor = "(Z)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "e", descriptor = "(B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ui", name = "d", descriptor = "(B)I")
	@Override
