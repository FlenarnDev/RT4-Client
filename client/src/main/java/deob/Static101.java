...
public final class Static101 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!hm", name = "gb", descriptor = "J")
	public static long aLong98;

	@OriginalMember(owner = "com.jagex3.client.client!hm", name = "R", descriptor = "Lclient!na;")
	public static final JagString aClass100_537 = Static28.parse("<img=1>");

	@OriginalMember(owner = "com.jagex3.client.client!hm", name = "T", descriptor = "Lclient!na;")
	public static final JagString aClass100_538 = Static28.parse(" ");

	@OriginalMember(owner = "com.jagex3.client.client!hm", name = "Y", descriptor = "Lclient!na;")
	public static final JagString aClass100_539 = Static28.parse("Fps:");

	@OriginalMember(owner = "com.jagex3.client.client!hm", name = "ab", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!hm", name = "a", descriptor = "(IIIII)V")
