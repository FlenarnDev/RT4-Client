...
public final class Static3 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ab", name = "b", descriptor = "I")
	public static int anInt5868 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!ab", name = "c", descriptor = "[Z")
	public static final boolean[] aBooleanArray135 = new boolean[200];

	@OriginalMember(owner = "com.jagex3.client.client!ab", name = "j", descriptor = "[Lclient!na;")
