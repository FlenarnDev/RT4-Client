...
public final class Static21 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!bk", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!bk", name = "a", descriptor = "(BLclient!wa;)Lclient!re;")
