...
public final class Static76 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ga", name = "e", descriptor = "I")
	private static int anInt2126 = 2;

	@OriginalMember(owner = "com.jagex3.client.client!ga", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ga", name = "b", descriptor = "()V")
	public static void method1643() {
	}

	@OriginalMember(owner = "com.jagex3.client.client!ga", name = "c", descriptor = "()I")
	public static int method1644() {
		return anInt2126;
	}

	@OriginalMember(owner = "com.jagex3.client.client!ga", name = "b", descriptor = "(I)V")
