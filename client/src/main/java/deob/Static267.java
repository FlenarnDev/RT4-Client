...
public final class Static267 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!vl", name = "f", descriptor = "Lclient!na;")
	public static final JagString aClass100_1087 = Static28.parse("Cabbage");

	@OriginalMember(owner = "com.jagex3.client.client!vl", name = "h", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!vl", name = "a", descriptor = "(II)V")
