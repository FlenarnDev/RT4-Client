...
public final class Static10 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!an", name = "a", descriptor = "([BIII)Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!an", name = "c", descriptor = "(III)V")
