...
public final class Static275 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "b", descriptor = "Z")
	public static boolean aBoolean308 = false;

	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "e", descriptor = "()I")
	public static int method4607() {
		return aBoolean308 ? 33986 : 33985;
	}

	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "f", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!wg", name = "g", descriptor = "()V")
