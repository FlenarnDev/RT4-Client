			...
			for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
				for (@Pc(42) int local42 = 0; local42 < local30[local32].length; local42++) {
					...
					if (local54 != null) {
						...
						if (local54.aClass15_1 != null && local54.aClass15_1.aClass8_1 instanceof GlModelLit) {
							local71 = (GlModelLit) local54.aClass15_1.aClass8_1;
						...
						if (local54.aClass24_1 != null) {
							if (local54.aClass24_1.aClass8_3 instanceof GlModelLit) {
								local71 = (GlModelLit) local54.aClass24_1.aClass8_3;
							...
							if (local54.aClass24_1.aClass8_2 instanceof GlModelLit) {
								local71 = (GlModelLit) local54.aClass24_1.aClass8_2;
