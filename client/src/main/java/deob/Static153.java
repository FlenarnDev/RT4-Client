...
public final class Static153 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "Q", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "mb", descriptor = "Lclient!na;")
	private static final JagString aClass100_726 = Static28.parse("en");

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "vb", descriptor = "Lclient!na;")
	private static final JagString aClass100_728 = Static28.parse("de");

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "pb", descriptor = "Lclient!na;")
	private static final JagString aClass100_727 = Static28.parse("fr");

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "ob", descriptor = "[Lclient!na;")
	public static final JagString[] aClass100Array113 = new JagString[] { aClass100_726, aClass100_728, aClass100_727, aClass100_725 };

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "tb", descriptor = "S")
	public static short aShort22 = 1;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "c", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "a", descriptor = "(IIIIIIII)V")
