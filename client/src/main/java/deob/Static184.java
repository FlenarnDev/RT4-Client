...
public final class Static184 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "a", descriptor = "(IIIILclient!th;IJIIII)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "a", descriptor = "(IIZI)I")
