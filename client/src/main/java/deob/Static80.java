...
public final class Static80 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!gf", name = "N", descriptor = "Z")
	public static boolean aBoolean231 = true;

	@OriginalMember(owner = "com.jagex3.client.client!gf", name = "S", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!gf", name = "a", descriptor = "(Lsignlink!ll;I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!gf", name = "a", descriptor = "(BII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!gf", name = "a", descriptor = "(Lclient!na;II)V")
