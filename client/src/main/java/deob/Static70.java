...
public final class Static70 {
    ...
    @OriginalMember(owner = "com.jagex3.client.client!fi", name = "l", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!fi", name = "a", descriptor = "(BI)Lclient!na;")
	public static JagString method1548(@OriginalArg(1) int arg0) {
		...
		for (@Pc(21) int local21 = local9.length() - 3; local21 > 0; local21 -= 3) {
			local9 = JagString.join(new JagString[] { local9.substring(local21, 0), Static159.aClass100_760, local9.method3136(local21) });
		}
		if (local9.length() > 9) {
			return JagString.join(new JagString[] { Static250.aClass100_1043, local9.substring(local9.length() - 8, 0), LocalizedText.MILLION_SHORT, Static123.aClass100_593, local9, Static116.aClass100_583 });
		} else if (local9.length() > 6) {
			return JagString.join(new JagString[] { Static119.aClass100_589, local9.substring(local9.length() - 4, 0), LocalizedText.THOUSAND_SHORT, Static123.aClass100_593, local9, Static116.aClass100_583 });
		} else {
			return JagString.join(new JagString[] { Static278.aClass100_1101, local9, Static230.aClass100_978 });
		}
	}
		...
		for (@Pc(11) int local11 = 0; local11 < FloType.anInt2510; local11++) {
			...
			if (local18 != null) {
				...
				if (local18.anInt5894 >= 0) {
					...
					local53 = Rasteriser.anIntArray220[Static230.method3949(Pix3D.anInterface1_2.method3234(local24), 96)];
