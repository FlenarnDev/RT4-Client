...
@OriginalClass("com.jagex3.client.client!ta")
public final class TextureOp29SubOp4 extends TextureOp29SubOp {

	@OriginalMember(owner = "com.jagex3.client.client!ta", name = "D", descriptor = "I")
	private final int anInt5247;

	@OriginalMember(owner = "com.jagex3.client.client!ta", name = "s", descriptor = "I")
	private final int anInt5238;

	@OriginalMember(owner = "com.jagex3.client.client!ta", name = "C", descriptor = "I")
	private final int anInt5246;

	@OriginalMember(owner = "com.jagex3.client.client!ta", name = "A", descriptor = "I")
	private final int anInt5244;

	@OriginalMember(owner = "com.jagex3.client.client!ta", name = "<init>", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ta", name = "a", descriptor = "(IZI)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ta", name = "c", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ta", name = "a", descriptor = "(III)V")
	@Override
