...
public final class SpotAnimType {
	...
	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "h", descriptor = "[S")
	private short[] aShortArray17;

	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "m", descriptor = "I")
	public int anInt1751;

	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "o", descriptor = "I")
	private int anInt1753;

	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "s", descriptor = "[S")
	private short[] aShortArray18;

	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "i", descriptor = "Z")
	public boolean aBoolean100 = false;

	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "j", descriptor = "I")
	private int anInt1748 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "k", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "b", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!eg", name = "a", descriptor = "(IBII)Lclient!ak;")
