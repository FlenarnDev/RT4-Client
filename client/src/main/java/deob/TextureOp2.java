...
@OriginalClass("com.jagex3.client.client!aj")
public final class TextureOp2 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!aj", name = "V", descriptor = "I")
	private int anInt148 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!aj", name = "ab", descriptor = "I")
	private int anInt151 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!aj", name = "<init>", descriptor = "()V")
	public TextureOp2() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!aj", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!aj", name = "b", descriptor = "(II)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!aj", name = "a", descriptor = "(IB)[I")
	@Override
