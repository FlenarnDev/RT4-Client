...
public final class Static147 {
	...
	public static PcmPlayer aClass62_2;

	@OriginalMember(owner = "com.jagex3.client.client!lh", name = "u", descriptor = "I")
	public static volatile int anInt3521 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!lh", name = "z", descriptor = "Lclient!na;")
	public static final JagString aClass100_672 = Static28.parse("(U (X");

	@OriginalMember(owner = "com.jagex3.client.client!lh", name = "b", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!lh", name = "a", descriptor = "(Lclient!fg;IIIIIIZ)V")
