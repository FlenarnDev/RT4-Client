...
@OriginalClass("com.jagex3.client.client!d")
public final class TextureOp6 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!d", name = "U", descriptor = "[I")
	private int[] anIntArray86;

	@OriginalMember(owner = "com.jagex3.client.client!d", name = "W", descriptor = "[I")
	private int[] anIntArray87;

	@OriginalMember(owner = "com.jagex3.client.client!d", name = "Q", descriptor = "I")
	private int anInt1234 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!d", name = "P", descriptor = "I")
	private int anInt1233 = 10;

	@OriginalMember(owner = "com.jagex3.client.client!d", name = "bb", descriptor = "I")
	private int anInt1240 = 2048;

	@OriginalMember(owner = "com.jagex3.client.client!d", name = "<init>", descriptor = "()V")
	public TextureOp6() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!d", name = "e", descriptor = "(I)V")
	@Override
	public final void method4630() {
		this.method991();
	}

	@OriginalMember(owner = "com.jagex3.client.client!d", name = "h", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!d", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!d", name = "a", descriptor = "(IB)[I")
	@Override
