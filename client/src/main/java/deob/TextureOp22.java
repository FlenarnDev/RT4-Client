...
@OriginalClass("com.jagex3.client.client!ol")
public final class TextureOp22 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "gb", descriptor = "I")
	private int anInt4356;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "R", descriptor = "I")
	private int anInt4346 = 819;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "ab", descriptor = "I")
	private int anInt4351 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "Z", descriptor = "I")
	private int anInt4350 = 2048;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "T", descriptor = "I")
	private int anInt4347 = 1024;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "Q", descriptor = "I")
	private int anInt4345 = 1024;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "cb", descriptor = "I")
	private int anInt4353 = 409;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "kb", descriptor = "I")
	private int anInt4360 = 1024;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "P", descriptor = "I")
	private int anInt4344 = 1024;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "eb", descriptor = "I")
	private int anInt4354 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "<init>", descriptor = "()V")
	public TextureOp22() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "e", descriptor = "(I)V")
	@Override
	public final void method4630() {
	}

	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "a", descriptor = "(ILjava/util/Random;IIBI[[I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ol", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
