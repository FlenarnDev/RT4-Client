...
@OriginalClass("com.jagex3.client.client!mc")
public final class TextureOp17 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "U", descriptor = "I")
	private int anInt3670;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "V", descriptor = "I")
	private int anInt3671;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "X", descriptor = "[[I")
	private int[][] anIntArrayArray26;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "cb", descriptor = "[I")
	private int[] anIntArray352;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "jb", descriptor = "I")
	private int anInt3679;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "sb", descriptor = "[[I")
	private int[][] anIntArrayArray27;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "P", descriptor = "I")
	private int anInt3667 = 204;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "bb", descriptor = "I")
	private int anInt3673 = 1024;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "eb", descriptor = "I")
	private int anInt3675 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "lb", descriptor = "I")
	private int anInt3681 = 409;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "hb", descriptor = "I")
	private int anInt3677 = 8;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "W", descriptor = "I")
	private int anInt3672 = 81;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "ub", descriptor = "I")
	private int anInt3685 = 4;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "ib", descriptor = "I")
	private int anInt3678 = 1024;

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "<init>", descriptor = "()V")
	public TextureOp17() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "e", descriptor = "(I)V")
	@Override
	public final void method4630() {
		this.method2908();
	}

	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "i", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!mc", name = "a", descriptor = "(IB)[I")
	@Override
