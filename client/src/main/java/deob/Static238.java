...
public final class Static238 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!te", name = "b", descriptor = "(Lclient!na;I)Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!te", name = "e", descriptor = "(I)V")
