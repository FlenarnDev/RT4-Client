...
@OriginalClass("com.jagex3.client.client!e")
public final class ClientPlayer extends ClientEntity {

	@OriginalMember(owner = "com.jagex3.client.client!e", name = "Bc", descriptor = "Lclient!hh;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!e", name = "wc", descriptor = "I")
	private int anInt1651 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!e", name = "uc", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!e", name = "Cc", descriptor = "I")
	public int anInt1654 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!e", name = "qc", descriptor = "I")
	public int anInt1648 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!e", name = "Pc", descriptor = "I")
	public int anInt1664 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!e", name = "Hc", descriptor = "I")
	public int anInt1658 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!e", name = "Sc", descriptor = "I")
	public int anInt1667 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!e", name = "Oc", descriptor = "Z")
	...
	@OriginalMember(owner = "com.jagex3.client.client!e", name = "Vc", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!e", name = "a", descriptor = "(IIIIIIIIJILclient!ga;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!e", name = "a", descriptor = "(B)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!e", name = "a", descriptor = "(IIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!e", name = "a", descriptor = "(BIZI)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!e", name = "finalize", descriptor = "()V")
	@Override
