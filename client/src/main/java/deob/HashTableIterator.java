...
@OriginalClass("com.jagex3.client.client!l")
public final class HashTableIterator {
	...
	@OriginalMember(owner = "com.jagex3.client.client!l", name = "e", descriptor = "Lclient!sc;")
	private final HashTable aClass133_10;

	@OriginalMember(owner = "com.jagex3.client.client!l", name = "<init>", descriptor = "(Lclient!sc;)V")
