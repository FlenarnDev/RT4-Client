...
public final class Static234 {
	...
	public static void method4014() {
		for (@Pc(3) int local3 = 0; local3 < Static116.anInt2951; local3++) {
			...
			@Pc(47) int local47;
			if ((local18 & 0x40) != 0) {
				local43 = Client.in.g1();
				local47 = Client.in.g1_alt2();
				local14.method2686(local47, Static83.anInt372, local43);
				local14.anInt3378 = Static83.anInt372 + 300;
				local14.anInt3372 = Client.in.g1_alt3();
			}
			if ((local18 & 0x2) != 0) {
				local43 = Client.in.g1_alt2();
				local47 = Client.in.g1_alt3();
				local14.method2686(local47, Static83.anInt372, local43);
			}
			if ((local18 & 0x10) != 0) {
				local43 = Client.in.g2();
				local47 = Client.in.g1();
				if (local43 == 65535) {
					local43 = -1;
				}
			...
			if ((local18 & 0x4) != 0) {
				local14.anInt3370 = Client.in.g2_alt2();
				if (local14.anInt3370 == 65535) {
					local14.anInt3370 = -1;
				}
			}
			if ((local18 & 0x80) != 0) {
				local43 = Client.in.g2_alt2();
				if (local43 == 65535) {
					local43 = -1;
				}
				local47 = Client.in.g4_alt1();
			...
			if ((local18 & 0x1) != 0) {
				...
				local14.method2698(Static214.method4363(Client.in.g2_alt1()));
			...
			if ((local18 & 0x20) != 0) {
				local14.aClass100_640 = Client.in.gjstr();
			...
			if ((local18 & 0x100) != 0) {
				...
				for (@Pc(339) int local339 = 0; local339 < local43; local339++) {
					@Pc(350) int local350 = Client.in.g2_alt1();
					if (local350 == 65535) {
						local350 = -1;
					}
					local331[local339] = local350;
					local334[local339] = Client.in.g1_alt3();
					local337[local339] = Client.in.g2();
				}
				Static159.method3037(local337, local14, local334, local331);
			}
			if ((local18 & 0x200) != 0) {
				local14.anInt3382 = Client.in.g2_alt2();
				local14.anInt3363 = Client.in.g2();
			}
		}
	}
