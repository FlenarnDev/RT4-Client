...
@OriginalClass("com.jagex3.client.client!nl")
public final class SynthFilter {

	@OriginalMember(owner = "com.jagex3.client.client!nl", name = "e", descriptor = "[I")
	public final int[] anIntArray368 = new int[2];

	@OriginalMember(owner = "com.jagex3.client.client!nl", name = "c", descriptor = "[[[I")
	private final int[][][] anIntArrayArrayArray15 = new int[2][2][4];

	@OriginalMember(owner = "com.jagex3.client.client!nl", name = "a", descriptor = "[[[I")
	private final int[][][] anIntArrayArrayArray14 = new int[2][2][4];

	@OriginalMember(owner = "com.jagex3.client.client!nl", name = "h", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nl", name = "a", descriptor = "(IF)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nl", name = "a", descriptor = "(IIF)F")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nl", name = "b", descriptor = "(IIF)F")
