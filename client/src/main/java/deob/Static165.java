...
public final class Static165 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!nb", name = "h", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nb", name = "m", descriptor = "Lclient!na;")
	public static final JagString aClass100_776 = Static28.parse("logo");

	@OriginalMember(owner = "com.jagex3.client.client!nb", name = "n", descriptor = "Lclient!na;")
	public static final JagString aClass100_777 = Static28.parse("details");

	@OriginalMember(owner = "com.jagex3.client.client!nb", name = "a", descriptor = "(IIIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nb", name = "a", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nb", name = "a", descriptor = "(BI)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!nb", name = "a", descriptor = "(II)Lclient!na;")
