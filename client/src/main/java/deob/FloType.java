...
public final class FloType {
	...
	@OriginalMember(owner = "com.jagex3.client.client!wl", name = "p", descriptor = "I")
	public int anInt5892 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!wl", name = "f", descriptor = "I")
	public int anInt5885 = 128;

	@OriginalMember(owner = "com.jagex3.client.client!wl", name = "w", descriptor = "I")
	public int anInt5897 = 8;

	@OriginalMember(owner = "com.jagex3.client.client!wl", name = "x", descriptor = "I")
	public int anInt5898 = 16;

	@OriginalMember(owner = "com.jagex3.client.client!wl", name = "t", descriptor = "I")
	public int anInt5894 = -1;

	@OriginalMember(owner = "com.jagex3.client.client!wl", name = "y", descriptor = "Z")
	public boolean aBoolean312 = true;

	@OriginalMember(owner = "com.jagex3.client.client!wl", name = "z", descriptor = "I")
