...
@OriginalClass("com.jagex3.client.client!ij")
public final class IsaacRandom {

	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "b", descriptor = "I")
	private int anInt2912;

	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "d", descriptor = "I")
	private int anInt2914;

	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "f", descriptor = "I")
	private int anInt2916;

	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "i", descriptor = "[I")
	private final int[] anIntArray274 = new int[256];

	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "k", descriptor = "[I")
	private final int[] anIntArray275 = new int[256];

	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "l", descriptor = "I")
	private int anInt2920;

	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "<init>", descriptor = "([I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!ij", name = "b", descriptor = "(I)V")
