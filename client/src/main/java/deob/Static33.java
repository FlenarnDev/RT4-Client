...
public final class Static33 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!cj", name = "a", descriptor = "(ZI[B)Ljava/lang/Object;")
	public static Object method869(@OriginalArg(2) byte[] arg0) {
		...
		if (arg0.length > 136 && !Static84.aBoolean127) {
			try {
				@Pc(27) ByteArrayWrapper local27 = (ByteArrayWrapper) Class.forName("deob.ByteBufferNode").getDeclaredConstructor().newInstance();
	...
	@OriginalMember(owner = "com.jagex3.client.client!cj", name = "a", descriptor = "(I)[Lclient!qf;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!cj", name = "a", descriptor = "(IB)I")
	public static int method872(@OriginalArg(0) int arg0) {
		return arg0 & 0xFF;
	}

	@OriginalMember(owner = "com.jagex3.client.client!cj", name = "a", descriptor = "(JB)Lclient!na;")
