...
public final class Static142 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!lc", name = "m", descriptor = "Lclient!na;")
				...
				for (local74 = 0; local74 < 4; local74++) {
					if (local17.anIntArray319[local74] > Static83.anInt372) {
						...
						if (Static65.anInt1951 > -1) {
							...
							Static114.aClass3_Sub2_Sub9_42.method2875(JagString.parseInt(local17.anIntArray322[local74]), Static65.anInt1951 + arg2 - 1, Static16.anInt548 + 3 + arg0, 16777215, 0);
						}
					}
				}
			}
