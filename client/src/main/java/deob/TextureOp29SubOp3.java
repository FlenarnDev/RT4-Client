...
@OriginalClass("com.jagex3.client.client!re")
public final class TextureOp29SubOp3 extends TextureOp29SubOp {

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "x", descriptor = "I")
	private final int anInt4850;

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "A", descriptor = "I")
	private final int anInt4853;

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "v", descriptor = "I")
	private final int anInt4849;

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "s", descriptor = "I")
	private final int anInt4846;

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "n", descriptor = "I")
	private final int anInt4842;

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "q", descriptor = "I")
	private final int anInt4845;

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "m", descriptor = "I")
	private final int anInt4841;

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "C", descriptor = "I")
	private final int anInt4854;

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "<init>", descriptor = "(IIIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!re", name = "a", descriptor = "(IZI)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!re", name = "c", descriptor = "(III)V")
	@Override
	public final void method4013(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	}

	@OriginalMember(owner = "com.jagex3.client.client!re", name = "a", descriptor = "(III)V")
	@Override
