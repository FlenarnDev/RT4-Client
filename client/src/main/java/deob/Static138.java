...
import com.jagex3.client.ByteArrayWrapper;
...
public final class Static138 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!km", name = "xc", descriptor = "Lclient!na;")
	private static final JagString aClass100_644 = Static28.parse("May");

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "yc", descriptor = "Lclient!na;")
	private static final JagString aClass100_645 = Static28.parse("Nov");

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "zc", descriptor = "Lclient!na;")
	private static final JagString aClass100_646 = Static28.parse("Mar");

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "Gc", descriptor = "Lclient!na;")
	private static final JagString aClass100_649 = Static28.parse("Jan");

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "Hc", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!km", name = "Qc", descriptor = "Lclient!na;")
	private static final JagString aClass100_653 = Static28.parse("Aug");

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "cd", descriptor = "Lclient!na;")
	private static final JagString aClass100_657 = Static28.parse("Sep");

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "dd", descriptor = "Lclient!na;")
	...
	@OriginalMember(owner = "com.jagex3.client.client!km", name = "Sc", descriptor = "Lclient!na;")
	public static final JagString aClass100_654 = Static28.parse(":trade:");

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "ad", descriptor = "I")
	public static int anInt3445 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!km", name = "b", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!km", name = "a", descriptor = "(ILjava/lang/Object;Z)[B")
