...
@OriginalClass("com.jagex3.client.client!um")
public final class TextureOpColorGradient extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!um", name = "R", descriptor = "[[I")
	private int[][] anIntArrayArray39;

	@OriginalMember(owner = "com.jagex3.client.client!um", name = "bb", descriptor = "[I")
	private final int[] anIntArray494 = new int[257];

	@OriginalMember(owner = "com.jagex3.client.client!um", name = "<init>", descriptor = "()V")
	public TextureOpColorGradient() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!um", name = "e", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!um", name = "a", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!um", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!um", name = "h", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex3.client.client!um", name = "b", descriptor = "(II)[[I")
	@Override
