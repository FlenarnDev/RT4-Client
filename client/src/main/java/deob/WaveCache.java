...
@OriginalClass("com.jagex3.client.client!le")
public final class WaveCache {

	@OriginalMember(owner = "com.jagex3.client.client!le", name = "d", descriptor = "Lclient!sc;")
	private final HashTable aClass133_11 = new HashTable(256);

	@OriginalMember(owner = "com.jagex3.client.client!le", name = "l", descriptor = "Lclient!sc;")
	private final HashTable aClass133_12 = new HashTable(256);

	@OriginalMember(owner = "com.jagex3.client.client!le", name = "b", descriptor = "Lclient!ve;")
	private final Js5 aClass153_52;

	@OriginalMember(owner = "com.jagex3.client.client!le", name = "i", descriptor = "Lclient!ve;")
	private final Js5 aClass153_53;

	@OriginalMember(owner = "com.jagex3.client.client!le", name = "<init>", descriptor = "(Lclient!ve;Lclient!ve;)V")
	public WaveCache(@OriginalArg(0) Js5 arg0, @OriginalArg(1) Js5 arg1) {
		this.aClass153_52 = arg0;
		this.aClass153_53 = arg1;
	}

	@OriginalMember(owner = "com.jagex3.client.client!le", name = "a", descriptor = "([IIII)Lclient!kj;")
	private Wave method2737(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(21) int local21 = arg2 ^ (arg1 >>> 12 | arg1 << 4 & 0xFFF3);
		@Pc(27) int local27 = local21 | arg1 << 16;
		@Pc(30) long local30 = (long) local27;
		@Pc(37) Wave local37 = (Wave) this.aClass133_12.method3863(local30);
		if (local37 != null) {
			return local37;
	...
	@OriginalMember(owner = "com.jagex3.client.client!le", name = "a", descriptor = "(I[IIB)Lclient!kj;")
	private Wave method2740(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		@Pc(15) int local15 = arg2 ^ (arg0 >>> 12 | arg0 << 4 & 0xFFF3);
		@Pc(21) int local21 = local15 | arg0 << 16;
		@Pc(26) long local26 = (long) local21 ^ 0x100000000L;
		@Pc(33) Wave local33 = (Wave) this.aClass133_12.method3863(local26);
		if (local33 != null) {
			return local33;
		} else if (arg1 == null || arg1[0] > 0) {
			@Pc(53) JagVorbis local53 = (JagVorbis) this.aClass133_11.method3863(local26);
			if (local53 == null) {
