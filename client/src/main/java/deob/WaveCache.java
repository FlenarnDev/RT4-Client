...
public final class WaveCache {
	...
	private Wave method2737(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(37) Wave local37 = (Wave) this.aClass133_12.find(local30);
		if (local37 != null) {
			return local37;
	...
	private Wave method2740(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(33) Wave local33 = (Wave) this.aClass133_12.find(local26);
		if (local33 != null) {
			return local33;
		} else if (arg1 == null || arg1[0] > 0) {
			@Pc(53) JagVorbis local53 = (JagVorbis) this.aClass133_11.find(local26);
			if (local53 == null) {
