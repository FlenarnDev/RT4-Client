...
@OriginalClass("com.jagex3.client.client!pg")
public final class TextureOp23 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "U", descriptor = "I")
	private int anInt4503 = 4096;

	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "<init>", descriptor = "()V")
	public TextureOp23() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!pg", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
