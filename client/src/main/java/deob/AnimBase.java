...
public final class AnimBase extends Node {
	...
	@OriginalMember(owner = "com.jagex3.client.client!jm", name = "x", descriptor = "I")
	public final int anInt3116;

	@OriginalMember(owner = "com.jagex3.client.client!jm", name = "v", descriptor = "[[I")
	public final int[][] anIntArrayArray23;

	@OriginalMember(owner = "com.jagex3.client.client!jm", name = "B", descriptor = "[I")
	public final int[] anIntArray291;

	@OriginalMember(owner = "com.jagex3.client.client!jm", name = "y", descriptor = "[Z")
	public final boolean[] aBooleanArray70;

	@OriginalMember(owner = "com.jagex3.client.client!jm", name = "q", descriptor = "[I")
