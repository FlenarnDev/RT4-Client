...
@OriginalClass("com.jagex3.client.client!rj")
public final class TextureOp26 extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!rj", name = "<init>", descriptor = "()V")
	public TextureOp26() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex3.client.client!rj", name = "c", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!rj", name = "a", descriptor = "(IB)[I")
	@Override
