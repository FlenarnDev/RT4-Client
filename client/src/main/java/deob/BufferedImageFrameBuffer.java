...
@OriginalClass("com.jagex3.client.client!ti")
public final class BufferedImageFrameBuffer extends FrameBuffer {

	@OriginalMember(owner = "com.jagex3.client.client!ti", name = "p", descriptor = "Ljava/awt/deob.Component;")
	private Component aComponent1;

	@OriginalMember(owner = "com.jagex3.client.client!ti", name = "a", descriptor = "(IILjava/awt/Graphics;I)V")
	@Override
	public final void method4186(@OriginalArg(2) Graphics arg0) {
		arg0.drawImage(this.anImage4, 0, 0, this.aComponent1);
	}

	@OriginalMember(owner = "com.jagex3.client.client!ti", name = "a", descriptor = "(IZILjava/awt/deob.Component;)V")
	@Override
