...
@OriginalClass("com.jagex3.client.client!pi")
public final class TextureOpCombine extends TextureOp {

	@OriginalMember(owner = "com.jagex3.client.client!pi", name = "Z", descriptor = "I")
	private int anInt4543 = 6;

	@OriginalMember(owner = "com.jagex3.client.client!pi", name = "<init>", descriptor = "()V")
	public TextureOpCombine() {
		super(2, false);
	}

	@OriginalMember(owner = "com.jagex3.client.client!pi", name = "a", descriptor = "(IB)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex3.client.client!pi", name = "b", descriptor = "(II)[[I")
	@Override
