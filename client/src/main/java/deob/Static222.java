...
public final class Static222 {
	...
	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "R", descriptor = "Ljava/awt/deob.Font;")
	public static Font aFont1;

	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "Q", descriptor = "[I")
	public static final int[] anIntArray437 = new int[5];

	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "W", descriptor = "Z")
	public static boolean aBoolean246 = true;

	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "Y", descriptor = "I")
	public static volatile int anInt4973 = 0;

	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "c", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex3.client.client!sa", name = "a", descriptor = "(IIIBI)V")
